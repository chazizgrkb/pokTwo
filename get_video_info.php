...
by genosmrpg7899#4308 (667891621236310016)
further edits by «John»#1234 based on elements of the 2012L get video info
...
/* only one of these is required, the rest of them are just to trick the player into showing extra formats */
$fmt_stream_map = [
	[
	"itag" => "43",
    "url" => "./media/".$vid.".mp4",
