...
if (isset($_FILES['fileToUpload'])) {
	...
	if(move_uploaded_file($temp_name, $target_file)){
		...
		if (!$error) {
		query("INSERT INTO videos (video_id, title, description, author, time, most_recent_view, videofile, videolength) VALUES (?,?,?,?,?,?,?,?,?)",
			[$new, $title, $description, $userdata['id'], time(), time(), $upload_file, $seccount]);
