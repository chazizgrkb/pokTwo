(function() {
    ...
    function Aa(a) {
        if (!Ba.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(Ca, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(Da, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(Ea, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(Fa, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(Ga, "&#39;"));
        return a
    }
    var Ca = /&/g,
        Da = /</g,
        ...
        switch (typeof b) {
            ...
            case "object":
                ...
                if (ga(b)) {
                    var d = b.length;
                    c.push("[");
                    for (var e = "", g = 0; g < d; g++) c.push(e), e = b[g], xb(a, a.a ? a.a.call(b, String(g), e) : e, c), e = ",";
                    c.push("]");
                    break
                }
                c.push("{");
                d = "";
                for (g in b) Object.prototype.hasOwnProperty.call(b, g) && (e = b[g], "function" != typeof e && (c.push(d), yb(g, c),
                    c.push(":"), xb(a, a.a ? a.a.call(b, g, e) : e, c), d = ","));
                c.push("}");
                break;
            case "function":
                break;
    ...
    function $b(a, b) {
        for (var c, d, e = 1; e < arguments.length; e++) {
            d = arguments[e];
            for (c in d) a[c] = d[c];
            for (var g = 0; g < Zb.length; g++) c = Zb[g], Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c])
        }
    }

    function ac(a) {
        var b = arguments.length;
        if (1 == b && ga(arguments[0])) return ac.apply(null, arguments[0]);
    ...
    t: {
        var vc = "",
            wc;
        if (mc && l.opera) var xc = l.opera.version,
            vc = "function" == typeof xc ? xc() : xc;
        else if (nc ? wc = /rv\:([^\);]+)(\)|;)/ : C ? wc = /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/ : oc && (wc = /WebKit\/(\S+)/), wc) var yc = wc.exec(ic()),
            vc = yc ? yc[1] : "";
        if (C) {
            var zc = tc();
            if (zc > parseFloat(vc)) {
    ...
    function Lc(a, b) {
        for (var c = Kc(a), d = hb(arguments, 1), e = c.length + d.length, g = c, h = 0; h < d.length; h++) y(g, d[h]) || g.push(d[h]);
        g = c.join(" ");
        a.className = g;
        return c.length == e
    }
    ...
    function Vc(a, b, c) {
        ...
        if (b) {
            d = {};
            for (g = e = 0; h = c[g]; g++) a = h.className, "function" == typeof a.split && y(a.split(/\s+/), b) && (d[e++] = h);
            d.length = e;
            return d
        }
        return c
    ...
    function kd(a) {
        if (Jc && !(C && Cc("9") && !Cc("10") && l.SVGElement && a instanceof l.SVGElement)) return a.parentElement;
        a = a.parentNode;
    ...
    function md(a, b) {
        if ("textContent" in a) a.textContent = b;
            ...
            a.firstChild.data = b
        } else hd(a), a.appendChild(Sc(a).createTextNode(String(b)))
    }
    ...
    function od(a, b, c, d) {
        if (null != a)
            for (a = a.firstChild; a;) {
                if (b(a) && (c.push(a), d) || od(a, b, c, d)) return !0;
                a = a.nextSibling
            }
        return !1
    }
    ...
    function yd(a, b, c) {
        var d;
        t: if (d = Ka(c), void 0 === a.style[d] && (c = wd() + La(c), void 0 !== a.style[c])) {
            d = c;
            break t
        } d && (a.style[d] = b)
    }
    ...
    function Ed(a) {
        if (C && !Dc(8)) return a.offsetParent;
        var b = Sc(a),
            c = Ad(a, "position"),
            d = "fixed" == c || "absolute" == c;
        for (a = a.parentNode; a && a != b; a = a.parentNode)
            if (c = Ad(a, "position"), d = d && "static" == c && a != b.documentElement && a != b.body, !d && (a.scrollWidth > a.clientWidth || a.scrollHeight > a.clientHeight || "fixed" == c || "absolute" == c || "relative" == c)) return a;
        return null
    }
        ...
        for (var b = new Eb(0, Infinity, Infinity, 0), c = Qc(a), d = c.a.body, e = c.a.documentElement, g = $c(c.a); a = Ed(a);)
            if (!(C && 0 == a.clientWidth || oc && 0 == a.clientHeight && a == d || a == d || a == e || "visible" == Ad(a, "overflow"))) {
                ...
                if (nc && !Cc("1.9")) {
                    ...
                    if (Hd(k)) var p = k.offsetWidth - k.clientWidth - m - parseFloat(zd(k, "borderRightWidth")),
                        m = m + p;
    ...
    function Gd(a) {
        var b, c = Sc(a),
            d = Ad(a, "position"),
            e = nc && c.getBoxObjectFor && !a.getBoundingClientRect && "absolute" == d && (b = c.getBoxObjectFor(a)) && (0 > b.screenX || 0 > b.screenY),
            g = new A(0, 0),
            h;
        b = c ? Sc(c) : document;
        h = !C || Dc(9) || ud(Qc(b)) ? b.documentElement : b.body;
        if (a == h) return g;
        if (a.getBoundingClientRect) b = Dd(a), a = vd(Qc(c)), g.x = b.left + a.x, g.y = b.top + a.y;
            ...
            if (mc || oc && "absolute" == d) g.y -= c.body.offsetTop;
            for (b = a;
                (b = Ed(b)) && b != c.body && b != h;) g.x -= b.scrollLeft, mc && "TR" == b.tagName || (g.y -= b.scrollTop)
        }
        return g
    }
    ...
    function Kd(a) {
        var b;
        if (a.getBoundingClientRect) b = Dd(a), b = new A(b.left, b.top);
        else {
            b = vd(Qc(a));
            var c = Gd(a);
    ...
    function Md(a, b, c) {
        if (b instanceof B) c = b.height, b = b.width;
    ...
    function Rd(a) {
        var b = a.offsetWidth,
            c = a.offsetHeight,
            d = oc && !b && !c;
        return q(b) && !d || !a.getBoundingClientRect ? new B(b, c) : (a = Dd(a), new B(a.right - a.left, a.bottom - a.top))
    }
    ...
    function Vd(a) {
        var b = Sc(a),
            c = C && a.currentStyle;
        if (c && ud(Qc(b)) && "auto" != c.width && "auto" != c.height && !c.boxSizing) return b = Wd(a, c.width, "width", "pixelWidth"), a = Wd(a, c.height, "height", "pixelHeight"), new B(b, a);
    ...
    function ee(a) {
        ...
        if (C) {
            if (c in ce) return Wd(a, b, "left", "pixelLeft");
            if (a.parentNode && 1 == a.parentNode.nodeType && c in de) return a = a.parentNode, c = Ad(a, "fontSize"), Wd(a, b == c ? "1em" : b, "left", "pixelLeft")
        }
        c = E("span", {
    ...
    function ke(a, b) {
        ...
        if (1 < c) {
            ...
            a instanceof ke ? (c = a.mc(), d = a.gc()) : (c = Qb(a), d = Pb(a));
    ...
    f.remove = function(a) {
        return ne(this.b, a) ? (delete this.b[a], this.Y--, this.g++, this.a.length > 2 * this.Y && le(this), !0) : !1
    };
    ...
    function le(a) {
        ...
        if (a.Y != a.a.length) {
            for (var e = {}, c = b = 0; b < a.a.length;) d = a.a[b], ne(e, d) || (a.a[c++] = d, e[d] = 1), b++;
            a.a.length = c
        }
    }
    f.get = function(a, b) {
    ...
    f.set = function(a, b) {
        ne(this.b, a) || (this.Y++, this.a.push(a), this.g++);
        this.b[a] = b
    };
    f.clone = function() {
        return new ke(this)
    ...
    function oe(a) {
        if ("function" == typeof a.gc) return a.gc();
    ...
    function pe(a, b, c) {
        if ("function" == typeof a.forEach) a.forEach(b, c);
        else if (ha(a) || r(a)) x(a, b, c);
        else {
            var d;
            if ("function" == typeof a.mc) d = a.mc();
            ...
            for (var e = oe(a), g = e.length, h = 0; h < g; h++) b.call(c, e[h], d && d[h], a)
        }
    };
    ...
    function se(a) {
        if (te) {
            ...
            if (b) {
                var c = b.href;
                if (c && (c = ue(c)) && c != b.hostname) throw te = !0, Error();
            }
        }
        return a.match(re)
    }
    ...
    function xe(a, b, c) {
        ...
        else null != b && c.push("&", a, "" === b ? "" : "=", ya(b))
    }

    function ye(a, b, c) {
        Math.max(b.length - (c || 0), 0);
        for (c = c || 0; c < b.length; c += 2) xe(b[c], b[c + 1], a);
        return a
    }

    function ze(a, b) {
        for (var c in b) xe(c, b[c], a);
        return a
    }
    ...
    function Fe(a, b) {
        for (var c = a.search(De), d = 0, e, g = []; 0 <= (e = Ce(a, d, b, c));) g.push(a.substring(d, e)), d = Math.min(a.indexOf("&", e) + 1 || c, c);
        g.push(a.substr(d));
    ...
    function Ge(a, b) {
        var c;
        if (a instanceof Ge) this.af = q(b) ? b : a.af, He(this, a.Kf), this.Oi = a.Oi, Ie(this, a.Me), Je(this, a.Xg), this.Yg = a.Yg, Ke(this, a.a.clone()), Le(this, a.Gl);
            ...
            Ke(this, c[6] || "", !0);
            Le(this, c[7] || "", !0)
        } else this.af = !!b, this.a = new Me(null, 0, this.af)
    }
    f = Ge.prototype;
    f.Kf = "";
    f.Oi = "";
    ...
    f.toString = function() {
        ...
        if (b = this.Yg) this.Me && "/" != b.charAt(0) && a.push("/"), a.push(Ne(b, "/" == b.charAt(0) ? Pe : Qe));
    ...
    function Ke(a, b, c) {
        b instanceof Me ? (a.a = b, Se(a.a, a.af)) : (c || (b = Ne(b, Te)), a.a = new Me(b, 0, a.af))
    }
    ...
    f.remove = function(a) {
        af(this);
        a = bf(this, a);
        return ne(this.Ma.b, a) ? (this.a = null, this.Y -= this.Ma.get(a).length, this.Ma.remove(a)) : !1
    };
    f.clear = function() {
        this.Ma = this.a = null;
        this.Y = 0
    ...
    f.gc = function(a) {
        af(this);
        var b = [];
        if (r(a)) cf(this, a) && (b = db(b, this.Ma.get(bf(this, a))));
        else {
            a = this.Ma.gc();
    ...
    function We(a, b, c) {
        a.remove(b);
        0 < c.length && (a.a = null, a.Ma.set(bf(a, b), eb(c)), a.Y += c.length)
    }
    f.toString = function() {
    ...
    f.clone = function() {
        var a = new Me;
        a.a = this.a;
        this.Ma && (a.Ma = this.Ma.clone(), a.Y = this.Y);
        return a
    };
    ...
    function Se(a, b) {
        b && !a.b && (af(a), a.a = null, pe(a.Ma, function(a, b) {
            var e = b.toLowerCase();
            b != e && (this.remove(b), We(this, e, a))
        }, a));
        a.b = b
    };
    ...
    function Ff(a) {
        if (window && window.yterr) {
            ...
            b ? b(a, void 0) : (b = zf("ERRORS") || [], b.push(a), xf("ERRORS", b))
        }
    }
    ...
    function Kf(a) {
        if (a = a || window.event) {
            for (var b in a) b in Lf || (this[b] = a[b]);
            this.scale = a.scale;
    ...
    function Uf(a, b, c) {
        ...
        var d = c,
            e = "mouse" + b;
        if (rf("pointerEnabled", window.navigator)) e = "MSPointer" + b.charAt(0).toUpperCase() + b.substr(1);
    ...
    function fg(a) {
        a && (this.name = a.name, this.tb = a.screenId, this.ic = a.loungeToken, this.Db = a.dialId || "")
    }
    f = fg.prototype;
    f.name = "";
    f.tb = "";
    ...
    Ig.prototype.b = function(a, b) {
        ...
        if (c)
            if (!b && Jg(c)) Ig.prototype.remove.call(this, a);
            else return c
    };
    ...
    function Qg(a) {
        if (!Pg && !Og || !window.JSON) return null;
        var b;
        try {
            b = Pg.get(a), b = r(b) ? b : Og.get(a)
        } catch (c) {
            return null
        }
        if (!r(b)) return null;
    ...
    function Yg() {
        ...
        a = bh(a);
        Ya(a) ? Xg.remove("remote_sid", "/", "youtube.com") : (a = a.join(","), Xg.set("remote_sid", a, void 0, "/", "youtube.com"))
    }
    ...
    function $g() {
        ...
        a || (a = lg(), Ng("yt-remote-device-id", a, 31536E3));
        for (var b = Zg(), c = 1, d = a; y(b, d);) c++, d = a + "#" + c;
        return dh = d
    }
    ...
    function lh(a) {
        a || (Rg("yt-remote-session-screen-id"), Rg("yt-remote-session-video-id"), Rg("yt-remote-session-list-id"));
        Yg();
        a = Zg();
        ab(a, $g());
        ch(a)
    ...
    f.Vs = function(a, b, c) {
        ...
        e ? (a = new Rh(1E3 * b, 1E3 * c, {
            id: a
        }), a.Ta.G("onEnter", d.Mw, d), a.Ta.G("onExit", d.Nw, d), e.wh(a), d = !0) : d = !1;
        return d
    };
    f.Ht = function() {};
    ...
    f.yn = function(a) {
        var b = this.app;
        b.g && (b.g.Wd ? Vh(b, Wh(b.g, a)) : b.Re = !1, Xh(b.g, a))
    };
    f.Mt = function(a) {
        var b = this.app;
        b.g && Yh(b.g, a)
    ...
    f.zb = function() {
        var a = this.app.g;
        if (!a) return null;
        for (var b = [], c = 0; c < a.dc; c++) b[c] = Wh(a, c).L;
        return b
    };
    f.nk = function() {
        var a;
    ...
    f.Pt = function(a) {
        var b = this.app;
        ci(b.a) && 6 != b.o && (b.a.lg = !Ya(a), b.a.lg ? 1 != b.o && 3 != b.o && di(b) : ei(b.F))
    };
    f.destroy = function() {
        this.app.dispose()
    };
    ...
    f.H = function() {
        if (this.U) {
            for (var a in this.g) this.U[a] = null;
            for (a in this.i) this.U[a] = null
        }
    ...
    f.cy = function(a, b) {
        var c = this.app,
            d = c.Ii[a];
        d && (ii(d, b), d.start(), delete c.Ii[a])
    };
    f.fy = function() {
        this.app.a.C = u()
    };
    f.hy = function(a) {
        ...
        b && (b = b.a, ji(b, a), b.B("dataupdated"))
    };
    f.$x = function() {
    ...
    oi.prototype.b = function(a, b) {
        ...
        for (pi(this, "index"); this.a > this.o;) {
            var c = this.a - this.o,
                d = this.g[0];
            d.weight <= c ? (this.a -= d.weight, this.g.shift()) : (this.a -= c, d.weight -= c)
        }
    };
    ...
    f.Uc = function(a) {
        if (0 != this.Hi) return this.b || (this.b = []), this.b.push(a), !1;
        var b = this.a[a];
        if (b) {
            var c = this.Rb[b];
            c && ab(c, a);
    ...
    f.clear = function(a) {
        if (a) {
            var b = this.Rb[a];
            b && (x(b, this.Uc, this), delete this.Rb[a])
        } else this.a.length = 0, this.Rb = {}
    };
    f.Id = function(a) {
        if (a) {
            var b = this.Rb[a];
    ...
    f.preventDefault = function() {
        ...
        else if (a.returnValue = !1, Hi) try {
    ...
    Pi.prototype.add = function(a, b, c, d, e) {
        var g = this.a[a];
        g || (g = this.a[a] = [], this.b++);
        var h = Qi(g, b, d, e); - 1 < h ? (a = g[h], c || (a.Gi = !1)) : (a = new Ni(b, this.src, a, !!d, e), a.Gi = c, g.push(a));
        return a
    };
    Pi.prototype.remove = function(a, b, c, d) {
        ...
        var e = this.a[a];
        b = Qi(e, b, c, d);
        return -1 < b ? (Oi(e[b]), bb(e, b), 0 == e.length && (delete this.a[a], this.b--), !0) : !1
    };
    ...
    function Ri(a, b) {
        ...
        var d = ab(a.a[c], b);
        d && (Oi(b), 0 == a.a[c].length && (delete a.a[c], a.b--));
        return d
    }
    Pi.prototype.removeAll = function(a) {
        ...
        for (c in this.a)
            if (!a || c == a) {
                for (var d = this.a[c], e = 0; e < d.length; e++) ++b, Oi(d[e]);
                delete this.a[c];
                this.b--
            } return b
    };
    ...
    function Qi(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var g = a[e];
            if (!g.removed && g.$e == b && g.capture == !!c && g.jb == d) return e
        }
        return -1
    };
    ...
    function Wi(a, b, c, d, e) {
        if (ga(b)) {
            for (var g = 0; g < b.length; g++) Wi(a, b[g], c, d, e);
            return null
        }
        c = Xi(c);
    ...
    function bj(a, b, c, d, e) {
        if (ga(b))
            for (var g = 0; g < b.length; g++) bj(a, b[g], c, d, e);
        else c = Xi(c), Li(a) ? a.Fd.add(String(b), c, !0, d, e) : Yi(a, b, c, !0, d, e)
    }

    function cj(a, b, c, d, e) {
        if (ga(b))
            for (var g = 0; g < b.length; g++) cj(a, b[g], c, d, e);
        else c = Xi(c), Li(a) ? a.Ib(b, c, d, e) : a && (a = Zi(a)) && (b = Si(a, b, c, !!d, e)) && dj(b)
    }

    function dj(a) {
        if (ia(a) || !a || a.removed) return !1;
        var b = a.src;
        if (Li(b)) return Ri(b.Fd, a);
        var c = a.type,
            d = a.proxy;
        b.removeEventListener ? b.removeEventListener(c, d, a.capture) : b.detachEvent && b.detachEvent(c in Ui ? Ui[c] : Ui[c] = "on" + c, d);
        Vi--;
        (c = Zi(b)) ? (Ri(c, a), 0 == c.b && (c.src = null, b[Ti] = null)) : Oi(a);
        return !0
    }
    ...
    function aj(a, b) {
        ...
        if (!Gi) {
            ...
            if (!(0 > c.keyCode || void 0 != c.returnValue)) {
                ...
                for (var g = a.type, k = c.length - 1; !d.b && 0 <= k; k--) d.currentTarget = c[k],
                e &= ej(c[k], g, !0, d);
    ...
    function ij(a, b) {
        ...
        if (d) {
            c = [];
            for (var e = 1; d; d = d.Si) c.push(d), ++e
        }
        var d = a.S,
            e = b,
            g = e.type || e;
        if (r(e)) e = new Ii(e, d);
        else if (e instanceof Ii) e.target = e.target || d;
        else {
            var h = e,
                e = new Ii(g, d);
            $b(e, h)
        ...
        var h = !0,
            k;
        if (c)
            for (var m = c.length - 1; !e.b && 0 <= m; m--) k = e.currentTarget = c[m], h = jj(k, g, !0, e) && h;
        e.b || (k = e.currentTarget = d, h = jj(k, g, !0, e) && h, e.b || (h = jj(k, g, !1, e) && h));
        if (c)
            for (m = 0; !e.b && m < c.length; m++) k = e.currentTarget = c[m], h = jj(k, g, !1, e) && h
    }
    f.H = function() {
        hj.D.H.call(this);
    ...
    function lj(a, b) {
        a.a = b;
        a.fc && a.enabled ? (a.stop(), a.start()) : a.fc && a.stop()
    }
    f.Ru = function() {
        if (this.enabled) {
            var a = u() - this.i;
            0 < a && a < 0.8 * this.a ? this.fc = this.b.setTimeout(this.g, this.a - a) : (this.fc && (this.b.clearTimeout(this.fc), this.fc = null), ij(this, "tick"), this.enabled && (this.fc = this.b.setTimeout(this.g, this.a), this.i = u()))
        }
    };
    f.start = function() {
        this.enabled = !0;
        this.fc || (this.fc = this.b.setTimeout(this.g, this.a), this.i = u())
    };
    f.stop = function() {
        this.enabled = !1;
        this.fc && (this.b.clearTimeout(this.fc), this.fc = null)
    };
    f.H = function() {
        kj.D.H.call(this);
        this.stop();
        ...
        t: {
            if (a)
                for (c = 0; c < a.length; c++)
                    if (a.start(c) <= b && a.end(c) >= b) break t;c = -1
        }
    ...
    f.playVideo = function() {
        ...
        !this.hasAttribute("src") && this.ud && (this.src = Wj(this.ud), this.ud.a || this.load());
        this.play();
    ...
    f.rp = function(a, b) {
        this.paused || this.currentTime > a || 10 < b || (this.play(), L(t(this.rp, this, this.currentTime, b + 1), 500))
    };
    f.pauseVideo = function() {
        this.pause()
    };
    ...
    function Yj(a) {
        a.currentSrc && (Pj && Xj(a, 0), hd(a), a.removeAttribute("src"), a.load(), a.ud && a.ud.a && (a.ud = null))
    }
    ...
    f.Lx = function(a) {
        ...
        x(arguments, function(a) {
            this.i.push(a);
            var c = this.b.a;
            if (!c.length || 0 < Ci(a, c[c.length - 1])) c.push(a);
            else {
                var d = jb(c, a, Ci);
                0 > d && gb(c, -(d + 1), 0, a)
            }
    ...
    f.reset = function() {
        this.pg = this.Mh = !1;
        nk(this);
        for (var a = this.i.length - 1; 0 <= a; a--) mk(this, a);
        this.Zb();
        this.k = null
    };
    ...
    function ok(a, b) {
        if (a.pg && !a.Mh)
            if (nk(a), R(b.a, 2)) {
                ...
                rk(a, c)
            } else R(b.a, 16) ? (a.g = sk(a), a.j.stop(), a.j.start(), a.Zb()) : (a.j.stop(), R(b.b, 16) ? (a.g = sk(a), null != qj(a.b, Math.max(a.g - 2E3, 0)) && (a.Ag = mj(t(a.Zb, a)))) : a.Zb())
    }
    ...
    function pk(a, b) {
        ...
        for (var d = 0; d < b.length; d++) {
            var e = b[d],
                g = a.a.indexOf(e);
            0 > g || (a.a.splice(g, 1), c.push(["onExit", e]))
        }
        return c
    }
    f.Zb = function() {
        ...
        if (!this.Nk)
            for (var a = 3; this.Mk && a;) {
                ...
                if (this.pg && !this.Mh) {
                    ...
                    this.g = b;
                    !this.Mh && this.k && (c.unshift(["onLockBlockExit", this.k]), this.k = null, R(e, 2) && (this.g = 2147483647));
                    this.A() && (b = qj(this.b, this.g), null != b && (this.Ag =
                        mj(t(this.Zb, this), b - this.g)));
                    rk(this, c)
                }
                this.Nk = !1;
                a--
    ...
    function nk(a) {
        null != a.Ag && (l.clearTimeout(a.Ag), a.Ag = null)
    }
    ...
    function Fk(a, b) {
        ...
        if (c = zf("PAGE_CL"))
            if (c = zf("PAGE_BUILD_TIMESTAMP")) {
                ...
                c = se(a)[1] || null;
                var e = zk(a);
                c && e ? (c = d, d = se(a), c = se(c), d = d[3] == c[3] && d[1] == c[1] && d[4] == c[4]) : d = e ? zk(d) == e && (Number(se(d)[4] || null) || null) == (Number(se(a)[4] || null) || null) : !0;
                c = d || Gk(a)
            } c && (b["X-YouTube-Page-CL"] = zf("PAGE_CL"), b["X-YouTube-Page-Timestamp"] = zf("PAGE_BUILD_TIMESTAMP"));
        return b
    }
    ...
    function Hk(a, b) {
        ...
        d && (a = Bk(a, d));
        var e = b.Yw || "";
        (d = b.Ze) && r(e) && (e = vk(e), $b(e, d), e = xk(e));
        var g = !1,
            h, k = Ek(a, function(a) {
                if (!g) {
                    g = !0;
                    ...
                    var d = Dk(a),
                        e = null;
                    if (d || 400 <= a.status && 500 > a.status) e = Ik(c, a);
                    if (d) t: {
                        switch (c) {
                            case "XML":
                    ...
                    var e = e || {},
                        k = b.O || l;
                    d ? b.onSuccess && b.onSuccess.call(k,
        ...
        b.Il && 0 < b.timeout && (h = L(function() {
            g || (g = !0, k.abort(), M(h), b.Il.call(b.O || l, k))
        }, b.timeout));
        return k
    }
    ...
    function Ik(a, b) {
        ...
        switch (a) {
            case "JSON":
                ...
                break;
            case "XML":
                if (d = (d = b.responseXML) ? Jk(d) : null) c = {}, x(d.getElementsByTagName("*"), function(a) {
                    c[a.tagName] = Kk(a)
                })
        }
        return c
    ...
    function Nk(a, b, c, d, e) {
        if (Bf(a)) d && window.setTimeout(d, 0);
        else {
            var g = Ak() + "/token_ajax",
                h = {};
            b && (h.az = b);
    ...
    function cl(a) {
        a = a.split("-");
        return 2 == a.length && (a = new bl(parseInt(a[0], 10), parseInt(a[1], 10)), !isNaN(a.start) && !isNaN(a.end) && !isNaN(a.length) && 0 < a.length) ? a : null
    }
    ...
    function il(a) {
        return a && a == hl ? !0 : jl(a, el) ? (hl = a, !0) : !1
    }
    ...
    function ml(a, b) {
        var c = se(a),
            d = c[6];
        d && (d = d.replace(RegExp("(^|&)" + b + "=[^&]*&?"), "$1"), "&" == d.charAt(d.length - 1) && (d = d.substring(0, d.length - 1)));
        var e = c[5];
        if (e) {
            e = e.split("/");
            e[e.length - 1] || e.pop();
    ...
    function ol(a, b) {
        var c = a,
            d;
        for (d in b) null != b[d] && (c = nl(c, d, b[d]));
        return c
    };
    ...
    function xl(a, b, c, d, e, g, h, k, m) {
        ...
        this.o = !!m;
        this.T ? (this.k = this.g + this.b == this.T.length, this.j = this.startTime + this.duration * this.g / this.T.length, this.C = this.duration * this.b / this.T.length) : (this.k = 0 != this.b, this.j = this.startTime, this.C = this.duration);
    ...
    function Hl(a) {
        if (a.info.b != a.T.length) return !1;
        if (1 == a.info.a.info.j) {
            if (8 > a.info.b || 4 == a.info.type) return !0;
            var b = Fl(a),
                c = b.getUint32(0, !1),
                b = b.getUint32(4, !1);
            if (2 == a.info.type) return c == a.info.b && 1936286840 == b;
            if (3 == a.info.type && 0 == a.info.g) return 1836019558 == b || 1936286840 == b
        }
        return !0
    };
    ...
    f.resize = function(a) {
        ...
        for (a = 0; a < this.Y + 1; a++) this.a[a] = b[a], this.b[a] = c[a]
    };
    ...
    function Ll(a) {
        for (var b = Ml(a, !1); 236 == b;) Nl(a), b = Ml(a, !1);
        return b
    }
    ...
    function Pl(a) {
        for (var b = Ml(a, !0), c = Ql(a), d = 1; d < b; d++) c = (c << 8) + Ql(a);
        return c
    }
    ...
    function Ml(a, b) {
        var c = Ql(a);
        if (1 == c) {
            for (var d = c = 0; 7 > d; d++) c = 256 * c + Ql(a);
            return c
        }
        for (var e = 128, d = 0; 6 > d && e > c; d++) c = 256 * c + Ql(a), e *= 128;
        return b ? c - e : c
    }
    ...
    f.gl = function(a) {
        var b = new xl(1, this, this.o),
            ...
            d = [],
            e = [b];
        zl(b, c) ? e.push(c) : (d.push(new Cl([c])), a = 0);
        isNaN(this.b) ? a = 0 : a > this.b && (a = this.b);
        b = e[e.length - 1];
        c = b.T.end - e[0].T.start + 1;
        a > c && (a = dl(b.T.end + 1, a - c), e.push(new xl(4, this, a)));
        d.push(new Cl(e));
        return d
    };
    f.pl = function(a) {
        if (1 == a.info.type) {
            ...
            if (this.i || 0 <= this.index.wc()) return;
            if (1 == this.info.j) {
                var b = this.index,
                    c = Fl(a),
                    d = a.info.T.start;
        ...
        if (Uk(this.info) && this.a && this.i) {
            ...
            g = this.i;
            c = new Kl(c);
            if (440786851 == Ll(c) && (Nl(c), 408125543 == Ll(c))) {
                d = c;
                e = d.a;
                a = Ml(d, !0);
                d.a = e;
                for (var c = Ol(c), d = c.g + c.a, m = Ll(c); 357149030 != m;) Nl(c), m = Ll(c);
                c = Ol(c);
                h = 1E6;
                k = 1E9;
                for (e = 0; !(c.a >= c.b.byteLength);)
                    if (m =
                        Ll(c), 2807729 == m) h = Pl(c);
                    else if (2807730 == m) k = Pl(c);
                else if (17545 == m) {
                    var e = c,
                        m = Ml(e, !0),
                        p = 0;
                ...
                if (475249515 == Ll(c)) {
                    for (c = Ol(c); !(c.a >= c.b.byteLength);)
                        if (m = Ll(c), 187 == m) {
                            ...
                            h = d;
                            if (179 != Ll(g)) k = null;
                            else if (k = Pl(g), 183 != Ll(g)) k = null;
                            else {
                                g = Ol(g);
                                for (m = h; !(g.a >= g.b.byteLength);) 241 == Ll(g) ? m = Pl(g) + h : Nl(g);
                                k = [m, k]
                            }
                            g = b;
                            h = k[0];
    ...
    f.ai = function(a) {
        for (var b = 0; b < this.index.wc() && a.T.start >= this.index.Ki(b + 1);) b++;
    ...
    f.Ge = function(a, b) {
        ...
        4 == a.type && (c = this.ai(a), a = c[c.length - 1]);
        var c = 0,
            d = a.T.start + a.g + a.b;
        3 == a.type && (c = a.Jb, d == a.T.end + 1 && (c += 1));
    ...
    f.ql = function() {
        var a;
        if (a = this.yb())
            if (a = !isNaN(this.b)) a = this.index, a = (a.g ? a.a[a.Y] : -1) != this.b;
        return a
    };
    ...
    function Wl(a) {
        ...
        x(a, function(a) {
            var d = a.type,
                e = a.itag,
                g = null;
            Wk(d) && (g = a.size.split("x"), g = new Yk(parseInt(g[0], 10), parseInt(g[1], 10)));
            var h = null;
            Vk(d) && (h = new Qk);
    ...
    function am(a) {
        ...
        if (a = $l(a, "ContentProtection"))
            if ((h = a.attributes.schemeIdUri) && "http://youtube.com/drm/2012/10/10" == h.textContent)
                for (h = {}, a = a.firstChild; null != a; a = a.nextSibling) "yt:SystemURL" == a.nodeName && (h[a.attributes.type.textContent] = a.textContent.trim());
            else h =
                null;
    ...
    Tl.prototype.C = function(a, b) {
        if (200 <= b.status && 400 > b.status) {
            ...
            if ("dynamic" == d.getAttribute("type"))
                for (this.b = !0, this.o = 1E3 * Yl(Zl(d, "minimumUpdatePeriod")), d = 0; d < c.length; d++) {
                    var e = am(c[d]);
                    if (!this.a[e.b]) {
                    ...
                    for (var h = $l(c[d],
                            "SegmentList"), m = $l(h, "SegmentTimeline"), g = m.getElementsByTagName("S"), k = h.getElementsByTagName("SegmentURL"), h = (h = Zl(h, "start")) ? Yl(h) : 0, p = parseInt(Zl(m, "startNumber"), 10) || 0, m = parseInt(Zl(m, "timescale"), 10) || 1, s = [], w = 0; w < k.length; w++) {
                        var z;
                        z = p + w;
                        var X = h,
                            J = m,
                    ...
                    this.a[e.b].update(s)
                } else i: for (this.duration =
                    Yl(Zl(d, "mediaPresentationDuration")), d = 0; d < c.length; d++) {
                    k = c[d];
                    e = am(k);
    ...
    function im(a, b) {
        if (b.g && hm(b)) return gm;
        if (b.g || hm(a)) return b;
        if (a.g || hm(b)) return a;
    ...
    function nm(a) {
        var b = [];
        a = a.split("|");
        for (var c = a[0], d, e, g, h, k, m, p, s, w = 1; w < a.length; w++) d = a[w].split("#"), e = w - 1, g = parseInt(d[0], 10), h = parseInt(d[1], 10), k = parseInt(d[2], 10), m = parseInt(d[3], 10), p = parseInt(d[4], 10), s = d[6], d = d[7], b.push(new km(g, h, k, m, p, c, s, d, e));
        this.a = b;
        this.b = {};
    ...
    function zm() {
        ...
        a || (a = document.createElement("video"), ba("yt.player.utils.videoElement_", a, void 0));
        return a
    }
    ...
    function Cm() {
        var a;
        if (void 0 == xm && (xm = !1, window.crypto && window.crypto.getRandomValues)) try {
            a = new Uint8Array(1), window.crypto.getRandomValues(a), xm = !0
        } catch (b) {}
        if (xm) {
            a = Array(16);
            ...
            for (a = Array(16), c = 0; 16 > c; c++) {
                for (var d = u(), e = 0; e < d % 23; e++) a[c] = Math.random();
    ...
    function Dm() {
        for (var a = Cm(), b = [], c = 0; c < a.length; c++) b.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(a[c] & 63));
        return b.join("")
    }
        ...
        if (b.baseUrl && b.uid) {
            ...
            if (e || c) {
                ...
                if (e) {
                    ...
                    b.ppe && (e.ppe = b.ppe);
                    var g, h = [];
                    for (g in e) h.push(encodeURIComponent(g) + "=" + encodeURIComponent(e[g]));
                    g = h.join(";");
                    d.data = g
                }
                c && "view" == a && b.vid && b.uid && (b.oeid || b.ieid) && (b.oeid && (d.oeid = b.oeid), b.ieid && (d.ieid =
                    b.ieid), d.evid = b.vid);
                c && (d.foc_id = b.uid);
                c = yk(b.baseUrl, d)
            } else c = null
    ...
    function Rm(a) {
        ...
        if (a) t: {
            var b, c;
            if (a instanceof Rm) {
                if (b = a.mc(), c = a.gc(), 0 >= a.Id()) {
                    a = this.a;
                    for (var d = 0; d < b.length; d++) a.push(new Qm(b[d], c[d]));
                    break t
                }
            } else b = Qb(a),
            c = Pb(a);
            for (d = 0; d < b.length; d++) Sm(this, b[d], c[d])
        }
    }
    ...
    function Vm(a, b, c) {
        ...
        for (c = pm(a.a, c); 0 <= c;) {
            d = a.a.a[c];
            if (d = d.i[Math.floor(b / (d.a * d.g))] ? mm(d, b) : null) return d;
            c--
        }
        return mm(a.a.a[0], b)
    }
        ...
        for (var d = 0; d < Zm.length; d++) {
            ...
            if (c[e])
                for (var g = Ym[e], h = 0; h < g.length; h++) {
                    var k = g[h];
                    if (a.canPlayType(b, k) || 0 == b.indexOf("audio/mp4") && "widevine" == e && a.canPlayType(b) && a.canPlayType('video/mp4; codecs="avc1"', k)) return new Xm(e, k, c[e])
                }
        }
        return null
    };
    ...
    dn.prototype.listen = function(a, b, c) {
        ...
        else c = t(c, this), a.addEventListener(b, c, !1), this.g.push(a, b, c)
    };
    ...
    en.prototype.u = function(a, b) {
        isNaN(this.j) || (this.b.duration = this.j, this.j = NaN, this.a = this.b.addSourceBuffer(a), this.i = this.b.addSourceBuffer(b), this.o && (this.o(this), this.o = null))
    };
    ...
    function rn(a, b) {
        for (var c = [], d = 0; d < a.length; d++) {
            var e = a[d],
                g;
            if (g = nc)
                if (g = 0 != e.ye.g.b) g = 1 == e.getInfo().j;
    ...
    function yn(a, b) {
        ...
        for (g in Rk) {
            ...
            if (k && gn(k.info.Sc) && !(0 <= k.info.Sc.indexOf("vp9") && Rj("cros armv7"))) {
                if (k.info.k) {
                    d || (d = zm());
                    if (!$m(d, k.info.Sc, k.info.k)) continue;
                    if (261 == h && !d.canPlayType('audio/mp4; codecs="aac51"', "com.widevine.alpha")) continue
                }
                vl(k.j, b);
        ...
        ob(e[g], "itag");
        k = e[g].pop();
        for (g = 0; g < e[d].length; g++) h.push(zn(k, e[d][g]));
        nb(h,
            function(a, b) {
                var c = a.getInfo(),
                    d = b.getInfo();
    ...
    function An(a, b, c) {
        ...
        for (var d = 0; d < a.length; d++) {
            var e = a[d].getInfo();
            if (Xk[e.g.a] <= b.a && !(0 < c && !b.g && a[d].a && c < e.a + a[d].b.info.a)) return a[d]
        }
        return a[a.length - 1]
    };
    ...
    function Bn(a, b) {
        ...
        if (c.ad3_module || c.ad_module) "1" == c.allow_html5_ads ? (a.ja = !0, "1" == c.ad_preroll && a.Q.push("ad")) : "1" != c.supported_without_ads && (a.Jm = !0);
        ...
        c.cc_load_policy && (a.Cm = Hn(c.cc_load_policy,
            2));
        if (c.dashmpd) {
            a.K = yk(c.dashmpd, {
                cpn: a.Fa
            ...
            var d = /\/s\/([0-9A-F.]+)/,
                e = d.exec(a.K);
            e && (e = Ok(e[1]), a.K = a.K.replace(d, "/signature/" + e))
        }
        ...
        c.loudness && (a.xb = c.loudness, a.Rh = In(a));
        ...
        c.threed_module && !c.threed_converted && (a.V = c.threed_module, a.Jc = 6);
        if ("1" == c.track_embed || c.tk) a.sj = !0;
    ...
    f.zx = function(a) {
        if (!this.ia()) {
            if (this.u = a) this.Aa = this.u.duration || this.Aa;
            this.Ml()
        }
    };
    f.Ml = function() {
        this.ia() || (this.wd = !1, this.B("dataloaded", this.b))
    };
    ...
    function Mn(a) {
        if (!a.ia()) {
            ...
            a.S = null;
            a.A = null;
            if (a.u && (a.k = yn(a.u, Nn(a)), a.k.length)) {
    ...
    function Nn(a) {
        var b = {};
        a.F && (b.ptk = a.F, b.oid = a.ob, b.ptchn = a.mb, b.pltype = a.lb);
        return b
    }
    ...
    function In(a) {
        return a.xb ? (a = Math.min(-21 - a.xb, 10), Math.pow(10, a / 20)) : 1
    }
    f.Sx = function(a) {
        this.ia() || (this.wd = !1, a = vk(a.responseText), "fail" == a.status ? this.B("onStatusFail", a) : (Bn(this, a), this.wd || this.Ml()))
    };
    f.Rx = function() {
        this.ia() || (this.wd = !1, this.B("onStatusFail", {
            errorcode: 100,
            reason: ""
        }))
    };
    ...
    function Xn(a) {
        ...
        if (a.list) switch (a.listType) {
            ...
            case "search":
                ...
                break;
            default:
                a.playlist_length && (this.dc = a.playlist_length), this.g = Wn(a.list), ao(this)
        } else if (a.playlist) {
            ...
            this.Wd = !0
        } else a.videoList && (0 < this.xa && (this.a = []), x(a.videoList, function(a) {
            this.a.push(new Lh(a))
        }, this), this.dc = this.a.length, this.Wd = !0);
        Yh(this, !!a.shuffle)
    }
    v(Xn, T);
    f = Xn.prototype;
    ...
    function Wh(a, b) {
        ...
        if (c = a.a && c in a.a ? a.a[a.b[c]] : null) c.Ha = a.Sk || c.Mj || 0;
        return c
    }
    ...
    function Yh(a, b) {
        ...
        if (a.Uo) {
            ...
            for (d = 0; d < a.b.length; d++) a.b[d] == c && (a.xa = d)
        }
        a.B("shuffle")
    }
    ...
    function Yn(a, b) {
        a.Ug || (a.g = new Vn("UU", "PLAYER_" + b), go(a, "/list_ajax?style=json&action_get_user_uploads_by_user=1", {
            username: b
        }))
    }

    function Zn(a, b) {
        a.Ug || (a.g = new Vn("FL", "PLAYER_" + b), go(a, "/list_ajax?style=json&action_get_favorited_by_user=1", {
            username: b
        }))
    }
    ...
    function ho(a, b) {
        if (b.video && b.video.length) {
            ...
            x(b.video, function(a) {
                a && (a.video_id = a.encrypted_id, c && a.video_id == c.L && (this.xa = this.a.length), this.a.push(new Lh(a)))
            }, a);
            a.dc = a.a.length;
            Yh(a, !1);
            a.Ug = !1;
    ...
    f.Gd = function(a) {
        var b = this.Of.Gd(!0),
            ...
            d = new ge;
        d.next = function() {
            for (var d = b.next(); d.substr(0, c.cf.length) != c.cf;) d = b.next();
    ...
    function jo(a) {
        ...
        if (this.El) {
            ...
            var b = new Cg;
            if (a = b.isAvailable() ? a ? new io(b, a) : b : null) this.o = new Eg(a)
        }
    }
    v(jo, T);
    f = jo.prototype;
    ...
    f.create = function() {
        this.Df || (this.eb(this.a), G(S(this.a), this.pa + "-created"), this.Df = !0)
    };
    f.destroy = function() {
        this.unload();
    ...
    function po(a, b, c) {
        var d = {},
            e;
        for (e in b) d[a.pa + "_" + e] = b[e];
        b = {};
        for (var g in c) b[a.pa + "_" + g] = c[g];
    ...
    function Fo(a, b, c) {
        ...
        if (r(b[d]) || ga(b[d]) || null === b[d]) {
            var g = b[d++];
            ga(g) && (g = g.join(" "));
            if (g = Go(a, e, "className", g)) Ho(a, e, "className", g), Io(a, g, e)
        }
        for (; d < b.length; d++) {
            var h = b[d];
            if (ga(h)) Fo(a, h, e);
                ...
                var g = a,
                    k = e,
                    m = void 0;
                for (m in h) h[m] && Ho(g, k, m, Go(g, k, m, h[m]))
            } else r(h) && Ho(a, e, "child", Go(a, e, "child", h))
        }
        c && c.appendChild(e);
        return e
    }
    ...
    function Io(a, b, c) {
        var d = b.split(" ");
        if (1 < d.length)
            for (b = 0; b < d.length; b++) Io(a, d[b], c);
        else a.a[b] = c
    }
    f.X = function(a, b) {
    ...
    function Go(a, b, c, d) {
        return r(d) && "{{" == d.substr(0, 2) ? (a.b[d] = [b, c], null) : d
    }
    f.update = function(a) {
        for (var b in a) Jo(this, b, a[b])
    };

    function Jo(a, b, c) {
        if (c != a.g[b]) {
            var d = a.b["{{" + b + "}}"];
            d && (a.g[b] = c, Ho(a, d[0], d[1], c))
        }
    }
    ...
    function So(a, b) {
        (a = Tc(a)) && a.style && (Ud(a, b), I(a, "hid", !b))
    }
    ...
    function Xo(a) {
        if (a in Wo) return Wo[a];
        var b;
        if ((b = document.body.style) && a in b) b = a;
        else {
            var c = wd();
            c ? (c = c.toLowerCase(), c += La(a), b = !q(b) || c in b ? c : null) : b = null
        }
        return Wo[a] = b
    }
    ...
    function cp(a, b, c) {
        if (!c) {
            c = a.clientHeight;
            a = a.clientWidth;
            if ((900 < a || 600 < c) && b.Po) return b.Po;
            if ((430 < a || 320 < c) && b.Qo) return b.Qo
        }
    ...
    function hp() {
        Y.call(this, ["div", "ytp-watch-next-card", ["div", "ytp-watch-next-content", ["div", "ytp-watch-next-header", "{{watchnext}}"],
    ...
    function jp(a, b, c, d, e, g, h) {
        ...
        }, g && (a.authuser = g), h && (a.pageid = h), Hk("/get_video_metadata", {
            method: "GET",
            onError: d,
            onSuccess: c,
            xf: a,
    ...
    kp.prototype.create = function() {
        ...
        if (this.i) {
            ...
            a && zo(a[0]) && (ip(this.i, a[0]), this.i.X(this.j))
        }
    ...
    kp.prototype.A = function(a, b) {
        if (this.C) {
            ...
            this.i && b.watch_next && (ip(this.i, b.watch_next), this.i.X(this.j));
            d = b.video_info;
            d.subscription_ajax_token && Af("subscription_ajax", d.subscription_ajax_token);
            c = c.subscription_button_html;
            this.a.template.a["html5-subscribe-button-container"].innerHTML =
                c ? c : ""
        }
    };
    ...
    function op(a) {
        a.b || (a.b = D("ad-container", S(a.ca)), a.ca.N().Hb && G(a.b, "ad-container-single-media-element"));
        return a.b
    }

    function pp(a) {
        a.a && (a.ca.N().Hb ? (H(a.a, "ad-video"), qp(a.ca.app, a.a), a.a = null) : (F(a.a), Zj(a.a)))
    }
    ...
    function rp(a) {
        if (!a.g) {
            if (a.ca.N().Ub) {
                ...
                c.appendChild(b);
                op(a).appendChild(c)
            } else b = dd("div"), ff(b, ["video-click-tracking", "ad-video"]), op(a).appendChild(b);
            a.g = b
        }
        return a.g
    }
    np.prototype.H = function() {
        np.D.H.call(this);
        this.a && (qp(this.ca.app, this.a), this.a = null);
        pp(this);
        hd(op(this));
        hd(rp(this));
        this.g = this.b = null;
    ...
    function xp(a, b) {
        b && "" != b && (a.C && H(a.element, a.C), a.C = b, G(a.element, b))
    }
    f = vp.prototype;
    f.Ab = function(a) {
    ...
    f.Yv = function(a) {
        this.i && (a.stopImmediatePropagation(), a.preventDefault())
    };
    f.Zv = function(a) {
        if (13 == a.keyCode || 32 == a.keyCode) a.stopPropagation(), a.preventDefault(), Zf(this.element, "click")
    };
    f.H = function() {
        var a = this.I;
        if (a.a) {
    ...
    f.update = function(a, b) {
        ...
        var e = Xb(a);
        c || d ? (e.index = parseInt(e.index, 10) + 1, e.title || (e.title = a.playlist_title, e.author = a.playlist_author), e.playlist_length || (e.playlist_length = 0)) : e.duration = Ep(a.length_seconds);
        var g = dp(c && a.thumbnail_ids ? a.thumbnail_ids.split(",")[0] : this.o, b ? "hqdefault.jpg" : "mqdefault.jpg");
        this.a.style.backgroundImage = "url(" +
            g + ")";
    ...
    f.select = function(a, b) {
        ...
        c.a.$a || "detailpage" != c.a.Z ? g ? (c.Re = !1, Sh(c, d, void 0, void 0, void 0)) : Nh(c, d, 1) : (g = new Lh(d), g = Lp(c.a, g.L, g.Pa, {}, void 0), n("yt.player.exports.navigate")(g, e, !0), c.Dj(g, b))
    };
    f.mu = function() {
        var a = new Date - this.C;
        1E4 > a ? (Dp(this.b, a / 1E4), a = 1E4 - a, D("videowall-still-listlabel-autoplay-message", this.a).innerHTML = If("AUTOPLAY_MESSAGE", Math.ceil(a / 1E3))) : (Ef(this.g), this.select(!0))
    };
    f.nu = function(a) {
    ...
    function Np(a) {
        if (a.C && a.a && a.a.length) {
            ...
            g = 0;
            for (b = a.o; g < b; g++) c = Op(a, g), a.k.appendChild(c.M());
    ...
    function Qp(a) {
        ...
        if (a.N().Ji) {
            ...
            this.Ve = b
        } else a.N().xc ? this.Ve = new Mp(this.a, this.C, this) : this.Ve = new yo(this.a, this.C)
    }
    v(Qp, jo);
    f = Qp.prototype;
    f.pa = "endscreen";
    ...
    function Wp(a) {
        ja(l.setImmediate) ? l.setImmediate(a) : (Xp || (Xp = Yp()), Xp(a))
    }
    var Xp;
        ...
        if (0 == a.b)
            if (a.g) {
                ...
                if (c.a) {
                    ...
                    0 <= e && (0 == c.b && 1 == d ? kq(c, b) : (d = c.a.splice(e, 1)[0], lq(c, d, 3, b)))
                }
            } else hq(a, 3, b)
    }
    ...
    gq.prototype.u = function() {
        for (; this.a && this.a.length;) {
            var a = this.a;
            this.a = [];
            for (var b = 0; b < a.length; b++) lq(this, a[b], this.b, this.k)
        }
        this.j = !1
    };
    ...
    */
    ...
    f = rq.prototype;
    f.cancel = function(a) {
        if (this.a) this.g instanceof rq && this.g.cancel();
        else {
            if (this.b) {
                var b = this.b;
                delete this.b;
    ...
    function uq(a) {
        if (a.k && a.a && Aq(a)) {
            var b = a.k,
                c = Bq[b];
            c && (l.clearTimeout(c.Yr), delete Bq[b]);
            a.k = 0
        }
        a.b && (a.b.C--, delete a.b);
        for (var b = a.g, d = c = !1; a.j.length && !a.o;) {
            ...
            if (g = a.i ? h : g) try {
                ...
                q(k) && (a.i = a.i && (k == b || k instanceof Error), a.g = b = k);
                fq(b) && (d = !0, a.o = !0)
            } catch (m) {
                b = m, a.i = !0, Aq(a) || (c = !0)
            }
        ...
        a.g = b;
        d && (k = t(a.$m, a, !0), d = t(a.$m, a, !1), b instanceof rq ? (yq(b, k, d), b.I = !0) : b.then(k, d));
        c && (c = ++Cq, Bq[c] = new Dq(c, b), a.k = c)
    }
    ...
    function Eq(a, b) {
        ...
        e.onload = e.onreadystatechange = function() {
            e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Gq(e, c.Rv || !1, k), h.Lf(null))
        };
        e.onerror = function() {
            Gq(e, !0, k);
    ...
    Jq.prototype.send = function(a, b, c, d) {
        ...
        var e = this.b.clone();
        if (a)
            for (var g in a) a.hasOwnProperty && !a.hasOwnProperty(g) || Ve(e, g, a[g]);
        b && (l._callbacks_[d] = Lq(d, b), Ve(e, this.a, "_callbacks_." + d));
        b = Eq(e.toString(), {
            timeout: this.nc,
            Rv: !0
        });
    ...
    Jq.prototype.cancel = function(a) {
        a && (a.hc && a.hc.cancel(), a.Da && Nq(a.Da, !1))
    };
    ...
    function Pq() {
        this.g = new Eo(["div", "html5-fresca-module", ["div", "html5-fresca-band-slate", ["hgroup", "html5-fresca-message", ["h2", "html5-fresca-heading", "{{heading}}"],
    ...
    Pq.prototype.j = function() {
        var a;
        a = this.a;
        a.startTime ? (a = a.a, a = 6 == a || 8 == a || 7 == a ? !1 : !0) : a = !1;
        I(this.b, "html5-fresca-show-countdown", a);
        a && (this.g.update({
            countdown: Qq(this.a.startTime)
        }), M(this.i), this.i = L(t(this.j, this), 1E3))
    };
    ...
    function Sq(a, b) {
        ...
        if (c) {
            ...
            if (c = c.yt$slate) c.imgUrl && (a.g = "url(" + c.imgUrl + ")"), (c = c.content) && c.length && (c = c.splice(0, 3), a.b = Ra(c, function(a) {
                return a.$t
            }))
        }
    };
    ...
    f.Go = function(a) {
        this.b && (this.gi = R(a.a, 2), (Uq(a, 16) || this.gi) && Vq(this, this.b))
    };
    f.xv = function() {
        this.Bg || (this.b = new Rq, Vq(this, this.b))
    };
    f.yv = function(a) {
        this.b = new Rq(a);
    ...
    f.ad = 0;
    f.play = function(a) {
        if (a || 0 == this.a) this.ad = 0, this.b = this.g;
        else if (1 == this.a) return !1;
        $q(this);
        this.startTime = a = u(); - 1 == this.a && (this.startTime -= this.duration * this.ad);
        this.endTime = this.startTime + this.duration;
        this.ad || this.Zc();
        this.Qb("play"); - 1 == this.a && this.Qb("resume");
        this.a = 1;
        var b = la(this);
        b in Yq || (Yq[b] = this);
        ar();
    ...
    f.pause = function() {
        1 == this.a && ($q(this), this.a = -1, this.Qb("pause"))
    };
    f.H = function() {
    ...
    function cr(a, b) {
        ...
        1 <= a.ad && (a.ad = 1);
        fr(a, a.ad);
        1 == a.ad ? (a.a = 0, $q(a), a.Rc(), a.ee()) : 1 == a.a && a.Al()
    }

    function fr(a, b) {
        ja(a.j) && (b = a.j(b));
        a.b = Array(a.g.length);
        for (var c = 0; c < a.g.length; c++) a.b[c] = (a.k[c] - a.g[c]) * b + a.g[c]
    }
    f.Al = function() {
        this.Qb("animate")
    };
    ...
    function ir(a) {
        if (!jr.test(a)) throw Error("'" + a + "' is not a valid hex color");
    ...
    function Kr(a, b) {
        ...
        var c = c.replace(/https?:\/\//g, ""),
            d;
        (d = !Jr(c)) || (d = ve(c) || "", d = d.split("/"), d = "/" + (1 < d.length ? d[1] : ""), d = "/watch" != d);
        if (d) return -1;
        d = wk(c);
        if (!d || d.v != b || d.list || d.p) return -1;
        c = c.split("#", 2);
        if (!c || 2 > c.length) return -1;
        (c = vk(c[1])) && c.t ? (d = c.t, c = 0, -1 != d.indexOf("h") && (d = d.split("h"), c = 3600 * d[0], d = d[1]), -1 != d.indexOf("m") && (d = d.split("m"), c = 60 * d[0] + c, d = d[1]), -1 != d.indexOf("s") ? (d = d.split("s"), c = 1 * d[0] + c) : c = 1 * d + c) : c = -1;
        return c
    }
    ...
    function Wr(a) {
        ...
        d = E("div", "branding-context-container-inner iv-view-target",
            c, d, e);
    ...
    f.show = function() {
        this.j || (this.b || (Wr(this), this.b = !0), this.oc(), Yr(this.O.rf, this.ta), Uo(this.element), this.j = !0, this.pi(this.a))
    };
    f.hide = function() {
        this.j && (Vo(this.element), this.j = !1)
    };
    f.oc = function() {
        var a = this.O.a.pb,
            b = this.O.a.Qc;
    ...
    f.Ib = function(a, b, c, d, e) {
        if (ga(b))
            for (var g = 0; g < b.length; g++) this.Ib(a, b[g], c, d, e);
        else c = c || this.handleEvent, e = e || this.b || this, c = Xi(c), d = !!d, b = Li(a) ? Si(a.Fd, String(b), c, d, e) : a ? (a = Zi(a)) ? Si(a, b, c, d, e) : null : null, b && (dj(b), delete this.a[b.key]);
        return this
    };
    f.removeAll = function() {
        Lb(this.a, dj);
    ...
    bs.prototype.add = function(a) {
        y(this.b, a) || (this.b.push(a), Wi(a, "finish", this.i, !1, this))
    };
    ...
    cs.prototype.play = function(a) {
        ...
        if (a || 0 == this.a) this.g = 0, this.Zc();
        else if (1 == this.a) return !1;
        this.Qb("play"); - 1 == this.a && this.Qb("resume");
        var b = -1 == this.a && !a;
        this.startTime = u();
    ...
    cs.prototype.i = function() {
        this.g++;
        this.g == this.b.length && (this.endTime = u(), this.a = 0, this.Rc(), this.ee())
    };
    ...
    function hs(a) {
        ...
        ur(a.subscribeData);
        (a = ur(a.duration)) ? (a = Cr(a.value), a = new ds(a)) : a = null;
    ...
    function ss(a, b, c) {
        ...
        c = a.clone();
        b && !b.contains(a) && (a.width < b.width ? c.left = Bb(a.left, b.left, b.left + b.width - a.width) : (c.left = b.left, c.width = b.width), a.height < b.height ? c.top = Bb(a.top, b.top, b.top + b.height - a.height) : (c.top = b.top, c.height = b.height));
        return c
    }
    ...
    function Ls(a) {
        ...
        var c = yr(a.type, Js),
            ...
            h;
        var k = ur(a.segment);
        k ? (vr(k.timeRelative), h = vr(k.spaceRelative), h = (k = Dr(k.movingRegion, ys)) ? new As(h, k) : null) : h = null;
        var k = Dr(a.action, hs),
            m = Dr(a.trigger, Fs),
            p = js(ur(a.appearance));
        p || (p = js({}));
        var s = yr(a.coordinate_system, Ks, "video_relative"),
            w;
    ...
    function Us(a) {
        a.b ? (a = a.b, a = a.a.length ? a.a[0] : null) : a = null;
        return a
    }
    ...
    function Tr(a, b, c, d) {
        b && b.k && Xr(b) && (d = Xs(a, b, 3, d), d["i-time"] = a.a[b.id] || "", a.log_(d, c))
    }

    function Rr(a, b, c) {
        b && b.k && (c = Xs(a, b, 4, c), c["i-time"] = a.a[b.id] || "", a.log_(c))
    }
    ...
    function Xs(a, b, c, d) {
        ...
        e["a-id"] = b.id;
        e["a-type"] = Ys(b);
        if (c = Xr(b)) e.link = escape(Ir(c)), c.a && (e["l-class"] = c.a);
    ...
    f.Xu = function(a) {
        ...
        a.Tc - 500 < b && a.Tc + 500 > b && !this.pd.enabled && (this.oc(), this.k.innerHTML = "", b = E("span", "iv-cards-image"), xd(b, "background-image", 'url("' + a.a + '")'), gd(this.k, b, E("span", "iv-cards-notif-text", a.title)), Od(this.k, ""), a = this.k.offsetWidth, (new nr(this.k, 0, a, 400, tr)).play(), this.pd.Em = new nr(this.k, a, 0, 200, tr), this.pd.enabled = !0, this.pd.Kj.start())
    };
    f.Yu = function() {
        this.F.pop();
        bt(this, this.F.length)
    ...
    function bt(a, b) {
        0 == b ? (a.A.innerHTML = "", Lc(a.i, "iv-cards-notif-inactive")) : (10 > b ? a.A.innerHTML = b : a.A.innerHTML = "*", Mc(a.i, "iv-cards-notif-inactive"))
    }
    f.rw = function() {
        if (!this.o) {
            var a = new cs;
            ...
            2 == this.O.He.getPlayerState() ? this.K = !0 : (this.K = !1, this.O.He.pauseVideo());
            a.add(dt(this.i));
            a.add($s(this.C));
            for (b = 0; b < this.a.length; ++b) c = 200, b == this.u && (c *= 2), a.add($s(this.a[b].gk, c));
            this.o = !0;
    ...
    f.oc = function() {
        if (this.O.a.Qc && this.O.a.pb) {
            To(this.b) && (Md(this.element, this.O.a.pb), Bd(this.b, et(this)));
            var a = Ur(this),
                a = a ? Qd(a).height : 0;
    ...
    function kt(a) {
        ...
        d.appendChild(c);
        b.playlist_length && (c = E("div", "invideo-playlist-length iv-click-target"), md(c, b.playlist_length), d.appendChild(c));
        ...
        var e = [jt(a, 0, a.Sv, a.element)],
            h = 0;
        b.text_line_custom && (h = E("span", "iv-text-line1 iv-text-context iv-click-target"), md(h, b.text_line_custom), Vo(h), d.appendChild(h), e.push(jt(a, 300, a.Og, h), jt(a, 3E3, a.pi, h)), h = 3250);
    ...
    f.show = function() {
        this.j || (this.g || (kt(this), this.g = !0), this.oc(), Uo(this.element), Yr(this.O.rf, this.ta || null), this.j = !0, this.b.play())
    };
    f.hide = function() {
        if (this.j) {
            this.b.stop();
    ...
    lt.prototype.i = function(a, b, c, d) {
        ...
        this.b != a && (this.b = a, this.g.B(this.j, a, d))
    };
    ...
    function vt(a, b, c) {
        0 == Na(a.ya) ? a.Jd.length -= 2 : (a.ya.push(0), a.Y.push(1));
        a.Jd.push(b, c);
        a.fd = a.Nf = [b, c]
    }
    f.La = function(a) {
        ...
        1 != b && (this.ya.push(1), this.Y.push(0));
    ...
    f.close = function() {
        ...
        4 != a && (this.ya.push(4), this.Y.push(1), this.fd = this.Nf);
        return this
    };
    ...
    f.Pl = function(a) {
        if (this.Ui && this.Ui != a) throw Error("Method not supported");
        Ct.D.Pl.call(this, a)
    };
    f.Fp = function() {
    ...
    f.H = function() {
        ...
        var a = this.U;
        if (a)
            if (Li(a)) a.removeAllListeners(void 0);
            else if (a = Zi(a)) {
            var b = 0,
                c;
            for (c in a.a)
                for (var d = eb(a.a[c]), e = 0; e < d.length; ++e) dj(d[e]) && ++b
        }
    };
    ...
    function Ht(a, b, c, d) {
        ...
        a = this.Pj;
        b = this.M();
        c ? (b.setAttribute("stroke", c.b), c = c.a, r(c) && -1 != c.indexOf("px") ? b.setAttribute("stroke-width", parseFloat(c) / Ft(a)) : b.setAttribute("stroke-width", c)) : b.setAttribute("stroke", "none");
        c = this.Pj;
        a = this.M();
        if (d instanceof zt) a.setAttribute("fill", d.u), a.setAttribute("fill-opacity", d.A);
    ...
    f.Fp = function() {
        ...
        a.appendChild(b);
        this.U = a;
        this.g && (this.M().setAttribute("preserveAspectRatio", "none"), this.C ? this.So() : this.M().setAttribute("viewBox", "0 0 " + (this.g ? this.g + " " + this.k : "")))
    };
    f.So = function() {
        if (this.We) {
            var a = this.Wg();
            if (0 == a.width) this.M().style.visibility = "hidden";
            else {
    ...
    f.Wg = function() {
        if (!nc) return this.We ? Pd(this.M()) : Rt.D.Wg.call(this);
        var a = this.width,
            b = this.height,
            c = r(a) && -1 != a.indexOf("%"),
            d = r(b) && -1 != b.indexOf("%");
        if (!this.We && (c || d)) return null;
        var e, g;
        c && (e = this.M().parentNode, g = Qd(e), a = parseFloat(a) * g.width / 100);
        d && (e = e || this.M().parentNode, g = g || Qd(e), b = parseFloat(b) * g.height / 100);
        return new B(a, b)
    };
    f.clear = function() {
        this.b.clear();
    ...
    Xt.prototype.u = function() {
        if (this.g) {
            ...
            a >= this.j && (this.stop(), this.o && this.o())
        }
    };
    ...
    f.X = function(a, b) {
        ...
        for (var c = 0, d = 0; d < this.a.length; d++) c = Math.max(c, Pd(this.a[d].M()).width);
        if (c)
            for (d = 0; d < this.a.length; d++) Od(this.a[d].M(), c)
    };
    f.Ia = function(a) {
        this.b = a;
        for (var b = 0; b < this.a.length; b++) au(this.a[b], b == a)
    };
    ...
    function au(a, b) {
        ...
        } else c = a.M(), H(c, "ytp-segmented-control-selected"), G(c, "ytp-segmented-control-deselected")
    }
    f.kv = function(a) {
        for (var b = 0; b < this.a.length; b++)
            if (this.a[b] == a.currentTarget) {
                b != this.b && (this.Ia(b), Zf(this.element, "change"));
                break
            }
    };
    f.H = function() {
    ...
    function eu(a, b, c) {
        a.g ? (Md(a.g.M(), b, c), a.g.clear()) : (b = new Rt(b, c, void 0, void 0, void 0), a.g = b, a.g.Fp(), a.U = E("div"), b = a.g.M(), a.U.appendChild(b));
        return a.g
    }
    ...
    function qu(a, b, c, d) {
        var e = a.I;
        e ? a = new st(e.j * b / 100, e.o * c / 100, e.k * b / 100, e.C * c / 100, e.a, e.b, e.g, e.i) : (b = ru(d, a.g), a = new zt(a.j, b));
        return a
    }
    ...
    function su(a, b) {
        var c = new Eb(a.top, a.left + a.width, a.top + a.height, a.left),
            d = nu(b);
        ka(d) ? (c.top -= d.top, c.right += d.right, c.bottom += d.bottom, c.left -= d.left) : (c.top -= d, c.right += void 0, c.bottom += void 0, c.left -= NaN);
        return Ib(c)
    }

    function tu(a, b, c) {
        if (c.length && (b = Vc("g", void 0, b), b.length)) {
            var d = lu(c);
            if (d) {
                c = "effects:" + (d ? d.join("|") : "");
                var e = It(a, c);
                e ? a = e : (d = ku(d), a = 0 < d.childNodes.length ? Kt(a, c, d) : null)
            } else a = null;
            ...
            if (!(0 >= h.width || 0 >= h.height)) {
                ...
                if (k = (a = (a = Us(a)) && a.a ? a.a : null) && a.length ? a[0] : null) {
                    ...
                    var p = this.j(h, b, s, m),
                        ...
                        U = new tt;
                    vt(U, J + b + k, h + k);
                    "t" == m && (U.La(p.start, h + k), U.La(w, s), U.La(p.end, h + k));
                    U.La(J + z - b - k, h + k);
                    wt(U, b, b, -90, 90);
                    "r" == m && (U.La(J + z - k, p.start),
                        U.La(w, s), U.La(J + z - k, p.end));
                    U.La(J + z - k, h + X - b - k);
                    wt(U, b, b, 0, 90);
                    "b" == m && (U.La(p.end, h + X - k), U.La(w, s), U.La(p.start, h + X - k));
                    U.La(J + b + k, h + X - k);
                    wt(U, b, b, 90, 90);
                    "l" == m && (U.La(J + k, p.end), U.La(w, s), U.La(J + k, p.start));
                    U.La(J + k, h + b + k);
                    wt(U, b, b, 180, 90);
                    U.close();
                    Ut(a, U, e, g);
                    if (e = this.M()) G(e, "annotation-shape"), G(e, "annotation-speech-shape"), Bd(e, c.left, c.top), Md(e, c.width, c.height), tu(a, e, d.a)
                }
            }
        }
    };
    ...
    wu.prototype.b = function(a, b, c) {
        var d = Ts(a);
        d && (b = ss(d, b, c), 0 >= b.width || 0 >= b.height || (a = a.a, c = su(b, a.a), d = eu(this, c.width, c.height), ou(d, new Hb(0, 0, b.width, b.height), a.b, new At(!a.i && this.a ? 1 : a.i, a.j), new zt("#000", 0)), b = this.M(), G(b, "annotation-shape"), Td(b, ru(this.a, a.g)), Bd(b, c.left, c.top), Md(b, c.width, c.height)))
    };
    ...
    xu.prototype.b = function(a, b, c) {
        ...
        if (!(0 >= d.width || 0 >= d.height)) {
            ...
            if (a =
                ...
                Td(a, k);
                if (this.j && 0 < b.i) {
                    var k = new At(b.i, b.j),
                        d = new Hb(0, 0, d.width, d.height),
                        m;
                    m = pu(d, b.b, k.a / 2 + 1);
                    var p = It(g, "mask");
                    if (p) m = p;
    ...
    zu.prototype.b = function(a, b, c) {
        ...
        if (d) {
            ...
            if (!(0 >= e.width || 0 >= e.height)) {
                ...
                ou(d, g, b.b, a, e);
                if (a = this.M()) G(a, "annotation-shape"), G(a, "annotation-popup-shape"), Bd(a, c.left, c.top), Md(a, c.width, c.height), tu(d, a, b.a)
            }
        }
    };
    ...
    function Eu(a) {
        if (a.a.C) {
            ...
            Os(a.a, function(a) {
                return "close" == a.type
            }) ? b = a.g : (a.k = E("div", "annotation-close-button hid"), jf(a.k, "annotation_id", a.a.id), a.g.appendChild(a.k), b = a.k);
            var c = function(a) {
                a.stopPropagation()
            };
    ...
    Bu.prototype.K = function() {
        ...
        this.j && Td(this.j, 1);
        var a = Fu(this);
        this.i && (this.i.a = !0, Td(this.g, Gu(this) ? 1 : 0), a && this.i.b(this.a, a, Hu(this)))
    };
    Bu.prototype.J = function() {
        this.k && Vo(this.k);
        this.j && Td(this.j, 0);
        var a = Fu(this);
        this.i && (this.i.a = !1, Td(this.g, Gu(this) ? 1 : 0), a && this.i.b(this.a, a, Hu(this)))
    };
            ...
            if (b) {
                ...
                if (a.g && c) {
                    ...
                    if (e) {
                        ...
                        var h;
                        h = a.a.a;
                        h.padding ? h = h.padding : (h = "speech" == a.a.style ? 1.6 : 0.8, h = new Eb(h, h, h, h));
                        e = Vs(a.a, e);
                    ...
                    "label" == a.a.style &&
                        a.o && (a.o.style.padding = a.g.style.padding);
                    a.j && (e = 4.2 * c.height / 100, e = new B(e, e), Md(a.j, e), "highlight" == a.a.type || "label" == a.a.style ? (g = 1.5 * c.height / 100, e = new A(b.width - e.width - g, b.height - e.height - g)) : e = new A(b.width - e.width - 3 * c.height / 100, (b.height - e.height) / 2), Bd(a.j, e));
                    a.k && (e = 9 <= c.left + c.width - (b.left + b.width), g = 9 <= b.top - c.top, Bd(a.k, e && g ? new A(b.width - 9, -9) : e ? new A(b.width - 9, 45 < b.height ? 9 : b.height - 9) : g ? new A(45 < b.width ? b.width - 9 - 18 : -9, -9) : b.width / c.width > b.height / c.height ? new A(45 < b.width ? b.width -
                        9 - 18 : -9, b.height - 9) : new A(-9, 45 < b.height ? 9 : b.height - 9)))
                }
                a.i && c && a.i.b(a.a, c, d);
                if (a.g) {
                    c = a.g;
                    ...
                    if (a.scrollHeight > a.offsetHeight || a.scrollWidth > a.offsetWidth)
                        for (e = b = ee(a), g = Math.floor(b /
                                2); g;) e = a.scrollHeight <= a.offsetHeight && a.scrollWidth <= a.offsetWidth ? Math.min(e + g, b) : Math.max(e - g, 5), g = Math.floor(g / 2), a.style.fontSize = e + "px";
                    a.style.overflow = c;
                    d && Uo(d)
                }
            }
    ...
    Bu.prototype.show = function() {
        ...
        if (a) {
            ...
            if (d) {
                ...
                e && (e.b(this.a, d, Hu(this)),
                    this.i = e, d = e.M()) && (Vo(d), G(d, "annotation-type-" + this.a.type.toLowerCase()), this.A(d))
            }
        }
        if (b) {
            d = ["annotation", "hid"];
            ...
            this.g = E("div", d);
            this.a.o && ("label" == this.a.style ? (this.o = E("div", ["label-text"]), this.o.style.backgroundColor = this.a.a.j, md(this.o, this.a.o), this.g.appendChild(this.o)) : md(this.g, this.a.o));
            jf(this.g, "annotation_id", this.a.id);
            this.A(this.g);
            Cu(this, this.g);
            if (Ps(this.a) &&
                "image" != this.a.type && Ns(this.a)) {
                if (d = Xr(this.a)) this.g.title = Ir(d);
        ...
        if (a || b) {
            ...
            this.g && (this.g.style.zIndex = a);this.i && this.i.M() && (this.i.M().style.zIndex = a)
        }
        Uo(this.g);
        Td(this.g, Gu(this) ?
            1 : 0);
    ...
    function Iu(a) {
        ...
        this.u = E("DIV",
            ["video-annotations", "html5-stop-propagation"]);
        mo(this, this.u);
        mo(this, a);
    ...
    f.load = function() {
        ...
        b.Ak && (this.g++, Hk(b.Ak, a));
        b.zk && (this.g++, Hk(b.zk, a));
        if (b.yk) {
            var a = t,
                c = this.Lo,
                d = t,
            ...
            t: {
                g = {};
                if (!Vb(b.Va) && (Lu(g, b, "cta_annotation_shown"), Lu(g, b, "cta_annotation_clicked"), Lu(g, b, "cta_annotation_closed"), !Vb(g))) break t;
                var h = b.Ga;h ? (Mu(g, "cta_annotation_shown", h), Mu(g, "cta_annotation_clicked", h), Mu(g, "cta_annotation_closed", h)) : g = null
            }
            a = {
                format: "XML",
                method: "GET",
        ...
        if (this.g && !this.aa) {
            ...
            if (Dk(b) && c) {
                ...
                for (d in this.b) {
                    ...
                    if (g = e) e = 1E3 * g.start, g = 1E3 * g.end, 0 == e && (e++, g++), e == g && g++, g < e ||
                        (e = new Rh(e, g, {
                            id: d
                        }), c.push(e))
                }
    ...
    function Ru(a, b) {
        ...
        switch (b.style) {
            ...
            case "product":
            case "fundraising":
                a.j || (a.j = new Zs(c, e)), a.j.add(new Zr(b.id, b.data, Xr(b), b)), d = a.j
        }
        d && (c = d, c.ta && (e = c.ta.data, "start_ms" in e && "end_ms" in e && Pr(c, c.ta.data.start_ms, c.ta.data.end_ms, c.ta.id)), Or(c));
        return d
    }
    ...
    f.uc = function(a) {
        ...
        a = a.getId();
        var b = this.b[a];
        b && !b.Yb && (b = b.ta, "pause" == b.type ? Su(this, b) : (Tu(this, a), Yr(this.k, b)))
    };
    f.Yc = function(a) {
        Iu.D.Yc.call(this, a);
        Uu(this, a.getId())
    ...
    function Su(a, b) {
        if (a.J) {
            ...
            c && (a.I = !0, a.B("command_pause"), a.A.start(1E3 * c.duration.value))
        }
    }
    ...
    function Uu(a, b, c) {
        if (b = a.b[b]) pt(b), c && c.b ? (a = t(a.ap, a, b), b.a = new Xq(a, 2E3), b.a.start()) : a.ap(b)
    }
    f.ap = function(a) {
        a && (a.hide(), Wu(this, "shown", !1, a.ta.id), Xu(this, a.ta, "hidden"))
    };

    function Tu(a, b, c) {
        if (b = a.b[b]) pt(b), c && c.i ? (a = t(a.Io, a, b), b.a = new Xq(a, 2E3), b.a.start()) : a.Io(b)
    }
    f.Io = function(a) {
        a && (a.show(), Wu(this, "shown", !0, a.ta.id), Xu(this, a.ta, "shown"))
    };
    f.Jx = function(a, b, c) {
        var d = this.b[a];
        if (d && b.value != c) {
    ...
    function Xu(a, b, c) {
        ...
        Qs(b, function(a) {
            if (a.trigger == c) switch (a.type) {
                case "log":
                    a.url && (d[a.url.value] = 1, ua(a.url.value, function() {
                ...
                case "openUrl":
                    e = t(function() {
                        var c = this.a.getVideoData(),
                            d = Kr(a.url, c.L);
                        if (-1 != d) this.B("command_seek", d), this.vj();
                        else if (c = Lr(a.url, b.id, c.L)) this.pauseVideo(), window.open(c, Mr(a.url))
                    }, this)
            }
        }, a);
        !Ob(d) && e && e()
    ...
    f.Jq = function(a) {
        if (a || a.id) this.b[a.id].Yb = !0, Uu(this, a.id), a && (Rr(this.k, a), Xu(this, a, "close")), Wu(this, "closed", !0, a.id)
    };
    f.vj = function() {
        this.A.stop();
        this.I && (this.I = !1, this.B("command_play"))
    };
    ...
    function iv(a, b) {
        0 == b ? (dv(a.b), ev(a.a)) : 1 == b ? (ev(a.b), dv(a.a)) : (ev(a.b), ev(a.a))
    }
    ...
    function jv(a, b, c, d, e, g) {
        ...
        if (h = c.offsetParent) {
            ...
            m && "static" == Ad(h, "position") || (k = Gd(h), m || (m = (m = Hd(h)) && nc ? -h.scrollLeft : !m || C && Cc("8") || "visible" == Ad(h, "overflowX") ? h.scrollLeft : h.scrollWidth - h.clientWidth - h.scrollLeft, k = Db(k, new A(m, h.scrollTop))))
        }
        h = k || new A;
        k = Sd(a);
        if (m = Fd(a)) {
            ...
            if (m <= s) {
                ...
                w <= p && (k.left =
                    m, k.top = w, k.width = s - m, k.height = p - w)
            }
        }
        m = Qc(a);
        w = Qc(c);
        ...
        if (e = Fd(c)) e.top -= h.y, e.right -= h.x, e.bottom -= h.y, e.left -= h.x;
    ...
    function lv(a, b, c, d, e, g, h) {
        ...
        if (g && (e ? (d = a, k = 0, 65 == (g & 65) && (d.x < e.left || d.x >= e.right) && (g &= -2), 132 == (g & 132) && (d.y < e.top || d.y >= e.bottom) && (g &= -5), d.x < e.left && g & 1 && (d.x = e.left, k |= 1), d.x < e.left && d.x + h.width > e.right && g & 16 && (h.width = Math.max(h.width - (d.x + h.width - e.right), 0), k |= 4), d.x + h.width > e.right && g & 1 && (d.x = Math.max(e.right - h.width, e.left),
                k |= 1), g & 2 && (k = k | (d.x < e.left ? 16 : 0) | (d.x + h.width > e.right ? 32 : 0)), d.y < e.top && g & 4 && (d.y = e.top, k |= 2), d.y <= e.top && d.y + h.height < e.bottom && g & 32 && (h.height = Math.max(h.height - (e.top - d.y), 0), d.y = e.top, k |= 8), d.y >= e.top && d.y + h.height > e.bottom && g & 32 && (h.height = Math.max(h.height - (d.y + h.height - e.bottom), 0), k |= 8), d.y + h.height > e.bottom && g & 4 && (d.y = Math.max(e.bottom - h.height, e.top), k |= 2), g & 8 && (k = k | (d.y < e.top ? 64 : 0) | (d.y + h.height > e.bottom ? 128 : 0)), e = k) : e = 256, e & 496)) return;
        Bd(b, a);
        Fb(c, h) || (e = ud(Qc(Sc(b))), !C || e && Cc("8") ?
            (b = b.style, nc ? b.MozBoxSizing = "border-box" : oc ? b.WebkitBoxSizing = "border-box" : b.boxSizing = "border-box", b.width = Math.max(h.width, 0) + "px", b.height = Math.max(h.height, 0) + "px") : (a = b.style, e ? (e = Xd(b), b = Yd(b), a.pixelWidth = h.width - b.left - e.left - e.right - b.right, a.pixelHeight = h.height - b.top - e.top - e.bottom - b.bottom) : (a.pixelWidth = h.width, a.pixelHeight = h.height)))
    }
    ...
    function pv(a) {
        ...
        if ("HTML" != a.target.tagName && c) {
            ...
            if (b = mv[a.type])
                for (d in b.Rb)(e = ov(a.type, d, a.target)) && b.B(d, e, a.type, a)
        }
    }
    ...
    N(document, "cut", pv);
    N(document, "paste", pv);
    nv && (N(document, "touchstart", pv), N(document, "touchend", pv), N(document, "touchcancel", pv));
    ...
    f.Xl = function(a) {
        ...
        if (b = K(a, "tooltip-text")) a.title = b
    };
    f.oy = function(a, b, c) {
        this.ej = 0;
        ...
        if (b) {
            ...
            if (c) {
                ...
                if (!d) {
                    ...
                    zv(b,
                        c);
                    (c = parseInt(K(b, "tooltip-max-width"), 10)) && e.offsetWidth > c && (e.style.width = c + "px", Lc(h, $(a, "normal-wrap")));
                    h = Oc(b, $(a, "reverse"));
    ...
    function Cv(a, b, c, d, e, g) {
        ...
        if ("left" == b || g) k = -5;
        else if ("right" == b || h) k = 20 - c.width - 3;
        d.style.left = Math.floor(k) +
            "px";
        return !(e || a)
    }
    ...
    function yv(a, b) {
        if (b) {
            var c = Tc(Av(a, b));
            c && (Dv(c), F(c), a.removeData(b, "content-id"))
        }
    }
    ...
    function Bv(a, b) {
        var c = null;
        hc && Oc(b, $(a, "masked")) && ((c = Tc("yt-uix-tooltip-shared-mask")) ? (c.parentNode.removeChild(c), Uo(c)) : (c = document.createElement("iframe"), c.src = 'javascript:""', c.id = "yt-uix-tooltip-shared-mask", c.className = $(a, "tip-mask")));
        return c
    }
    ...
    function Dv(a) {
        ...
        b && c && (b.parentNode.removeChild(b), Vo(b), document.body.appendChild(b))
    };
    ...
    function Gv(a, b, c, d, e) {
        if (ef(c, "html5-async-progress")) return null;
        Fv(b, c);
    ...
    function Iv(a, b, c) {
        ...
        if (d) return isNaN(c) && (c = 0), d(a, b, c);
        if (isNaN(c)) a();
        else return L(a, c || 0)
    }
    ...
    function Vv(a) {
        var b = Ae("/signin?context=popup", "next", document.location.protocol + "//" + document.domain + "/post_login"),
            b = Ae(b, "feature", "sub_button");
        if (b = window.open(b, "loginPopup", "width=375,height=440,resizable=yes,scrollbars=yes", !0)) {
            var c = Rv("LOGGED_IN", function(b) {
                Tv(zf("LOGGED_IN_PUBSUB_KEY"));
                xf("LOGGED_IN", !0);
                a(b)
            });
            xf("LOGGED_IN_PUBSUB_KEY", c);
    ...
    f.Jp = function(a) {
        ...
        if (b) a = K(a, "target") || "_self", window.open(b, a);
        else if (c) {
            ...
            e = K(a, "parent-url");
            K(a, "is-subscribed") ? (g = K(a, "subscription-id"), Uv("subscription-unsubscribe",
                b, g, d, a, c, e)) : Uv("subscription-subscribe", b, d, a, c, e)
        } else Xv(this, a)
    };
    f.Ip = function(a) {
        this.Qf(a, this.kq, !0)
    ...
    f.lq = function(a, b, c) {
        b ? (jf(a, "is-subscribed", "true"), c && jf(a, "subscription-id", c)) : (this.removeData(a, "is-subscribed"), this.removeData(a, "subscription-id"));
        Yv(a)
    };
    f.kq = function(a, b) {
    ...
    function Yv(a) {
        ...
        Pc(a, d, c);
        K(a, "subscriber-count-tooltip") && !K(a, "subscriber-count-show-when-subscribed") && (b = $(vv.getInstance()), Pc(a, b, !c), a.title = c ? "" : K(a, "subscriber-count-title"));
        c ? L(function() {
            Lc(a, "hover-enabled")
    ...
    f.ry = function(a) {
        ...
        !K(a, "ypc-enabled") && b && c && d && (Lc(a, "ypc-enabled"), jf(a, "ypc-enabled", "true"))
    };
    f.qy = function(a) {
        K(a, "ypc-enabled") && (Mc(a, "ypc-enabled"), this.removeData(a, "ypc-enabled"))
    };
    ...
    function $v(a, b, c) {
        ...
        g = e.join(",");
        if (b.noreferrer) {
            if (b = d.open("", a, g)) C && -1 != c.indexOf(";") && (c = "'" + c.replace(/'/g, "%27") + "'"), b.opener = null, c = Aa(c), b.document.write('<META HTTP-EQUIV="refresh" content="0; url=' + c + '">'), b.document.close()
        } else b =
            d.open(c, a, g);
        return b
    }
    ...
    function aw(a, b) {
        ...
        (c = $v(a, c)) ? (c.opener || (c.opener = window), c.focus()) : c = null;
        return !c
    };
    ...
    function cw() {
        Y.call(this, ["div", "ytp-sentiment-display", ["div", "ytp-sentiment-bar", ["div", "ytp-sentiment-bar-likes"],
    ...
    function dw() {
        var a = ["button", "ytp-button-share-more", ["div", "ytp-button-share-more-icon yt-uix-button-icon-new-window"],
            ["span", "ytp-button-share-more-content", Z("YTP_BUTTON_MORE_SHARE")]
        ];
        Y.call(this, a)
    }
    v(dw, Y);
    ...
    f.iu = function(a, b) {
        if (!this.ia()) {
            ...
            g.innerHTML = d.subscription_button_html ?
                d.subscription_button_html : "";
            d = Wv.getInstance();
            (d = D($(d), g)) && fp(this.k, d);
    ...
    f.lu = function(a, b) {
        if (!this.ia()) {
            ...
            d.X(c);
            ef(this.a, "show-share") && (d.a.focus(), d.a.select());
    ...
    function iw() {
        Y.call(this, ["div", "ytp-playlist-tray-index-length", ["span", "ytp-playlist-tray-index", "{{index}}"],
            ["span", "", " / "],
            ["span", "ytp-playlist-tray-length", "{{length}}"]
        ])
    }
    v(iw, Y);
    ...
    function jw(a) {
        ...
        this.wa([
            ...
            ["div", "ytp-button-playlist-text", Z("YTP_BUTTON_PLAYLIST")]
        ])
    }
    v(jw, bv);
    ...
    function lw(a, b, c, d) {
        a = ["div", "ytp-playlist-tray-action-info", ["div", "ytp-playlist-tray-playlist-title", b],
            ["div", "ytp-playlist-tray-author-name", Z("YTP_AUTHOR_ATTRIBUTION", {
                author: c
            })],
    ...
    function mw(a) {
        var b = ["div", "ytp-playlist-tray-action-share", ["div", "ytp-playlist-tray-action-share-heading", Z("YTP_SHARE_PLAYLIST")],
            ["div", "share-bar-services"]
        ];
        Y.call(this, b);
        this.i = a;
        this.b = new Ao(this);
    ...
    function nw(a, b) {
        Y.call(this, ["div", "ytp-playlist-tray-item", ["span", "ytp-playlist-tray-item-index", "{{index}}"],
    ...
    function pw(a, b) {
        b != a.a && (a.a && a.a.ba("shuffle", a.g, a), a.a = b, a.a.G("shuffle", a.g, a), a.g())
    }
    ow.prototype.g = function() {
        ...
        for (var a = 0; a <= this.a.dc - 1; ++a) {
            var b = Wh(this.a, a);
            b && (b = new nw(b, a), b.yg(this.a.xa), this.b.push(b), this.i.listen(b, "click", qa(this.C, a)), b.X(this.element))
        }
    };
    ...
    function qw(a) {
        ...
        this.b = new Ao(this);
        this.F = mi(a).j;
        this.j = new Eo(["div", ["ytp-playlist-tray-container", "html5-stop-propagation"],
            ["div", ["ytp-playlist-tray-info", "show-more-info"]]
        ]);
        O(this, this.j);
        a = this.j.M();
    ...
    f.destroy = function() {
        this.a.zb() || (this.ba("fullscreentoggled", this.xm, this), this.ba("videodatachange", this.ym, this), this.ba("onResize", this.zj, this), this.ba("clearvideooverlays", this.unload, this), pw(this.i, null), qw.D.destroy.call(this))
    };
    f.load = function() {
        this.aa = !0;
        qw.D.load.call(this);
        var a = this.a.zb();
        this.I || (pw(this.i, a), a.G("shuffle", this.hu, this), this.I = !0);
        for (var a = this.i, b = 0; b < a.b.length; b++) a.b[b].yg(a.a.xa);
        dv(this.g.b)
    };
    f.unload = function() {
        this.aa = !1;
    ...
    f.Fm = function() {
        if (this.aa) this.unload();
        else if (this.B("command_clear_video_overlays"), this.load(), this.zj(), !this.k) {
    ...
    f.Xt = function() {
        ...
        Mc(a, "show-more-info");
        Lc(a, "show-share");
        this.J || (this.u = new mw(this.F), this.u.X(a), this.J = !0, Hk("/share_ajax", {
            O: this,
            method: "GET",
            onError: this.Mv,
            onSuccess: this.Nv,
    ...
    f.Ye = function() {
        this.qa && (0 != this.id && (Od(this.oa, "100%"), Od(this.oa, this.qa.offsetWidth)), Aw(this), So(this.oa, this.ua.isVisible))
    };

    function Aw(a) {
        Bd(a.oa, a.ua.hi + "%", a.ua.ce + "%");
        for (var b = 0; 8 >= b; b++) H(a.oa, "anchor-point-" + b);
    ...
    f.toString = function() {
        var a = "Caption window (" + this.id + "): " + this.Mg,
            b;
        for (b in this.ua) a += b + " " + this.ua[b] + " | ";
        return a
    };
    ...
    function Dw(a, b, c) {
        ...
        q(b) && this.Ab(b);
        q(c) && this.u != c &&
            (this.a.wa(c), this.u = c, Ew(this));
        Ew(this)
    }
    v(Dw, Y);
    Dw.prototype.Ab = function(a) {
        this.i != a && (this.C.wa(a), this.i = a, Ew(this))
    };
    ...
    function Fw(a, b) {
        b > a.A && (a.A = b, a.element.style.minWidth = a.A + "px")
    }

    function Ew(a) {
        a.g ? (a.a.show(), a.listen(window, "blur", a.j, a, "menu"), a.listen(document, "click", a.j, a, "menu")) : (a.a.hide(), Oo(a, "menu"));
        var b = Pd(a.b.M());
    ...
    function Jw(a, b) {
        if (!pb(a.a, b)) {
            for (var c = 0; c < a.a.length; c++) Kw(a, a.a[c]).zf();
            a.a = [];
            x(b, function(a) {
                this.a.push(a);
                var b = Kw(this, a);
    ...
    function Pw(a, b) {
        a.i[b] && (a.C = b, a.j.Ia(b), a.element.Ab(a.u(b)))
    }
    ...
    Mw.prototype.F = function(a) {
        this.element.j();
        a != this.g ? (Pw(this, a), Zf(this.element, "change")) : Zf(this.element, "select")
    };
    ...
    f.Ye = function() {
        0 != this.id && (Od(this.oa, "100%"), Od(this.oa, this.Lg ? Tw(this) : this.Cb.width));
    ...
    f.Qe = function(a) {
        ...
        for (var b = 0, c = a.length; b < c; b++)
            if (a[b]) {
                ...
                d.appendChild(e);
                e.innerHTML = a[b];
                this.Lg || (this.qa.style.height = this.Cb.height + "px", this.qa.style.width = this.Cb.width + "px", d.style.position = "absolute", d.style.top = this.Cb.to[b] + "px", d.style.left = this.Cb.ro[b] + "px");
    ...
    f.Tl = function() {
        this.oa.style.textAlign = this.ua.textAlign;
        for (var a = 0, b = this.Ob.length; a < b; a++) this.Ob[a].style.backgroundColor = this.ua.backgroundColor;
        this.qa.style.color = this.ua.fi;
        this.qa.style.opacity = this.ua.Sl;
        this.qa.style.fontFamily = this.ua.Op;
        1 == this.ua.Je ? this.qa.setAttribute("dir", "rtl") : this.qa.removeAttribute("dir")
    ...
    f.gp = function(a) {
        ...
        if (0 >= b) this.bj();
            ...
            for (var c = 0; c < b && 0 <= this.Fc.indexOf(a[c]);) c++;
    ...
    function Ww(a) {
        if (!Yw(a))
            if (a.le >= a.Fc.length) Xw(a);
            else {
                var b = a.Eb.length - 1;
                0 > b && (a.ke.push(0), a.le = 0, a.Eb.push(""), b = 0);
                for (var c = a.Fc.length, d = a.le; d < c; d++) {
                    ...
                    if (e.Zi || 0 == a.Eb[b].length) a.Eb[b] += e.be, a.le++, a.ke[b]++;
                    else break
                }
                Xw(a);
                d < c && !Yw(a) && (b = a.Yi(), G(a.qa, "caption-rollup"), a.oa.style.overflow = "hidden", a.qa.style.top = -b + "px", a.Mf.start())
            }
    }
    ...
    function Xw(a) {
        if (!Yw(a)) {
            for (; a.Eb.length < a.ua.xd;) a.Eb.unshift(""), a.ke.unshift(0);
            for (; a.Eb.length > a.ua.xd;) {
                a.Eb.shift();
                var b = a.ke.shift();
                0 < b && (a.le -= b, a.Fc.splice(0, b))
            }
            a.Qe(a.Eb.join("\n"))
        }
    }
    ...
    function ex(a) {
        ...
        this.g = [];
        this.a = {};
        if (a && (a = dx(a)) && a.firstChild) switch (this.i = a, this.i.firstChild.tagName) {
            case "timedtext":
                    ...
                    case "window":
                        ...
                        t: {
                            ...
                            if (d.getAttribute("t") || d.getAttribute("start")) {
                                ...
                                d.getAttribute("ap") && (h = parseInt(d.getAttribute("ap"), 10), k.anchorPoint = 0 > h || 8 < h ? 7 : h);
                                d.getAttribute("ah") && (k.hi = parseInt(d.getAttribute("ah"), 10));
                                d.getAttribute("av") && (k.ce = parseInt(d.getAttribute("av"),
                                    10));
                                ...
                                d.getAttribute("sd") &&
                                    (k.vk = parseInt(d.getAttribute("sd"), 10));
                        ...
                        break;
                    case "text":
                        e = ax(a[b]), this.b.push(e), d = e.$h, this.a[d] && (d = this.a[d], e = e.be, "" != d.g && (d.b = !0), d.g += e)
                }
                break;
            default:
                for (this.g.push(cx()), a = this.i.firstChild.childNodes, b = 0, c = a.length; b < c; b++) e = ax(a[b]), this.b.push(e)
        }
    }
    ex.prototype.b = null;
    ex.prototype.g = null;
    ...
    function hx(a) {
        ...
        a.a && (a = a.a, b.translationLanguage = {
            languageCode: a.a,
            languageName: a.b,
    ...
    function kx(a, b) {
        switch (b.Lb) {
            case "asr":
                return lx(b, a.b);
            default:
                if (b.ki || 0 > a.g) a.g = a.a.length;
                return lx(b, a.a)
        }
    }

    function lx(a, b) {
        return Ua(b, t(a.equals, a)) ? !1 : (b.push(a), !0)
    };
    ...
    function mx(a, b, c, d) {
        ...
        c ? this.Ed = Bk(this.Ed, {
            hl: c
        }) : (a = wk(this.Ed).hl || "", a = a.split("_").join("-"), this.Ed = Bk(this.Ed, {
            hl: a
        }));
        this.Ei = b;
        this.Up = !!d;
    ...
    function qx(a, b) {
        ...
        d = t(function(a) {
                if ((a = a.responseXML) && a.firstChild) {
                    ...
                    c = a.length;
                    for (d = 0; d < c; d++) k = a[d].getAttribute("lang_code"), m = a[d].getAttribute("lang_translated"), p = a[d].getAttribute("lang_original"), s = a[d].getAttribute("id"), w = "true" == a[d].getAttribute("lang_default"), k = {
                        languageCode: k,
                        languageName: m,
                        languageOriginal: p,
                        id: s,
                        is_default: w
                    }, this.Vp[k.languageCode] = k.languageName, this.qi.push(new fx(k))
                }
                b()
            },
            a);
    ...
    function rx(a) {
        ...
        Co(this.i,
            D("captions-settings-char-edge-style", b), this.Cu, "SELECT");
    ...
    f.create = function() {
        ...
        var a = this.a.N().V; - 1 == xw.indexOf(a) && G(S(this.a), "cc-international");
        this.b = Xb(sx);
        ra(this.b, qo(this, "display-settings"));
        this.B("module_menu_button_add", this.pa, this.k);
        vo(this, this.j);
        1 == this.ze.b.cc_load_policy || 1 == this.Xc.Cm || "alwayson" == Pn(this.Xc, "yt:cc") ? a = !0 : (a = qo(this, "module-enabled"), a = null != a ? !!a : "on" == Pn(this.Xc, "yt:cc") || this.ze.b.cc_prefer_on);
        a && this.load()
    };
    f.destroy = function() {
        this.unload();
    ...
    f.load = function() {
        if (this.Rg || this.aa) this.aa && (rx.D.load.call(this), this.Ck = "alwayson" == Pn(this.Xc, "yt:cc"), ro(this, "module-enabled", !0), this.Rg = !1, tx(this), this.Gm());
        else {
            this.Rg = !0;
            this.aa = !1;
    ...
    f.unload = function() {
        ...
        this.j.Ia(1);
        Qw(this.g, !0);
        this.sc && (ux(this, !1), this.Pn("control_subtitles_set_track"));
        vx(this, !1);
        wx(this);
        oo(this);
        ro(this, "module-enabled", !1);
        this.K = this.Rg = !1;
        this.aa && (this.aa = !1, rx.D.unload.call(this))
    };
    f.log_ = function() {};

    function xx(a, b) {
        a.A && (hd(a.A), x(b, function(a) {
            var b = dd("option");
    ...
    f.fp = function() {
        ...
        if (0 < a.length) {
            ...
            a = b.Dc.g;
            b = jx(b.Dc, !0);
            (a = 0 > a ? null : b[a]) ? (this.Dk = !0, yx(this, a)) : (this.aa || (this.aa = !0, this.load(), a = this.vb.Dc.b, a.length && (a = a[0].toString(), Pw(this.g, a), this.K && zx(this, a))), this.B("publish_external_event", "onCaptionsTrackListChanged"))
    ...
    f.Pv = function(a, b) {
        ...
        this.ac = b;
        this.Hn = sw.test(b.b);
        this.aa || (this.aa = !0, this.load());
        this.Dk && (this.Dk = !1, this.B("publish_external_event", "onCaptionsTrackListChanged"));
        c = Ra(c, function(a, b) {
    ...
    f.uc = function(a) {
        0 == a.getId().indexOf("caption") && (a = parseInt(a.getId().split("caption")[1], 10), !isNaN(a) && this.Ee[a] && (this.de.push(this.Ee[a]), L(t(this.Ri, this), 0)))
    };
    f.Yc = function(a) {
        0 == a.getId().indexOf("caption") && (a = parseInt(a.getId().split("caption")[1], 10), !isNaN(a) && this.Ee[a] && (a = this.de.indexOf(this.Ee[a]), 0 <= a && this.de.splice(a, 1), L(t(this.Ri, this), 0)))
    };
    ...
    function Ax(a, b) {
        if (b instanceof bx) {
            var c = a.Ka[b.id];
            ra(b.params, a.b);
            c && c.getType() != (b.params.vk ? 2 : b.b ? 0 : 1) && (F(c.oa), delete a.Ka[b.id]);
            if (!a.Ka[b.id]) {
                var c = a.Ka,
                    d = b.id,
                    e;
                ...
                0 == a.Ka[b.id].id ? (G(c, a.pa), jd(mi(a.a).I, c, 0)) : mo(a, c)
            }
            ...
            if (0 == (b.params.vk ?
                ...
                c.Cb.ro = [];
                c.Cb.to = [];
                for (d = 0; d < c.Cb.xd; d++) c.Cb.to.push(c.Ob[d].offsetTop), c.Cb.ro.push(c.Ob[d].offsetLeft);
                c.Lg = !1;
                c.Qe(c.Mg)
            }
        } else c = b.$h, a.Td[c] || (a.Td[c] = []), a.Td[c].push(b)
    }
    f.Gm = function() {
        if (this.aa) {
            oo(this);
            ...
            this.yp = a / 360;
            tx(this);
            for (var b in this.Ka) this.Ka[b].Ye();
            if (b = D("html5-popup-dialog-body", this.mi)) b.style.maxHeight = a - 180 + "px"
        }
    };
    ...
    f.Ri = function() {
        if (this.aa) {
            var a = this.de.length,
                b;
            for (b in this.Td) delete this.Td[b];
            this.de.sort(function(a, b) {
                return a.a == b.a ? a.i - b.i : a.a - b.a
            });
            for (var c = 0; c < a; c++) Ax(this, this.de[c]);
            for (b in this.Ka) this.Td[b] ? this.Ka[b].gp(this.Td[b]) : (F(this.Ka[b].oa), delete this.Ka[b]);
            Cx(this);
            this.Hd && this.Hd.Ye();
    ...
    f.Bu = function(a) {
        ...
        isNaN(a) || (this.b.backgroundOpacity = a, tx(this))
    };
    f.Hu = function(a) {
        a = parseFloat(a.target.getAttribute("value"));
        isNaN(a) || (this.b.textOpacity = a, tx(this))
    };
    f.Ju = function(a) {
        a = parseFloat(a.target.getAttribute("value"));
        isNaN(a) || (this.b.windowOpacity = a, tx(this))
    };
    f.Cu = function(a) {
        a.target && (this.b.charEdgeStyle = a.target.value, tx(this))
    };
    f.Gu = function(a) {
        a.target && (this.b.fontFamilyOption = a.target.value, tx(this))
    };
    f.Fu = function() {
        var a = this.Ka[0];
        a && a.oa && (a = a.oa, H(a, "controls-hidden"), G(a, "controls-visible"))
    };
    f.Eu = function() {
        var a = this.Ka[0];
        a && a.oa && (a = a.oa, ef(a, "controls-visible") && (H(a, "controls-visible"), G(a, "controls-hidden")))
    };
    f.bo = function() {
        Ex(this, -1)
    };
    ...
    function Gx(a, b, c) {
        var d = D(b);
        d && (b = d.querySelector("span.yt-uix-form-input-select-value"), d = d.querySelector("select"), d.value = a.b[c], md(b, d.options[d.selectedIndex].text))
    }
    ...
    function yx(a, b) {
        if (b)
            if (a.sc) a.ac = b, ux(a, !0), a.Pn("control_subtitles_set_track", hx(b)), a.aa || (a.aa = !0, a.load());
            else if (a.ze.Uu) {
            var c = a.vb,
                d = a.Gh.b,
                e = t(a.Qn, a),
    ...
    f.Iu = function() {
        if (!this.Ck) {
            ...
            a && (c = this.ac, b = new gx, b.b = c.b, b.Jg = c.Jg, b.cc = c.cc, b.Lb = c.Lb, b.ki = !1, b.li = c.li, b.a = a, kx(this.vb.Dc, b) && (a = b.toString(), vo(this, this.g), Nw(this.g, jx(this.vb.Dc, !0)), Pw(this.g, a)), yx(this, b))
        }
    };
    f.xu = function() {
        Vo(this.mi)
    ...
    function tx(a, b) {
        ...
        d = a.b.windowOpacity;
        a.ha = lp(".caption-window-transform", "background-color: rgba(" +
            c[0] + "," + c[1] + "," + c[2] + "," + d + ") !important;", {
                vc: a.ha,
                reset: !0
            });
        ...
        if ("none" == c) a.F && mp(a.F);
            ...
            switch (c) {
                ...
                case "raised":
                    ...
                    break;
                case "depressed":
                    d = "text-shadow: 1px 1px " + e + ", 0 1px " + e + ", -1px -1px " +
                        g + ", 0 -1px " + g + ";";
                    break;
                case "uniform":
        ...
        switch (a.b.fontFamilyOption) {
            ...
            case "cursive":
                ...
                break;
            case "smallCaps":
                c = '"Arial Unicode Ms", Arial, Helvetica, Verdana, "Marcellus SC", sans-serif', d = "font-variant: small-caps;"
        }
    ...
    f.Nu = function() {
        ...
        this.aa && !a ? (this.unload(), xo(this)) : !this.aa && a ? (this.K = !0, this.load()) : this.g.C && this.Wn()
    };
    f.Au = function() {
        oo(this);
        no(this);
    ...
    f.yu = function() {
        this.Ck || (oo(this), no(this), Uo(this.Pk));
        xo(this)
    };
    ...
    f.pq = function(a, b) {
        switch (a) {
            case "fontSize":
                return isNaN(b) || (this.b.fontSizeIncrement = Math.max(-2, Math.min(4, b)), tx(this)), this.b.fontSizeIncrement;
            case "reload":
            ...
            case "track":
                if (b) {
                    if (!ka(b)) break;
                    var c = new gx(b);
                    c.equals(this.ac) || (yx(this, c), Pw(this.g, c.toString()))
                } else return this.ac ? hx(this.ac) : {};
                return "";
            case "unloadTrack":
                wx(this);
                break;
            ...
            case "displaySettings":
                return b &&
                    ka(b) && Kx(this, b), c = Xb(this.b), delete c.fontFamily, c;
    ...
    function vx(a, b) {
        ...
        } else !b && a.Hd && (F(a.Hd.oa), a.Hd = null)
    }
    f.np = function() {
    ...
    function Kx(a, b) {
        if (b)
            if (Wb(b, "reset")) a.Dm();
                ...
                var c = Ox,
                    d;
                for (d in c) a.b[d] = c[d](b[d], a.b[d]);
                tx(a, ti())
            }
    }
    ...
    rx.prototype.Sh = function(a) {
        a ? (a = this.ac, wx(this), this.ac = a) : (ux(this, this.aa), this.ac && yx(this, this.ac))
    };

    function ux(a, b) {
        b ? (gv(a.k, "ytp-subtitles-button-active"), a.j.Ia(0)) : (gv(a.k, "ytp-subtitles-button"), a.j.Ia(1))
    }
    ...
    function Vx(a, b) {
        ...
        if (c.Ij && c.wf != b) {
            var c = a.a.app,
                d = Q(c);
            d.a.g && d.a.g.a || (d.a.wf = !d.a.wf, Mn(d.a), Wx(d, "r"));
            Tx(c);
            b ? Rx(a) : oo(a)
        }
    }
    ...
    function Rx(a) {
        qo(a, "warning-shown") || Px() || (a.bf = D("threed-html5-warning-dialog", S(a.a)), Uo(a.bf), L(t(function() {
            Xx(this)
        }, a), 0), N(a.bf, "mouseover", t(function() {
            H(this.bf, "hide-dialog")
        }, a)), N(a.bf, "mouseout", t(function() {
            Xx(this)
        }, a)), Sx(a, "threed-html5-warning-close", t(a.xw, a)))
    }
    ...
    function Yx(a) {
        jo.call(this, a);
        this.b = new Eo(["div", "ytp-ypc-clickwrap-overlay", ["h2", "header", Hf("YPC_CLICKWRAP_HEADER")],
            ["div", "description", this.a.getVideoData().b.ypc_clickwrap_message],
            ["button", "confirm-button", Hf("YPC_CLICKWRAP_BUTTON")]
        ]);
        Mo(this.b.M());
        a = this.b.M();
        mi(this.a).g.appendChild(a);
    ...
    function ay() {
        Y.call(this, ["div", ["ytp-drawer", "html5-stop-propagation"],
    ...
    ay.prototype.wa = function(a) {
        a ? (ay.D.wa.call(this, a), Lo(this.element)) : Mo(this.element)
    };
    ...
    function by(a, b) {
        ...
        this.g = new Eo(["div", "html5-ypc-module", ["div", "html5-ypc-action-heading", "{{heading}}"],
    ...
    f.eu = function() {
        if (this.b.a) "embedded" == this.a.N().Z ? $v(this.b.a) : window.location = yk(this.b.a, {}) + "";
        else if (this.b.b) {
    ...
    f.Ix = function(a) {
        R(a.a, 2) ? (this.i = 0, this.b = null, this.g = !1) : (R(a.a, 1) || R(a.a, 8)) && my(this, 6E4)
    };
    ...
    function my(a, b) {
        if (!a.b && a.j) {
            ...
            On(d) || (a.b = {
                ...
                gid: d.Hc,
                session_token: d.Kc
            }, a.k = d.Fa, d.I && (a.b.vvt = d.I), 0 == c ? a.On() : L(t(a.On, a), c))
        }
    }
    f.On = function() {
        if (this.b) {
    ...
    f.Iw = function(a) {
        if (this.b) {
            a = a.responseText;
            var b = a in jy ? 1 : 64 <= a.length && a.match(/[0-9a-fA-f]+/) ? 0 : -1; - 1 == b ? ny(this, "decode") : (this.i = 0, this.b = null, 1 == b ? (this.g = !1, a = a in jy ? Hf(jy[a]) : Hf("ERROR_LICENSE"), oy(this.a.app.b, 150, a, void 0)) : (this.g = !0, my(this)))
        }
    };
    f.Hw = function(a) {
        ...
        if (this.b) {
            ...
            if (!b)
                if (this.b) {
                    if (b = a(this.b)) {
                        a = this.i[c] = b;
                        for (var d in this.k) a.G(d, this.k[d]);
                        a.G("command_log_timing", this.A, this);
                        O(this, b)
                    }
                } else b = null;
            b && b.eb(this.b) && !y(this.a, b) && (b.create(), this.a.push(b), y(this.g, b.pa) && (b.sc = this.o, b.Sh(!!b.sc)))
        }
    };
    ...
    function ry(a, b, c) {
        ...
        a.g = eb(c);
        x(a.a, function(a) {
            0 <= Pa(c, a.pa) && (a.sc = b, a.Sh(!!a.sc))
        })
    }

    function sy(a) {
        x(a.g, function(a) {
            if (a = Hh(this, a)) a.sc = null, a.Sh(!1)
        }, a);
        a.o = null;
        a.g = []
    }
    ...
    f.fb = function() {
        ...
        if (!(b = a.fq)) {
            ...
            b = a.ny;
            var d = [];
            for (c in b) b.hasOwnProperty(c) && (0 == c || d.push(new wy(a, c, b[c])));
            c = new uy(d);
            b = a.fq = c
        }
        return b
    ...
    function zy(a, b) {
        for (var c = vy(a.fb()), d = 0; d < c.length; d++) {
            ...
            if (b.has(e)) {
                ...
                } else h = yy(b, e), g ? (g = yy(a, e)) ? zy(g, h) : a.set(e, h.clone()) : a.set(e, h)
            }
        }
    }
    f.clone = function() {
        var a = new this.constructor;
        a != this && (a.he = {}, a.$c && (a.$c = {}), zy(a, this));
        return a
    };
    ...
    function Vy(a) {
        ...
        b = a.ps;
        if (!y(Ty, b) || Xy(this) || this.mb) this.cb = b || this.cb;
        ...
        this.tm = b;
        this.mn = Hj;
        if (Gj || Fj) this.vm = "blazer" != this.cb;
        ...
        Xy(this) && (this.kg = V(this.kg, a.retryneterr), this.ok = V(this.ok, a.nologo));
        this.kg = this.kg || this.jj;
        this.Vb && (this.nf = !0, this.ra = 3);
        this.rk = V(this.rk, a.ssl);
        if (this.Ub = V(this.Ub, a.use_tablet_controls)) this.$ = "dark";
        b = this.jf;
        if (c = a.video_container_override) {
            var d = c.split("x");
            2 == d.length && (c = parseInt(d[0], 10), d = parseInt(d[1], 10), b = isNaN(c) || isNaN(d) || 0 >= c * d ? b : new B(c, d))
        }
        this.jf = b;
    ...
    function Yy(a, b) {
        ...
        "1" == b.enablecsi && (a.J = b.csi_page_type, a.bi = !1, a.Ih = !1)
    }

    function Zy(a, b) {
        var c;
        t: {
            if (b && ((c = b.adformat) || (c = (c = b.attrib) && c in Qy && c in Ry ? Ry[c] + "_" + Qy[c] : void 0), c)) {
                var d = c.match(/^(\d*)_((\d*)_?(\d*))$/);
                if (d && 5 == d.length && (d = d[3], d = 6 == d || 7 == d || 8 == d || 10 == d, Xy(a) || d)) break t
            }
            c = void 0
        }
        c && (a.j = c, a.b.adformat = b.adformat);
        c = b.agcid;
        a.xb = c;
        a.b.agcid = c;
        c = b.feature;
        a.k = c;
        a.b.feature = c;
        if (c = b.referrer) a.W = c, a.b.referrer = c;
        "1" == b.enablecsi && (a.J = b.csi_page_type, a.bi = !1, a.Ih = !1);
        a.va = W(a.va, b.q);
        a.u = W(a.u, b.cbrand);
        a.A = W(a.A, b.cbr);
    ...
    function bz(a, b) {
        switch (b.md) {
            ...
            case 30:
                return d = "//docs.google.com/", a.hb != Vy.prototype.hb && (d = a.hb), yk(d + "get_video_info", {
                    docid: b.L,
                    authuser: b.Qa,
                    authkey: b.bn,
                    eurl: a.a
            ...
            default:
                return d = {
                    ...
                    b.I ? d.vvt = b.I : b.P && (d.access_token = b.P), a.j && (d.adformat = a.j), b.ma && (d.iv_load_policy = b.ma), b.df && (d.autoplay = "1"), b.Zj && (d.noiba = "1"), b.$j && (d.mdx = "1"), b.ak && (d.utpsa = "1"), b.bb && (d.is_fling = "1"), c = cz(a), c.width && (d.width = c.width), c.height && (d.height = c.height), b.la && (d.ypc_preview = "1"), b.Kd && (d.splay = "1"), a.o && (d.content_v = a.o), b.cn && (d.livemonitor = 1), a.Qa && (d.authuser = a.Qa), a.Za && (d.pageid = a.Za), a.la && (d.ei = a.la), ra(d, az(a)), yk(a.hb + "get_video_info", d)
        }
    }
    ...
    function gz(a) {
        var b = {};
        if (!a.Ja) return b;
        a.Ja.webkitDecodedFrameCount && (b.hmewdfc = a.Ja.webkitDecodedFrameCount, b.hmewdrop = a.Ja.webkitDroppedFrameCount, b.hmewvdbc = a.Ja.webkitVideoDecodedByteCount, b.hmewadbc = a.Ja.webkitAudioDecodedByteCount);
        a.Ja.mozParsedFrames && (b.hmempf = a.Ja.mozParsedFrames, b.hmemdf = a.Ja.mozDecodedFrames, b.hmempresented = a.Ja.mozPresentedFrames, b.hmempainted = a.Ja.mozPaintedFrames, b.hmempaintdelay = a.Ja.mozPaintDelay);
        return b
    }

    function hz(a) {
        var b = n("yt.www.watch.activity.getTimeSinceActive", window);
        if ("detailpage" == a.Z && b) return b();
        var c;
        a.C && (c = u() - a.C);
        return c
    }
    ...
    function rz(a) {
        for (; a.pendingRequests_.length && 5 == a.pendingRequests_[0].a;) {
            ...
            b.A && (a.j -= qz(b), a.j += Al(b.info.a).length);
            x(b.k, a.u, a)
        }
    }
    oz.prototype.u = function(a) {
        4 == a.info.type ? (a = a.info.a.vp(a), fb(this.a, a)) : 3 == a.info.type && this.a.push(a)
    };

    function sz(a, b) {
        if (a.k) return a.a[0].T;
        var c = a.b.info.i;
        if (a.a[0].info.j >= b) return null;
        var d;
        for (d = 1; d < a.a.length; d++) {
            var e = a.a[d].buffer != a.a[d - 1].buffer;
            if (a.a[d].info.j > b || e) break
        }
        d--;
        var e = a.a[d].T.end,
            g = a.a[d].info.i - b;
    ...
    function uz(a, b) {
        if (vz(a)) {
            ...
            if (b >= c.j && b <= a.g.i) return c.a.uf(b, 0).a[0].startTime
        }
        a.g = a.b.uf(b, 0).a[0];
        a.i && a.i.o && (a.i = null);
    ...
    function wz(a, b) {
        ...
        if (a.a.length)
            for (a.j = a.a[0].buffer.byteLength, c = 1; c < a.a.length; c++) a.a[c].buffer != a.a[c - 1].buffer && (a.j += a.a[c].buffer.byteLength);
        else a.j = 0
    }

    function yz(a, b, c) {
        if (a.pendingRequests_.length) {
            if (a.pendingRequests_[0].info.a[0].startTime <= b) return;
            xz(a)
        }
        for (var d = a.a.length - 1; 0 <= d; d--) {
            var e = a.a[d];
            e.info.startTime > b && (a.a.pop(), a.a.length && a.a[d - 1].buffer == e.buffer || (a.j -= e.buffer.byteLength))
        }
        tz(a);
    ...
    function vz(a) {
        if (!a.i && !a.a.length || !a.g) return !1;
        var b;
        if (a.a.length) {
            if (a.i && !(1E-6 >= Math.abs(a.a[0].info.j - a.i.i))) return !1;
            b = a.a[0].info.i
        } else b = a.i.i;
        for (var c = 1; c < a.a.length; c++) {
            if (!(1E-6 >= Math.abs(b - a.a[c].info.j))) return !1;
            b = a.a[c].info.i
        }
        for (c = 0; c < a.pendingRequests_.length; c++) {
            var d = a.pendingRequests_[c].info.a;
            if (!(1E-6 >= Math.abs(b - d[0].j))) return !1;
            b = d[d.length - 1].i
        }
    ...
    f.xk = function() {
        if (!this.ia()) {
            ...
            if (4 == this.info.a[this.info.a.length - 1].type || this.info.T && this.info.T.start < this.i.S) a = nl(a, "fr", "yes");
            ...
            this.o = Hk(a, b);
            this.C = 0;
            this.b && (a = this.b, a.b = u(), a.j = a.b, a.a = 0, a.o = 0, a.g = !1, a.k = yi(a.i), Iz(a), this.o.addEventListener("progress", t(this.lr, this), !1), 0 < this.i.j && !yl(this.info.a[0]) && (this.g = L(t(this.Um, this), this.i.j)))
        }
    };
    f.lr = function(a) {
        if (!this.ia()) {
    ...
    f.kr = function(a) {
        if (!this.ia() && a == this.o) {
            this.g && (M(this.g), this.g = NaN);
            var b = null == a.response || 400 <= a.status;
            if (!b) {
                a = a.response;
                var c;
                t: {
                    if (2048 > a.byteLength && (c = String.fromCharCode.apply(String, new Uint8Array(a)), il(c))) break t;c = ""
                }
                if (c) {
                    c = ml(c, "keepalive");
                    c = ml(c, "fr");
                    ...
                    if (a.g) {
                        ...
                        if (d) {
                            var e = d.split("?");
                            if (0 < e.length)
                                for (var g = e[0].split("/"), d = 0; d < g.length; d += 2) c = ml(c, g[d]);
                            if (1 < e.length)
                                for (e = e[1].split("&"), d = 0; d < e.length; d++) c = ml(c, e[d].split("=")[0])
                        }
                    }
                    c =
                        ml(c, "range");
                    a.b.a = ml(c, "shost");
                    Hz(this, 3)
                } else if (this.info.T && a.byteLength != this.info.T.length) b = !0;
                else {
                    c = this.info.a;
                    1 != c.length || c[0].T || (d = c[0], e = dl(0, a.byteLength), d = new xl(d.type, d.a, e, d.Jb, d.startTime, d.duration, d.g, e.length, d.o), c[0] = d);
                    for (var d = [], e = 0, h = !1, g = !1, k = 0; k < c.length; k++) {
                        var m = c[k],
                            p = a,
                            s = dl(e, m.b),
                            w = !1;
                        if (1 == m.type) a.slice ? p = a.slice(e, e + m.b) : (h = new Uint8Array(a, e, e + m.b), p = (new Uint8Array(h)).buffer), s = dl(0, m.b), h = !0;
                        else if (3 == m.type || 4 == m.type) w = h && !g, g = !0;
                        d.push(new Gl(m,
                            p, s, w));
                        e += m.b
                    }
    ...
    f.Um = function() {
        ...
        if (!this.ia() && this.b) {
            ...
            if (this.b.g) {
                var b = this.b.C;
                Iz(this.b);
                this.b.C - b >= this.i.j / 1E3 * 0.8 ? (this.C++, a = 5 <= this.C) : this.C = 0
            } else a = u() / 1E3, b = this.b, a = 5 < a - (b.b / 1E3 + b.k.delay);
            a ? (Hz(this, 7), Lz(this), Kz(this.b, Date.now())) : this.g = L(t(this.Um, this), this.i.j)
        }
    };
    f.ia = function() {
        return -1 == this.a
    ...
    f.Rs = function(a) {
        this.o = !0;
        this.a = a;
        a.a.appendBuffer && (a.a.addEventListener("updateend", t(this.Yd, this), !1), a.i.addEventListener("updateend", t(this.Yd, this), !1));
        Pz(this);
        Qz(this, "msa")
    };

    function Rz(a) {
        a.a && a.a.a && a.a.a.removeEventListener && (a.a.a.removeEventListener("updateend", t(a.Yd, a), !1), a.a.i.removeEventListener("updateend", t(a.Yd, a), !1));
        a.a = null;
        a.o = !1;
        wz(a.b, !1);
        wz(a.i, !1)
    ...
    function Sz(a) {
        ...
        }, vl(a.i.b.j, b), vl(a.b.b.j, b))
    }

    function Tz(a, b, c) {
        if (!b.g) {
            if (!b.b.yb()) return b.b.g || Uz(a, b, !1), !1;
            uz(b, a.j)
        }
        if (!a.o) return !1;
        ...
        if (2 <= d + 1) return !1;
        d = b.g;
        4 == d.type && d.a.yb() && (b.g = Na(d.a.ai(d)), d = b.g);
        if (d.o || !d.a.tf(d) || d.a.info.i && 4 == d.type) return !1;
        if (Ez(b) && a.g.g) return !0;
        if (b.j + c.j > a.g.i || c.g && !c.g.o && c.g.i < d.i) return !1;
        b = Vz(a, b, !0);
        a = a.j + b;
        ...
        if (Tz(a, b, c))
            if (a.g.$) {
                ...
                if (b.g.a.yb()) {
                    ...
                    h && e <= ui && (0 < e && (d = new Fz(a.g, d.a.Ge(d, e)), Xz(a, d, !0), pz(b, d)), uz(b, Yz(b)), d = b.g, h = !1);
                    d.a.tf(d) && (c = lz(a.k, d.a.info.a, c.b.info.a, g), h && e <= c && (c = e), d = new Fz(a.g, d.a.Ge(d, c)), Xz(a, d, !1), pz(b, d))
                } else c = lz(a.k, b.b.info.a, c.b.info.a,
                    0), d = new Fz(a.g, d.a.Ge(d, c)), Xz(a, d, !1), pz(b, d)
            } else {
                c = b.g;
                var d = c.i - a.j,
                    e = c.a.info.a,
                ...
                k ? (c = Yz(b), a.g.g && e && (e = mz(a.k, d) + a.j + a.g.I, e = Math.min(e, c), e = b.b.index.Qh(e), e < b.b.index.wc() && (c = b.b.index.ug(e + 1)), yz(b, c, !1)), b.g && !b.g.k && (e =
                    new Fz(a.g, Az(b)), Xz(a, e, !0), pz(b, e)), b.g && (c = Yz(b)), c = new Fz(a.g, b.b.uf(c, d))) : c = new Fz(a.g, c.a.Ge(c, d));
                Xz(a, c, !1);
                pz(b, c)
            }
    }
    ...
    f.ew = function(a) {
        if (!this.ia()) {
            ...
            3 == a.a || b ? (b ? this.B("softerror", 209) : c && Qz(this, "vrr"), a.start()) : 5 == a.a ? (c && (this.R = a.I), x(a.k, function(a) {
                yl(a.info) && a.info.a.pl(a)
            }), Ta(a.k, function(a) {
                return Hl(a)
            }) && !a.k[0].info.a.ql() ? this.Yd() : Zz(this, 126)) : 7 == a.a ? (this.B("softerror", 210), Pz(this)) : 4 == a.a ? this.Yd() : Zz(this, 121)
        }
    };
    ...
    f.Yd = function() {
        ...
        if (!this.Q && this.a)
            if (this.A && this.A.b) {
                ...
                this.Q = !0
            } else if (a = Math.floor(Math.max(this.i.b.index.Cg(), this.b.b.index.Cg())), 0 < a) {
            var b = this.a;
            fn(b) ? b.b.duration = a : b.j = a;
            this.Q = !0
        }
        if (!this.ia())
            if (a = this.A, u() - a.k >= a.o) a = this.A, a.i || bm(a, a.j), $z(this);
            else if ("prerender" == window.document.webkitVisibilityState) $z(this);
        else {
            ...
            if (this.a) {
                ...
                if (!isNaN(b) || Cz(this.b)) Cz(this.b) && (b = NaN), a |= aA(this, this.i, this.a.a, b);
    ...
    f.rm = function() {
        if (!this.ia() && !isNaN(this.g.J)) {
            var a = nz(this.k);
            !isNaN(this.F) && Math.abs(this.F - a) / a < this.g.J || (Math.round(a / 1024), Math.round(this.F / 1024), this.B("bandwidthchange", a), this.F = a)
        }
    };
    ...
    function aA(a, b, c, d) {
        ...
        if (!e) return !1;
        !b.i || b.i.k || zl(b.i, e.info) || (b.i = null, fn(a.a) && c.abort(), c.g = null);
        var g;
        e.a ? g = !1 : (g = e.info.a.a, c.g == g ? g = !1 : (bA(a, c, g), c.g = g, g = !0));
                ...
                if (1 == e.info.a.info.j) {
                    ...
                    var m = h.getUint32(16),
                        k = String.fromCharCode.apply(null,
                            k.subarray(0, 140)).indexOf("tfdt") + 8;
        ...
        if (!bA(a, c, g)) return !1;
        for (var p; b.a.length && (b.a[0].T.end > d.end ? (p = b.a[0], h = d.end - b.a[0].T.start + 1, h = Math.min(h, p.info.b), g = new xl(p.info.type, p.info.a, p.info.T, p.info.Jb, p.info.startTime, p.info.duration, p.info.g, h, !1), a = dl(p.T.start, h), g = new Gl(g, p.buffer, a, p.a), h = new xl(p.info.type, p.info.a, p.info.T, p.info.Jb, p.info.startTime,
                p.info.duration, p.info.g + h, p.info.b - h, p.info.o), a = new bl(a.end + 1, p.T.end), a = [g, new Gl(h, p.buffer, a, !1)], p = a[0], b.a[0] = a[1]) : p = b.a.shift(), a = b, g = p.info, a.i = g, a.k && a.i.k && (a.k = !1), a.o = Math.max(a.o, g.a.info.a), p.T.end != d.end););
    ...
    function eA(a, b, c, d) {
        if (b.b.yb())
            if (d) {
                ...
                if (e == g && vz(b)) return c;
                wz(b, !0);
                b.b.info.g && b.i && !b.i.k && !Bz(b) && (d = new Fz(a.g, Az(b)), Xz(a, d, !0), pz(b, d));
                if (isNaN(e)) return uz(b, c);
                uz(b, e + Oz)
            } else uz(b, c);
        else b.b.g ? 0 != c && xz(b) : Uz(a, b, !1);
        return c
    }
    ...
    Nz.prototype.getDebugInfo = function() {
        ...
        this.a && !this.a.Yb() && (a.lab = rj(this.a.a.buffered), a.lvb = rj(this.a.i.buffered));
        return a
    };
    ...
    f = hA.prototype;
    f.start = function() {
        this.ia() || (this.J = !0, this.a.length && this.Fj(this.a.shift()))
    };
    f.dispose = function() {
    ...
    f.Fj = function(a) {
        this.ia() || a.sessionId != this.b || (this.A && a.defaultURL && ii(this, a.defaultURL), this.J ? (this.u = a, jA(this, a)) : this.a.push(a))
    };
    f.Gq = function(a) {
        this.ia() || a.sessionId != this.b || (this.A = !0, this.a.length && this.Fj(this.a.shift()))
    };
    ...
    f.Zw = function(a) {
        if (!this.ia())
            if (0 != a.status && a.response) {
                ...
                0 != a.a ? (b = hy[a.a.toString()], iA(this, "f" + a.a, b ? b : "ERROR_LICENSE")) : ((b = a.headers["Authorized-Format-Types"] || a.headers["Supported-Tracks"]) && this.C.B("newlicense", b.split(",")), a = a.message, this.U.addKey ? this.U.addKey(this.i.a, a, this.F, this.b) : this.U.webkitAddKey(this.i.a, a, this.F, this.b))
            }
        else this.Kn(a)
    };
    f.Hq = function(a) {
        this.ia() || a.sessionId != this.b || ("playready" == this.i.b && a.errorCode == a.MEDIA_KEYERR_UNKNOWN && 2 == a.systemCode && this.k ? (this.k = !1, jA(this, this.u)) : iA(this, "s" + a.errorCode.code + "." + a.systemCode))
    };
    f.Kn = function(a) {
        iA(this, "r" + a.status)
    };
    ...
    f.nr = function(a) {
        y(a, "HD") && !hm(this.o) && (this.o = gm, this.a.B("qualitychange"))
    };
    f.G = function(a, b, c) {
    ...
    mA.prototype.g = function() {
        if (!n("yt.abuse.botguardInitialized")()) return null;
    ...
    function rA(a, b, c) {
        ...
        if (a.a.pb) {
            ...
            a = a.a.jf || d
        } else a = a.a.jf ? a.a.jf : new B(640, 360);
        if (b.length) {
    ...
    function tA(a, b, c, d) {
        if (a.a == b) return c - a.b > (a.g ? 1 < d ? 1500 : 400 : 500);
        a.a = b;
        a.b = c;
        return !1
    };
    ...
    function xA(a, b) {
        ...
        if (g) {
            if (g = g.apply(null, [c, d, e, a])) zA(g), AA(a)
        } else {
            var g = {
                    v: 2,
                    s: "youtube",
            ...
            if (k || 0 === k) e.srt = k;
            c.aft || (c.aft = c.vr && c.cl &&
                c.cl > c.vr ? c.cl : c.vr ? c.vr : c.ol);
            c.vr && c.gv && (d.vl = Math.round(c.vr - c.gv));
            for (var s in e) "_" != s.charAt(0) && (g[s] = e[s]);
            e = {};
            m = [];
            s = c._start;
            for (var w in c) "_" != w.charAt(0) && (k = Math.max(Math.round(c[w] - s), 0), e[w] = k, m.push(w + "." + k));
            g.rt = m.join(",");
            c = {};
            w = [];
            for (var z in d) "_" != z.charAt(0) && (c[z] = d[z], w.push(z + "." + d[z]));
            g.it = w.join(",");
            zA(g);
    ...
    function FA(a, b, c) {
        ...
        a.o = null;
        a.A.reset();
        if (2 == a.Ga || jl(a.k.origin, fl)) b.sm = !0;
        a.a = b;
        a.a.G("dataupdated", a.Dq, a);
        a.a.G("dataloaded", a.Cq, a);
        a.a.G("onStatusFail", a.Bq, a);
        b.hf && b.hf > b.Ha && (b = b.hf, a.F && (a.sh(a.F), a.F = null), a.F = new Rh(1E3 * b, 2147483646), a.F.Ta.G("onEnter", a.fg, a), a.wh(a.F));
        fi(a);
        HA(a) || (a.i = c, b = t(a.Mc, a), c.la = b, b = t(a.getCurrentTime, a), c.j = b, b = t(a.Aq, a), c.va = b, b = t(a.Eq, a), c.$ = b, b = a.k, c.b = a.a, c.a = b, c.S = c.a.hb +
            "get_video", c.i = !1, c.o = new IA(c.b, c.a, c.va), O(c, c.o), c.ra = !0);
        JA(a, "newdata")
    }
    ...
    function PA(a) {
        if (!a.W) {
            ...
            a.W = !0;
            !OA(a) || a.a && a.a.wd || (MA(a) ? (Mn(a.a), RA(a)) : a.a.wd || (HA(a) ? RA(a) : (b = bz(a.k, a.a), Tn(a.a, b))))
        }
    }
    ...
    function RA(a) {
        a.S = eb(a.a.Q);
        NA(a) && (a.a.gb && (VA(a, a.a.Aa), WA(a, !0)), Wx(a, "i"));
    ...
    function tp(a) {
        a.o = null;
        a.g && (a.g.o = !1);
        a.b && (GA(a), a.R.removeAll(), Zj(a.b), a.b = null)
    }
    f.playVideo = function() {
        ...
        if (this.b) {
            ...
            if (this.a.g.a) {
                ...
                a = this.Ea;
                this.g.o = !0
            } else a = this.a.S.i, ra(a.g, Nn(this.a));
            this.b.ud != a ? bB(this, a) : (R(this.j, 64) && QA(this, hk(this.j, 8)), this.b.playVideo(),
                this.a.nb && !this.a.gb && TA(this, Infinity))
        }
    };

    function Wx(a, b, c) {
        if (!a.ia() && !R(a.j, 128) && (a.a && c && (a.a.ff = c), NA(a))) {
            var d = "m" == b,
                e = "m" == a.a.ld;
            if (d || !e) {
                d && c && hm(c) && (b = "a", d = !1);
                c = NaN;
                !a.P || a.k.Ga && !ti() || a.k.jh || (c = a.g ? nz(a.g.k) : xi(a.P), c = "i" != b || a.k.re || a.k.Va ? 0.9 * c : 0.6 * c);
                if (a.k.jd && "i" == b) {
                    c = a.a;
                    var g = em("medium", "medium", !1);
                    c = An(c.k || c.A, g)
                } else c = pA(a.ra, a.a, c, a.a.mj ? gm : a.u ? a.u.o : NA(a) && a.a.g.a && Ul(a.a.u) ? fm : gm);
                g = c;
                c = g.getInfo();
                var h = g.a ? g.b.info : c;
                if (!a.k.Va || !a.a.a || "135" != a.a.a.b || "136" != c.b)
                    if (a.a.a != c || a.a.za != h || d != e) a.a.ld =
                        b, a.a.a = c, a.a.za = h, g.a ? (a.a.Xa = g, a.g ? (e = a.g, g = g.g, e.ia() || (e.J = d, e.b.b = g, Sz(e), d && (wz(e.b, !0), g.yb() && uz(e.b, e.j)), g.g || Uz(e, e.b, !1), Pz(e))) : aB(a, g)) : a.a.S = g, a.i && (d = a.a, e = rA(a.ra, d), e = An(d.k || d.A, e), d = a.i.o, c = new nA(a.a, c, b, e.ye.b), LA(d, "vfs", [c.a.b, c.b, d.I, c.g]), d.I = c.a.b, c = fz(d.a), 0 < c.width && 0 < c.height && LA(d, "view", [Math.round(c.width), Math.round(c.height)]), LA(d, "vps", [d.b]), d.hg()), a.B("internalvideoformatchange", a.a, "m" == b), a.ag() && a.playVideo()
            }
        }
    }
    ...
    function aB(a, b) {
        ...
        c.kd && (d.F = 30, d.I = 5, d.V = !0);
        c.Kc && (d.C = 3);
        c.Ic && (d.C = 1.5, d.o = 1048576);
        c.Uf && (d.b = 131072, d.$ = !1);
        c.sq && (d.K = !0, d.b = 65536, d.k = 4194304);
        c.ij && (d.K = !0, d.b = 65536, d.Q = 8);
        c.Wf && (d.a = 2.5);
        c.Tf && (d.a = 3);
        c.Yf && (d.a = 3.5);
        c.ld && (d.W = 0.8);
        c.hd && (d.R = 0.99);
        c.hj && (d.S = 5E5);
        ti() && (d.A = 8388608, d.u = 524288, d.i = 2097152, d.k = 1048576, d.F = 15, d.g = !1);
        ti() && (d.a = 3.5, d.A = 20971520, d.u = 1572864, d.i = 20971520, d.g = !0, d.j = 1E3, d.P = 2);
        c.Jc ? c = !1 : (c = c.jf || new B(window.screen.width,
            window.screen.height), c = 2560 <= c.width && 1440 <= c.height);
        c && (d.A = 52428800, d.u = 5242880, d.i = 20971520, d.k = 8388608);
        ...
        d.b = new oz(d.V);
        c = c || 0;
        0 == c && (d.i.b.g || Uz(d, d.i, !0), d.b.b.g || Uz(d, d.b, !0));
        Sz(d);
        dA(d, c);
        Qz(d, "gv");
        d = t(d.rm, d);
    ...
    function TA(a, b, c, d) {
        if (a.b) {
            ...
            a.a.Ha = b;
            a.I = b;
            c ? a.oi() : (dB(a), d && (a.K || (a.K = new Xq(a.oi, d, a)), a.K.start()), eB(a, !0));
            a.F && b > a.a.hf && (a.sh(a.F), a.F = null);
            a.B("seekto", a, b)
        } else a.a.Ha = b || 0
    }

    function dB(a) {
        R(a.j, 32) || (QA(a, hk(a.j, 32)), R(a.j, 8) && a.pauseVideo(), a.B("beginseeking", a))
    }
    f.oi = function() {
        if (!isNaN(this.I) && this.b) {
            var a = this.Mc();
            !this.a.nb && this.I >= Math.floor(a) ? (this.I = a, this.B("endseeking", this), this.pauseVideo(), this.fg()) : (this.g && dA(this.g, this.I), Xj(this.b, this.I))
        }
        this.K && (this.K.dispose(), this.K = null);
        R(this.j, 32) && (a = this.j, QA(this, gk(a, a.b & -33)), this.B("endseeking", this))
    };
    f.getCurrentTime = function() {
        if (!isNaN(this.I)) return this.I;
        var a = 0;
    ...
    f.Aq = function() {
        ...
        this.g ? (b = this.g, b.a && !b.a.Yb() && (a.b = uj(b.a.i.buffered, b.j), a.i = uj(b.a.a.buffered, b.j)), a.a = nz(b.k), xi(b.u), vi(b.u), wi(b.u)) : this.b && (a.b = uj(this.b.buffered, this.getCurrentTime()));
        return a
    };
    ...
    f.Eq = function() {
        ...
        if (this.a) {
            a = this.a;
            var b = {};
            a.a && (b.fmt = a.a.b, a.za && (b.afmt = a.za.b));
            a.V && (b.threed = a.Jc);
            b.plid = a.Ya;
            b.ei = a.j;
            b.list = a.Pa;
    ...
    EA.prototype.getDebugInfo = function(a) {
        var b = {};
        a && (this.i && (a = gB(this.i)) && ra(b, a.Uh()), this.b && ra(b, this.b.getDebugInfo()), this.g && ra(b, this.g.getDebugInfo()), R(this.j, 384) && (b.debug_error = this.j.a));
    ...
    f.Rw = function(a) {
        ...
        if (b == this.b && b.currentSrc) {
            switch (a.type) {
                case "durationchange":
                    this.a.gb || (b.kc = b.duration || 0, b = b.kc, (!this.o || isFinite(b) && 0 < b) && VA(this, b));
                    break;
                case "ended":
                    QA(this, gk(this.j, 4));
                    this.Im();
                    break;
                case "loadedmetadata":
                    this.a.Ha && (this.b.currentTime = this.a.Ha), this.k.vm && this.a.Ha && (this.Q = this.a.Ha, this.b.pauseVideo());
                case "loadeddata":
                    this.V && M(this.V);
                    break;
                case "loadstart":
                    Ef(this.ha);
                    this.mg() || (Hv() ? hB(this) : (b = this.k.qe ? 16 : 100, this.ha = Df(t(this.mg, this),
                        b)));
                    break;
                case "progress":
                    this.Q && this.b.seekable.length && this.b.seekable.end(0) > this.Q && (this.b.currentTime = this.Q, this.Q = NaN, this.na = this.R.listen(this.b, "canplay", this.Pu));
                case "suspend":
                    eB(this);
                ...
                case "seeked":
                    ...
                    break;
                case "timeupdate":
                    this.za = !0, this.mg(), iB(this), eB(this), this.B("onVideoProgress", this, b.getCurrentTime())
            }
                ...
                if (!R(b, 128)) {
                    ...
                    switch (a.type) {
                        case "ended":
                            ...
                            break;
                        case "pause":
                            R(b, 32) || R(b, 2) || (d = 4, R(b, 1) && R(b, 8) && (d |= 1), e = null);
                            break;
                        case "playing":
                            d = 8;
                            e = null;
                        ...
                        case "canplay":
                            ...
                            break;
                        case "progress":
                            R(b, 8) && (g.Qk(), a = g.getCurrentTime(),
                                c && (g = uj(g.buffered, a), tA(c, a, u(), g) && (d |= 1)));
                            break;
                        case "seeked":
                            d &= -18;
                            break;
    ...
    f.mg = function() {
        ...
        if (this.b && this.a && !this.a.ph && 0 < this.b.getCurrentTime() && 0 < this.b.kc) {
            ...
            this.k.Oa && jB(this);
            if (this.i && (a = this.i, !a.i)) {
                var b = gB(a, "playback");
                a.b.nm && (a.J = [10 + a.b.Sf, 10, 10, 40 + a.b.hh - a.b.Sf, 40], Ef(a.F), a.F = NaN, a.F = Df(t(a.P, a), 100), a.A = kB(a), b.Xf = lB(a, !0));
                b.a && b.a.push(mB(a));
                b.ef = !0;
                b.send();
                if (a.a.Nc &&
                ...
                a.b.F && (b = a.a, c = a.b, b = yk(b.hb + "ptracking", {
                    html5: "1",
                    video_id: c.L,
                    cpn: c.Fa,
                    plid: c.Ya,
    ...
    function jB(a) {
        ...
        b.j && (c = b.j, yA(void 0).ei = c);
        b.Fa && (c = b.Fa, yA(void 0).cpn = c);
        0 < b.Ha && (c = b.Ha.toString(), yA(void 0).start = c);
        b = b.a.b.toString();
        yA(void 0).fmt = b;
        ...
        if (a.g) {
            a = a.g;
            window && window.performance && window.performance.getEntriesByName && (b = window.performance.getEntriesByName(a.R), b.length && (b = b[0], Qz(a, "vri", b.fetchStart),
                Qz(a, "vdns", b.domainLookupEnd), Qz(a, "vreq", b.requestStart), Qz(a, "fvb", b.responseStart), Qz(a, "vrc", b.responseEnd)));
            a = a.S;
            for (var d in a) uA(d, a[d])
        }
    }
    f.Pu = function() {
        this.na && (this.R.Ib(this.na), this.na = void 0, this.b.playVideo())
    };
    ...
    function eB(a, b) {
        if (a.b && a.a) {
            ...
            if (a.g) {
                var d = a.g;
                if (!d.P || d.j <= c && c < d.j + 10) d.j = c, d.P = !1;
                $z(d)
            }
            a.a.gb && c > a.Mc() && (d = a.Mc(), 0 == d && (d = c), VA(a, 1.2 * d));
            var d = fB(a),
                e = 0;
            ...
            a.a.se = c;
            if (!b && a.ag()) {
                a.i ? (g = a.i, g = g.j ? g.Q + g.j() - g.g : null) : g = null;
                if (null != g) a.a.Qd = g;
                else {
                    var g = a.a.Xj,
                        h = a.a.se;
                ...
                a.a.Aa && a.a.R && a.a.Qd >= a.a.R && (g = a.i, g.i && g.b.R && (h = gB(g, "delayplay"), h.ih = !0, h.a && h.a.push(mB(g)), h.send()), a.a.R = NaN)
            }
            a.a.ph || a.mg();
            if (a.a.sj && 0 < a.a.se) {
                g = a.i;
    ...
    f.en = function() {
        this.b && (this.b.Qk(), R(this.j, 8) && tA(this.la, this.getCurrentTime(), Date.now(), uj(this.b.buffered, this.b.getCurrentTime())) && QA(this, hk(this.j, 1)), eB(this))
    };
    ...
    function QA(a, b) {
        if (!ik(a.j, b)) {
            ...
            a.k.kg && R(b, 8) && 0 < Uq(c, 256) && 201 == b.a.errorCode && setTimeout(t(function() {
                this.b && (this.a.S && this.b.load(), this.playVideo())
            }, a), 500);
            0 > Uq(c, 8) && WA(a, !1);
            0 < Uq(c, 32) && WA(a, !1);
            a.a && a.a.nb && a.a.gb && R(c.a, 2) && (VA(a, a.getCurrentTime()), eB(a, !0));
            R(b, 256) && oB(a, b);
            a.i && pB(a.i, c);
            ok(a.A, c);
            a.B("statechange", c)
    ...
    function cB(a) {
        var b;
        if (b = a.k.gd)
            if (b = a.a) b = a.a, b = 18E3 < u() - b.pe;
        b && (bi(a, 127), a.B("urlauthexpired"))
    }
    ...
    function WA(a, b) {
        a.a && a.a.gb && a.fa != b && (a.fa = b, a.B("liveviewshift", b))
    }
    ...
    function qB(a) {
        var b = On(a.a);
        b && !a.u && a.b && ((b = $m(a.b, a.a.a.Sc, b)) ? (a.u = new kA(a.b, b), a.u.G("newsession", t(a.Iv, a)), a.u.G("licenseerror", t(a.Gv, a)), a.u.G("qualitychange", t(a.Hv, a)), a.u.u = a.a.P, O(a, a.u)) : oy(a, 203, "HTML5_NO_AVAILABLE_FORMATS_FALLBACK"))
    }
    ...
    f.uv = function() {
        bi(this, 102);
        if (this.i) this.i.onError(102);
        this.B("loadsofttimeout")
    };

    function VA(a, b) {
        a.b && (a.b.kc = b);
        a.a.Aa != b && (a.a.Aa = b, JA(a))
    }
    f.Im = function() {
        if (!this.Ca) {
            this.Ca = !0;
            ...
            a && (b = this.i, b.na || (c = gB(b, "atr"), c.C = a, c.send(), b.na = !0))
        }
    };
    ...
    xB.prototype.j = function() {
        ...
        var b = {};
        b.at = this.getType();
        10 <= this.b || !a ? (yB(this), this.B("AD_LOGGING_EVENT", 2, b)) : a() && (yB(this), this.B("AD_LOGGING_EVENT", 3, b))
    };
    ...
    f.jy = function() {
        if ("3.1" == this.cj && (google.ima.settings.setLocale(this.Yp), this.hc)) {
            this.hc.Lf();
            return
        }
    ...
    function BB(a, b) {
        if (a) {
            ...
            c ? b.error_code = c : (c = "getMessage" in a && ja(a.getMessage) && "3.1" == zB.getInstance().getVersion() ? a.getMessage() : a.message, 50 < c.length && (c = c.substring(0, 47) + "..."), b.error_message = c)
        }
    }
    ...
    function CB(a, b) {
        if (a && "3.1" == zB.getInstance().getVersion()) {
            ...
            if (c) {
                ...
                b.ad_id = db(d, c).join(",");
                if (c = a.getAdSystem()) d = a.getWrapperAdSystems() || [], b.ad_sys = db(d, c).join(",");
    ...
    function DB(a, b) {
        if (a[b]) return AB(a[b]);
        var c = b.toLowerCase(),
            d;
        for (d in a)
            if (d && d.toLowerCase() == c) return AB(a[d]);
        return !1
    }
    ...
    f.stop = function() {
        this.Pe && (l.clearTimeout(this.Pe), this.Pe = null, this.Pf = !1)
    };
    f.pause = function() {
        this.fh++
    };
    f.resume = function() {
        this.fh--;
        this.fh || !this.Pf || this.Pe || (this.Pf = !1, IB(this))
    };
    f.H = function() {
        GB.D.H.call(this);
        this.stop()
    ...
    f.Tu = function() {
        this.Pe = null;
        this.Pf && !this.fh && (this.Pf = !1, IB(this))
    };
    ...
    f.lp = function() {
        for (var a = this.$b.cloneNode(!0), b = this.Wc.a[0].b, c, d, e = 0; e < b; e++) d = this.tg.cloneNode(!1), c = Vm(this.Ne, e, this.Mb), JB(d, c, this.Mb, this.yi), a.appendChild(d);
        b = this.$b;
    ...
    f.Wk = function(a, b) {
        ...
        for (var c, d, e = a; e <= b; e++)
            if (d = this.$b.children[e]) c = Vm(this.Ne, e, this.Mb), JB(d, c, this.Mb, this.yi);
        Ud(this.$b, !0)
    };
    ...
    f.rv = function() {
        for (var a = this.Kk, b = Math.max(Math.floor(a / this.Mb), 0), a = Math.min(Math.ceil((a + this.ae) / this.Mb), this.Wc.a[0].b - 1); b <= a; b++) {
            for (var c = this.Ne, d = b, e = pm(c.a, 2 * this.Mb), g = void 0, h = void 0; 0 <= e; e--)
                if (g = c.a.a[e], h = Math.floor(d / (g.a * g.g)), !g.i[h]) {
                    var g = c,
                        k = e,
                        m = k + "-" + h;
                    g.i[m] || (g.i[m] = !0, Sm(g.g, k, {
                        Rn: k,
                        Sn: h
                    }))
                } Wm(c)
    ...
    function LB(a, b) {
        ...
        b && (c = a.Wc.a[0].b, Hv() ? a.a.push(Jv(t(a.Wk, a, 0, c - 1))) : a.Wk(0, c - 1), MB(a, a.bl), a.g = !0)
    }
    f.H = function() {
        this.tg = this.jk = this.ik = this.Ph = this.$b = this.td = this.Ne = this.Wc = null;
        for (var a = this.a, b = 0, c = a.length; b < c; b++) Lv(a[b]);
        this.a.length = 0;
        KB.D.H.call(this)
    };
    ...
    function OB() {
        Y.call(this, ["div", ["ytp-progress-magnifier", "html5-draggable"],
            ["div", "ytp-play-progress"],
            ["div", "ytp-load-progress"],
            ["div", "ytp-progress-magnifier-scrubber-button"]
        ]);
    ...
    function RB(a, b) {
        if (a.b) {
            ...
            var c = a.A * e.a + e.b,
                ...
                m = a.i.offsetWidth,
                p = k - h - m / 2;
            p > -m && p < 2 * g + m ? (a.i.style.left = p + "px", Lo(a.i)) : Mo(a.i);
            k -= h;
            0 <= k ? (Od(a.u, Math.min(k, 2 * g)), Lo(a.u)) : Mo(a.u);
            c -= h;
            0 <= c ? (Od(a.C, Math.min(c, 2 * g)), Lo(a.C)) : Mo(a.C);
            if (b) {
                h = (h - e.b) / 2;
                d = (d - e.b) / 2;
                c = h / 60;
                k = d / 60;
                g = 0;
                for (m = Math.ceil(c); m <= k; m++) p = SB(a, g++), p.className = 0 == m % 60 ? "ytp-60m-progress" : 0 == m % 30 ? "ytp-30m-progress" : 0 == m % 15 ?
                    "ytp-15m-progress" : "ytp-1m-progress", p.style.left = 120 * (m - c) + "px", p.style.width = "1px";
                var h = 2 * h,
                    d = 2 * d,
                    c = 2 * a.Pd,
                    s;
                for (s in a.a)
                    if (k = a.a[s], p = Bb(0.002 * k.start, 0, c), m = Math.min(Math.min(0.002 * k.end, c) - p, Di(k)), p = Bb(p, 0, e.a - m), p <= d || p + m >= h) {
                        var w = SB(a, g++);
                        w.style.left = p - h + "px";
                        w.style.width = m + "px";
                        w.className = k.style
                    } for (; g < a.g.length;) F(a.g.pop())
            }
        }
    }

    function SB(a, b) {
        if (b < a.g.length) return a.g[b];
    ...
    function TB() {
        Y.call(this, ["div", ["ytp-progress-tooltip"],
            ["div", "ytp-progress-tooltip-thumbnail"],
    ...
    f = VB.prototype;
    f.zn = function(a) {
        this.I || (this.k.Ib(this.Oa), this.A = !1, this.Q = this.ma = a = new A(Nf(a), Of(a)), this.a && 5400 <= this.o && (M(this.na), this.a.show(), Uo(this.la), a = XB(this), this.a.b = a, RB(this.a, !0), a = qa(G, this.g, "html5-progress-magnifier-hover"), this.na = L(a, 0)), this.b && this.b.show(), Bo(this.Ca, this.g, "move", this.Fn), Bo(this.Ca, this.g, "out", this.gu))
    };
    ...
    f.Fn = function(a) {
        ...
        if (this.a && this.a.isEnabled())
            if (this.I) this.A ? this.P = b : this.Q = b;
            else {
                var d = Sd(this.a.M());
                if (d.contains(b)) this.P = b, this.A = !0;
                else {
                    var e = Sd(this.J),
                        g = this.ma.y - Of(a);
                    if (Nf(a) >= d.left && Of(a) >= d.top && Nf(a) < d.left + d.width || e.contains(b)) {
                        d = 6 * g - 6;
                        if (Nf(a) >= this.ma.x - d && Nf(a) <= this.ma.x + d) return;
                        this.A = !1;
                        this.ma = this.Q = b
                    } else {
                        ZB(this);
    ...
    function $B(a, b) {
        ...
        if (a.b && (c = a.Xa ? a.V * a.o : 0, d = a.b, e = aC(a), !d.Th)) {
            g = 50;
            d.yf ? (g = 108, b && (g *= 2)) : b && (g = 108);
            d.M().style.padding =
                "2px";
            ...
            d.yf && (c = om(d.yf, e.qd), c != d.a && (d.a = c, UB(d)));
            b ? (G(d.M(), "with-text"), d.wa(b, "text")) : H(d.M(), "with-text")
        }
    }
    f.wx = function() {
        var a;
        if (0 > this.j) a = 0.15 * this.j - 0.1, this.j -= a, 0 < this.j && (this.j = 0);
        else if (0 < this.j) a = 0.15 * this.j + 0.1, this.j -= a, 0 > this.j && (this.j = 0);
        else return;
        var b = Gd(this.g).x;
    ...
    function ZB(a) {
        a.Ca.removeAll();
        a.b && a.b.hide();
        a.a && a.a.isEnabled() && (a.a.disable(), YB(a));
        a.Oa = Bo(a.k, a.i, "over", a.zn)
    }
    f.iw = function(a) {
        a.stopPropagation();
    ...
    function bC(a, b, c) {
        ...
        a.a && (d = a.a, d.F = b, d.A = c, RB(a.a, !1))
    }
    ...
    function eC(a) {
        ...
        b && (a.F.style.left = 100 * a.ha / a.o + "%", a.S.style.width = a.F.style.left);
        c && (b = Math.min(100, 100 * a.fa / a.o), a.K.style.left = b + "%", a.W.style.left = b + "%", a.W.style.width = 100 - b + "%")
    }
    f.kp = function() {
    ...
    function fC(a, b) {
        x(b, function(a) {
            ...
            } else gC(this, a), this.a && delete this.a.a[a.getId()]
        }, a);
        a.a && RB(a.a, !1)
    }
    ...
    function gC(a, b) {
        var c = b.getId();
        a.R[c] == b && (F(a.ra[c]), delete a.R[c], delete a.ra[c])
    }
    f.H = function() {
        M(this.na);
        Ef(this.Ga);
    ...
    function mC(a) {
        ...
        d && 0 < d && (b.ad_len = d);
        c && c.L ? b.ad_v = c.L : e && (c = zk(e), b.ad_dom = c, a.i.ka.u && (b.ad_v_url = e.substr(0, 512)));
        b.at = a.a.getType();
        return b
    }
    ...
    f.show = function() {
        ...
        if ("3.1" == rC()) a = this.u;
            ...
            var b = null;
            try {
                b = this.g.getSelectedCreative(), a = b.getMediaUrl("video/x-flv") || b.getMediaUrl("video/mp4") || b.getMediaUrl("video/webm")
            } catch (c) {
                sC(this, c);
                return
            }
        ...
        this.da = a;
        var e;
        this.da ? (this.da.Kd = !0, e = {
                video_id: this.da.L
            },
            this.da.G("onStatusFail", this.Ln, this), this.da.G("dataloaded", this.Mn, this), a = this.a.N(), a = new Vy(a.b), a.Z = "adunit", a.Sb = !0, a = bz(a, this.da), Tn(this.da, a)) : tC(this);
        uC(this.a, -1, e);
        this.En()
    };

    function vC(a) {
        a.da && (a.da.ba("onStatusFail", a.Ln, a), a.da.ba("dataloaded", a.Mn, a))
    }
    f.Mn = function() {
        vC(this);
        Mn(this.da);
        var a = pA(new oA(this.a.N()), this.da);
        a ? (a = a.i) ? (a = new Ge(Wj(a)), a.a.set("autoplay", "1"), a = a.toString(), "3.1" == rC() ? this.g.setMediaUrl(a) : this.g.getSelectedCreative().setMediaUrl(a), tC(this)) : sC(this, Error("Failed to determine ad media resource.")) : sC(this, Error("Failed to determine ad media format."))
    };
    ...
    f.yo = function() {
        ...
        this.ab = xC(this.a, !0);
        this.Hg = S(this.a.a);
        if (this.a.ka.V) F(D("video-ad-status-bar"));
        else {
            var a = S(this.a.a);
        ...
        try {
            this.b.listen(this.g,
                google.ima.AdErrorEvent.Type.AD_ERROR, this.cv);
    ...
    f.po = function() {
        this.If = !0;
        this.k = !1;
        this.o || (this.o = !0, oC(this.i), zC(this.a, 1));
        if (0 == this.Gf()) {
            var a = this.ab;
            a.kc = a.duration || 0
        }
    ...
    f.no = function() {
        this.k || (pC(this.i), this.If = !1, this.k = !0, uC(this.a, 0), zC(this.a, 2), this.B("adEnd", this))
    };
    f.cv = function(a) {
        sC(this, a.getError())
    };
    ...
    f.ev = function(a) {
        ...
        this.Gg.innerHTML = b;
        0 == this.Gf() && (b = this.ab, b.kc = b.duration || 0);
    ...
    f.H = function() {
        ...
        vC(this);
        this.g.destroy();
        this.ab && (pp(this.a.b), this.ab = null);
        wC(this);
        this.Gg && (this.Gg.innerHTML = "", this.Gg = null);
        this.Fg && (F(this.Fg), this.Fg = null);
        this.Hg && (gf(this.Hg, ["ad-showing", "ad-interrupting"]), this.Hg = null);
        this.k = !0;
        qC.D.H.call(this)
    };

    function wC(a) {
        a.j && (M(a.j), a.j = 0, H(S(a.a.a), "ad-interstitial-showing"))
    }
    f.Gf = function() {
    ...
    f.fu = function(a) {
        ...
        isNaN(a) || (a = Bb(a / 100, 0, 1), this.g.setVolume(a))
    };
    f.Hm = function() {
        this.If ? this.Lj() : this.yh()
    };
    f.yh = function() {
        this.ab && (this.g.resume(), this.po())
    };
    f.Lj = function() {
        this.ab && (this.g.pause(), this.oo())
    };
    f.Gk = function() {
        var a = yC(this.a);
    ...
    f.show = function() {
        ...
        try {
            this.b.listen(this.g, google.ima.AdErrorEvent.Type.AD_ERROR,
                this.Zt), this.b.listen(this.g, google.ima.AdEvent.Type.CLICK, this.Yt), this.b.listen(this.g, google.ima.AdEvent.Type.COMPLETE, this.au), this.b.listen(this.g, google.ima.AdEvent.Type.PAUSED, this.In), this.b.listen(this.g, google.ima.AdEvent.Type.STARTED, this.Jn), this.b.listen(this.g, google.ima.AdEvent.Type.SKIPPED, this.cu), this.ek(), this.g.start()
        } catch (c) {
            EC(this, c)
        }
    };
    ...
    f.Jn = function() {
        this.ul = !0;
        this.k = !1;
        this.o || (this.o = !0, oC(this.j), zC(this.a, 1));
        uC(this.a, 1);
        this.B("adPlay", this)
    };
    f.In = function() {
    ...
    f.au = function() {
        ...
        var b = CC(this.a);
        b.pauseVideo();
        b.b && (GA(b), b.o && (b.o.dispose(), b.o = null), b.a && (b.a.Ha = b.getCurrentTime()), b.I = NaN, Yj(b.b), b.k.Na && ck(b.b, !1), R(b.j, 128) || QA(b, gk(b.j)));
        uC(this.a, 0, a);
        zC(this.a, 2);
        pC(this.j);
        this.B("adEnd", this)
    ...
    f.H = function() {
        ...
        a.g && FC(a.app, a.g);
        this.g.destroy();
        this.rg && (this.rg.innerHTML = "", this.rg = null);
        this.qg && (F(this.qg), this.qg = null);
    ...
    f.H = function() {
        ...
        this.g && (this.g.destroy(), this.g = null);
    ...
    function PC(a) {
        if (!OC(a)) throw Error("Preroll status is undefined before ad load.");
    ...
    function QC(a) {
        ...
        var b = a.g.shift();
        b ? (0 == a.start && SC(a.b, "nl"), b = b.create(a.start, a.Da, a.b), O(a, b), yq(b.load(), a.Fw, a.Ew, a)) : (TC(a.b, 2, UC(a, {})), a.Le = "error", VC(a))
    }
    f.getId = function() {
        return this.Da
    };
    ...
    f.Fw = function(a) {
        ...
        this.a = a.Qu;
        O(this, this.a);
        0 == this.Da && (a = this.a.getType(), this.b.i.at = a);
    ...
    f.show = function() {
        this.il ? this.a instanceof JC && KC(this.a, google.ima.ViewMode.NORMAL) : (this.il = !0, (this.a instanceof qC || this.a instanceof BC) && SC(this.b, "bs"), this.a.G("adEnd", this.Wo, this), this.a.G("adError", this.Xo, this), this.a.G("AD_LOGGING_EVENT", this.Yo, this), this.a.G("select", this.Vo, this), this.a.show())
    };
    f.Wo = function() {
        if (this.rd) {
            WC(this);
            var a = this.b;
            a.ka.re && !a.Bj && (ua(a.N().hb + "mac_204?action_fcts=1"), a.Bj = !0)
        }
        VC(this)
    };
    f.Xo = function(a) {
    ...
    f.zd = null;
    f.load = function() {
        if (this.zd) return this.zd;
        this.zd = new rq;
        var a = cD(this.ja),
            b;
        this.ja.ka.a ? b = !1 : (b = 0 < (this.b & 3) ? 190 : 200, b = 200 > a.width || a.height < b);
        if (b) {
            b = this.a;
            var c = aD(b);
        ...
        } else yq(this.ja.jg, this.Qv, this.Dd, this);
        return this.zd
    };
    f.Xk = function() {
    ...
    f.Qv = function(a) {
        ...
        if ("3.1" == rC()) {
            b.isYouTube = !0;
            if (c = hz(this.ja.N())) b.lastActivity = c;
            this.ja.ka.ob && (b.tagForChildDirectedContent = !0)
        }
        var c = this.b,
            d = n("yt.www.watch.ads.setGutSlotSizes");
        d && d(0 < (c & 3), 0 < (c & 12));
        this.C.listen(a, google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,
            this.wv);
    ...
    f.Dd = function(a) {
        if (a instanceof sq) this.zd.cancel();
        else {
            var b = this.a,
                c = aD(b);
            a && BB(a, c);
    ...
    jD.prototype.k = function() {
        ...
        if (a.a.xb && (e = 4 == b && a.a.ma ? a.a.ma : a.a.ld)) {
            ...
            $b(d, wk(e));
            var g = e.indexOf("?"); - 1 != g && (e = e.substring(0, g + 1))
        }
        e || (e = "//googleads.g.doubleclick.net/pagead/ads?", d.eid = a.a.la, d.scs = a.a.Uf, d.client = a.a.Yf, d.description_url = a.a.Gb, d.loeid = a.a.Vf, d.cust_gender = a.a.Kc, d.host = a.a.host, d.hl = a.b.i, d.max_ad_duration = a.a.Gc, a.a.Jc && (d.adtest = "on"), isNaN(a.a.ha) || (d.cust_age = a.a.ha), isNaN(a.a.Ea) || (d.hostTierId =
            a.a.Ea), a.a.bb && (d.yt_pt = a.a.bb), a.a.wb && (d.video_cpm = a.a.wb), a.a.F && (d.as_dbp = a.a.F), d.ytdevice = a.a.Tf, d.ad_type = EB(b), 0 < (b & 3) ? a.a.Ga && (d.channel = a.a.Ga.join("+")) : b & 4 && a.a.Xa && (d.channel = a.a.Xa.join("+")), a.a.Sa && (d.lsv = 1), a.a.ob && (d.tfcd = 1));
        d.videoad_start_delay = c;
        d.url = "embedded" == a.b.Z && a.b.a ? a.b.a : a.a.Gb;
        var a = d,
            b = {},
            h;
        for (h in a) fa.call(void 0, a[h]) && (b[h] = a[h]);
        return e + uk(b, "&")
    };
    jD.prototype.Oe = function(a, b) {
        if (this.ja.ka.a) return 1;
        0 == this.g && (this.g = 10, this.a.b = 10, TC(this.ja, 1));
        uB(this.b);
        return jD.D.Oe.call(this, a, b)
    };
    jD.prototype.Ue = function(a) {
        var b = this.ja.ka;
        b.a ? jD.D.Ue.call(this, a) : b.Lc || this.b & 4 ? (dD(this, new xB(this.ja)), hD(this)) : jD.D.Ue.call(this, a)
    };
    ...
    function kD(a, b) {
        if (a) {
            ...
            if (c = 2 != d.length ? null : {
                    ...
                    ly: d[1],
                    my: c
                }) this.Qp = c.ky, this.Sp = c.ly, this.Tp = c.my
        }
    }
    f = kD.prototype;
    f.dq = "";
    ...
    mD.prototype.Oe = function(a, b) {
        ...
        return DB(c, "rm") ? (1 != this.b && vB(), nD(a), 2) : DB(c, "blockAllAds") ? (nD(a), dD(this, new LC(this.ja, a)), 0) : DB(c, "hideMaster") ? (dD(this, new LC(this.ja, a)), 0) : this.ja.ka.a ? 1 : "3.1" == rC() ? (dD(this, new JC(this.j, this.ja, a)), 0) : 1
    };
    ...
    oD.prototype.Oe = function(a, b) {
        switch (qD(a)) {
            ...
            case 2:
                var c;
                1 != this.u && vB();
                this.ja.ka.a ? c = 1 : (0 == this.g && (this.g = 10, this.a.b = 10, TC(this.ja, 1)), uB(this.b), eD(this, b.getAdId()), dD(this, new JC(2, this.ja, a)), c = 0);
                return c;
            default:
                return 1
        }
    ...
    rD.prototype.wi = function(a, b) {
        var c = this.b;
        c & 1 || c & 4 || c & 8 ? this.o ? c & 8 ? wB(this.o) : ("goo.gl" == zk(this.o) ? (c = sD("https://www.googleapis.com/urlshortener/v1/url?key=AIzaSyBbSB-E7SYd1iggX6r2b5C7ljvO6fVqaj0&shortUrl=" + this.o), xq(c, function(a) {
            a = sb(a.responseText);
        ...
        }, this)) : c = sD(this.o), xq(c, function(c) {
            b.adsResponse = c.responseText;
            a.requestAds(b, this)
        }, this), yq(c, null, this.Dd, this)) : this.Dd(Error("Invalid empty URL")) : this.Dd(Error("Invalid request type: " + c))
    };
    ...
    function zD(a) {
        var b = a.K;
        if (/^[\s\xa0]*$/.test(null == b ? "" : String(b)) || !a.P) return !1;
        b = (a.b || a.g) && a.C;
        a.A && a.C && (b = b || a.R || a.S);
        if (!b) return !1;
        b = a.i || a.j;
        if (!(b || a.A && a.o)) return !1;
        ...
        if (this.g && !(0 >= a)) {
            ...
            Lb(this.k.j, function(a) {
                if (a.rd && a.isVisible && !(0 >= DD(this, a))) {
                    ...
                    if (DD(this, a) > b) {
                        var m = !ED(this, a);
                        m != g.Sd && (g.Sd = m, c.push(g));
                        m || (g = DD(this, a) - b, g < e && (e = g, d = a))
                    } else g.Sd || (g.Sd = !0, c.push(g))
                }
            }, this);
    ...
    function ED(a, b) {
        if (!a.g || !b.rd || !(0 < b.start) && -1 != b.start) return !1;
        var c = a.a.ka.k;
        if (0 >= c || 0 >= a.b) return !1;
        var d = u() / 1E3,
    ...
    f.Ux = function(a) {
        var b = Pa(this.b, a),
            c = this.b[b + 1],
            b = this.b[b - 1],
            d = 2147483646; - 2 == a.start || -1 == a.start ? d = 2147483647 : c && 2147483647 != c.start && (d = NC(c) - 1);
        0 == a.Da && (SC(this.a, "bl"), PC(a) || SC(this.a, "fb"));
        if (c = "loaded" != a.Le) {
            if (b && OC(b)) {
                var e = NC(b);
                e > d && (d = e);
        ...
        } else this.j[a.getId()] = a, KD(this, a, d);
        lo(this.a);
        c && this.ng(a);
    ...
    function JD(a, b) {
        a.i[b.getId()] && (a.a.fw(a.i[b.getId()]), delete a.i[b.getId()])
    }
    f.ng = function(a) {
        a.ba("adBreakComplete", this.Bl, this);
    ...
    f.sv = function(a) {
        if (a.rd) {
            if (-1 != a.start && a.Ik) {
                ...
                LD(b);
                b.playVideo()
            } else PC(a) && !a.Ik ? (b = this.a, LD(b), b.playVideo()) : (LD(this.a), this.a.rb(!1));
            this.ng(a);
            a = this.k;
            a.g && 0 < a.a.ka.k && (a.b = u() / 1E3, a.i())
        } else a.isVisible || this.ng(a)
    };
    f.H = function() {
        ph(this.k);
    ...
    function PD(a, b) {
        ...
        this.a.C && (this.a.b && c.push("1_2"), this.a.g && c.push("1_2_1"), this.a.R && c.push("1_1"), this.a.S && c.push("1_3"));
    ...
    function TD(a, b) {
        if (!a.a.hd) return !1;
        var c = a.g.N();
        if (y(c.g, "906335")) return !0;
        c = b.ad_event;
        return y(QD, c) || 7 == c && (c = b.ad_error, y(RD, c) || 32 == c && y(SD, b.error_code)) ? !1 : !0
    };
            ...
            try {
                ...
                for (var k = d.zq, c = 0; c < k.length; c++) {
                    ...
                    if (s.ka.A) {
                        e = [];
                        var z = s.ka;
                        if (z.Oa) e.push(new vD(4,
                            0));
                        else {
                            z.I && (z.b || z.g) && e.push(new vD(5, 1));
                            g = 0;
                            z.C && (z.b && (g |= 1), z.g && (g |= 2), z.R && (g |= 4), z.S && (g |= 8));
                            h = 0;
                            if (z.j || z.i) z.j && (h |= 1), z.i && (h |= 2);
                            var X = 0;
                            z.o && (X = 4);
                            h || (h = X, X = 0);
                            z.Na && g && (h || X) ? e.push(new vD(3, g, h)) : (g && e.push(new vD(2, g)), h && e.push(new vD(1, h)));
                            X && e.push(new vD(1, X))
                        }
                    } else {
                        e = [];
                        var J = s.ka;
                        if (J.Oa) e.push(new vD(4, 0));
                        else {
                            J.I && J.b && e.push(new vD(5, 1));
                            g = 0;
                            J.C && (J.b && (g |= 1), J.g && (g |= 2));
                            h = 0;
                            if (J.j || J.i) J.j && (h |= 1), J.i && (h |= 2);
    ...
    function xC(a, b) {
        ...
        if (b) {
            ...
            c = d
        } else c = a.b, c = c.ca.N().Hb ? mi(c.ca).b : sp(c);
        return c
    }
    ...
    function nC(a) {
        return a.ka.u ? (a = a.N().pb || gD, new Hb(0, 0, a.width, a.height)) : Sd(S(a.a))
    }
    ...
    f.uc = function(a) {
        ...
        this.Nd && !isNaN(b) && (a = this.Nd, q(b) && (b = a.j[b])) && (a.yd == b && !b.rd && b.isVisible ? b.show() : (a.yd && a.ng(a.yd), ED(a.k, b) ? (a.yd = null, b = a.i[b.getId()], b.Sd || (b.Sd = !0, FD(a.a, [b]))) : (a.yd = b, b.G("adBreakComplete", a.sv, a), b.rd && (a = a.a, a.dk = !0, a.B("command_redirect_controls", a, ["play_pause"], void 0), so(a, ["seek"]), a.N().Od && so(a, ["audio"]), a.pauseVideo()), b.show())))
    };
    f.Yc = function(a) {
        UD.D.Yc.call(this, a);
        var b = parseInt(a.getId(), 10),
            c = 1E3 * this.a.getCurrentTime();
        this.Nd && !isNaN(b) && c > a.start && (2147483647 == a.end || 2147483646 == a.end) && (a = this.Nd, (b = a.j[b]) && a.yd == b && !b.rd && b.isVisible && b.il && b.a instanceof JC && KC(b.a, google.ima.ViewMode.FULLSCREEN))
    };
    f.yq = function() {
        SC(this, "sdk");
        ...
        if (this.ka.P) {
            ...
            var b = google.ima.AdDisplayContainer,
                c = op(this.b),
                d = rp(this.b);
            a.b || (a.b = Xb(a.g), a.b.addEventListener = t(a.lw, a), a.b.removeEventListener = t(a.mw, a));
            a = new b(c, void 0, d, a.b)
        } else {
            a = xC(this, !1);
            if (!a) return a = Error("AdModule.getVideoElement returned an invalid element."), b = new rq, b.Bd(a), b;
    ...
    function SC(a, b) {
        var c = b;
        "nl" == b && (c = a.xe, c.k++, c = c.k.toString());
        a.j[c] = u();
    ...
    function WD(a, b) {
        var c = [];
        if (y(b, a)) c.push("[...circular reference...]");
    ...
    function kE(a) {
        ...
        if (Dj) return kE(/Firefox\/([0-9.]+)/);
        if (C || mc) return Ac;
        if (Ij) return kE(/Chrome\/([0-9.]+)/);
        if (Jj) return kE(/Version\/([0-9.]+)/);
        if (Fj || Gj) {
            var a;
            if (a = /Version\/(\S+).*Mobile\/(\S+)/.exec(ic())) return a[1] + "." + a[2]
        } else {
            if (Hj) return (a = kE(/Android\s+([0-9.]+)/)) ? a : kE(/Version\/([0-9.]+)/);
            if (Ej) return kE(/Camino\/([0-9.]+)/)
        }
        return ""
    })();
    var lE = [];
    ...
    function oE(a) {
        var b;
        (b = a.a) || (b = {}, pE(a) && (b[0] = !0, b[1] = !0), b = a.a = b);
        return b
    };
    var qE;
    ...
    f.send = function(a, b, c, d) {
        ...
        try {
            mE(wE(this, "Opening Xhr")), this.K = !0, this.a.open(b, String(a), !0), this.K = !1
        } catch (e) {
        ...
        try {
            zE(this), 0 < this.k && (this.A = AE(this.a), mE(wE(this, "Will abort after " + this.k + "ms if incomplete, xhr2 " + this.A)), this.A ? (this.a.timeout = this.k, this.a.ontimeout = t(this.nc,
                this)) : this.o = mj(this.nc, this.k, this)), mE(wE(this, "Sending request")), this.C = !0, this.a.send(a), this.C = !1
        } catch (h) {
            mE(wE(this, "Send error: " + h.message)), xE(this, h)
        }
    };
    ...
    f.nc = function() {
        "undefined" != typeof aa && this.a && (this.j = "Timed out after " + this.k + "ms, aborting", this.i = 8, wE(this, this.j), ij(this, "timeout"), BE(this, 8))
    };
    ...
    function CE(a) {
        a.J || (a.J = !0, ij(a, "complete"), ij(a, "error"))
    }

    function BE(a, b) {
        a.a && a.b && (wE(a, "Aborting"), a.b = !1, a.g = !0, a.a.abort(), a.g = !1, a.i = b || 7, ij(a, "complete"), ij(a, "abort"), DE(a))
    }
    f.H = function() {
        this.a && (this.b && (this.b = !1, this.g = !0, this.a.abort(), this.g = !1), DE(this, !0));
        tE.D.H.call(this)
    };
    f.hn = function() {
    ...
    function EE(a) {
        if (a.b && "undefined" != typeof aa)
            if (a.F[1] && 4 == FE(a) && 2 == GE(a)) wE(a, "Local request error detected and ignored");
            else if (a.C && 4 == FE(a)) mj(a.hn, 0, a);
        else if (ij(a, "readystatechange"), 4 == FE(a)) {
            ...
            try {
                ...
                if (c) ij(a, "complete"), ij(a, "success");
                else {
                    a.i = 6;
                    var k;
                    try {
    ...
    function zE(a) {
        ...
        ia(a.o) && (l.clearTimeout(a.o), a.o = null)
    }
    ...
    if (navigator.plugins && navigator.plugins.length) {
        ...
        WE && (UE = !0, WE.description && VE(WE.description));
        ...
        try {
            ...
            try {
                YE = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"), UE = !0, VE(YE.GetVariable("$version"))
            } catch (aF) {}
        }
    };
    C && Cc(8);
    ...
    function kF() {
        ...
        b && c || (RE || (RE = new PE), -1 != window.location.href.indexOf("Debug=true") && QE(), QE(), RE.a.a = !0, (b = n("yt.mdx.remote.debug.logger_")) || (b = jE("yt.mdx.remote")), dF = b, aE.prototype.log = aE.prototype.log, aE.prototype.getLogRecord = aE.prototype.zw, aE.prototype.addHandler = aE.prototype.yw, aE.prototype.removeHandler = aE.prototype.Aw, ba("yt.mdx.remote.debug.logger_", dF, void 0), eF = n("yt.mdx.remote.debug.handlers_") || [], ba("yt.mdx.remote.debug.handlers_",
            eF, void 0), n("yt.mdx.remote.debug.logger_"), c = n("yt.mdx.remote.debug.handlers_"));
        c && (c.push(a), jF(c))
    }
    ...
    function mF(a, b) {
        ...
        } else d && !Ya(d) || iF(new ZD(fE, String(b), "yt.mdx.remote"))
    };
    ...
    function lF(a) {
        var b = pF();
        b && b.logMessage && (a = OE(qF, a), b.logMessage(a))
    }

    function rF() {
        if (!sF && (Ya(tF) && fb(tF, jh()), nF())) {
            var a = pF();
            a ? (a.removeReceiverListener("YouTube", uF), a.addReceiverListener("YouTube", uF), oF("API initialized in the other binary")) : (a = new cast.Api, ba("yt.mdx.remote.castapi.api_", a, void 0), a.addReceiverListener("YouTube", uF), a.setReloadTabRequestHandler && a.setReloadTabRequestHandler(function() {
                L(function() {
                    window.location.reload(!0)
                }, 1E3)
            }), qF = new NE, qF.b = !1, qF.a = !1, kF(), oF("API initialized"));
            sF = !0
        }
    }
    ...
    function uF(a) {
        ...
        x(a, function(a) {
            a.isTabProjected && (a = zF(a.id), oF("Detected device: " + a.id + " is tab projected. Firing DEVICE_TAB_PROJECTED event."), Uv("yt-remote-cast-device-tab-projected", a.id))
        })
    }
    ...
    function AF(a, b) {
        ...
        var c = zF(a);
        c ? (b.activityId && (c.activityId = b.activityId), c.status = "running" == b.status ? "RUNNING" : "stopped" == b.status ? "STOPPED" : "error" == b.status ? "ERROR" : "UNKNOWN", "RUNNING" != c.status && (c.activityId = ""), vF(c), Uv("yt-remote-cast-device-status-update", c)) : oF("Device not found")
    }
    ...
    function wF(a) {
        a = Ra(a, function(a) {
            ...
            if (a = zF(a.id)) c.activityId = a.activityId, c.status = a.status;
            return c
        });
        Za(tF);
        fb(tF, a)
    ...
    function BF(a) {
        ...
        var b = zF(a),
            c = pF();
        c && b && b.activityId ? (oF("Stopping cast activity"), c.stopActivity(b.activityId, qa(AF, a))) : oF("Dropping cast activity stop")
    }
    ...
    function HF(a) {
        ...
        if (0 <= b.search("MSIE") && (b = b.match(/MSIE ([\d.]+)/)[1], 0 > Ha(b, "10.0"))) return a;
    ...
    function LF(a, b) {
        ...
        return Qa(b, function(a) {
            return a.Db ? (a = rg(this.b, a.Db), !!a && "RUNNING" == a.status) : !!wg(c, a)
        }, a)
    }
    f.xi = function(a) {
        var b = !1;
        ...
        b && (this.log_("Renaming due to DIAL."), MF(this));
        ih(og(a));
    ...
    f.mv = function(a) {
        ...
        b && (this.log_("Updating DIAL device: " + b.id + "(" + b.name + ") from status: " + b.status + " to status: " + a.status + " and from activityId: " + b.activityId + " to activityId: " + a.activityId), b.activityId = a.activityId, b.status = a.status, ih(og(this.b)));
        FF(this, this.a)
    };
    ...
    function FF(a, b, c) {
        var d = LF(a, b),
            e = !pb(a.a, d, vg);
        !e && !c || Ya(b) || (b = sg(d), Ng("yt-remote-online-screens", b, 60));
        e && (a.log_("Updating online screens: " + hg(a.a) + " -> " + hg(d)), a.a = d, a.B("onlineReceiverChange"))
    }
    ...
    function JF(a) {
        ...
        Ya(c) || (a.log_("Updating lounge tokens for: " + ub(c)), Hk(HF("/api/lounge/pairing/get_lounge_token_batch"), {
            Ze: {
                screen_ids: c.join(",")
            },
            method: "POST",
    ...
    function MF(a) {
        var b = tg(gh());
        pb(a.Ec, b, vg) || (a.log_("Saving local screens: " + hg(b) + " to " + hg(a.Ec)), fh(sg(a.Ec)), a.rl())
    }
    ...
    f.Ap = function(a, b, c) {
        var d = !1;
        b >= GF.length && (this.log_("Pairing DIAL device " + a + " with " + c + " timed out."), d = !0);
        var e = rg(this.b, a);
        ...
        d ? (RF(this), this.B("screenPair", null)) : Hk(HF("/api/lounge/pairing/get_screen"), {
            method: "POST",
            Ze: {
                pairing_code: c
            },
            ...
            onError: function() {
                c == this.Ti && (this.log_("Polling pairing code: " + c), M(this.Zg), this.Zg = L(t(this.Ap, this, a, b + 1, c), GF[b]))
            }
        })
    };
        ...
        if (rg(a.b, b)) {
            if (!c) {
                ...
                if (k && h) {
                    ...
                    d && (m.parameters += "&v=" + d, e && (m.parameters += "&t=" + Math.round(e)), m.description.url = "http://i.ytimg.com/vi/" + d + "/default.jpg");
                    "UNKNOWN" != h.status && (h.status = "UNKNOWN", vF(h), Uv("yt-remote-cast-device-status-update", h));
                    oF("Sending a cast launch request with params: " +
                        m.parameters);
                    k.launch(m, qa(AF, b))
                } else oF("No cast API or no cast device. Dropping cast launch.")
            }
            a.Ti = c;
            a.Zg = L(t(a.Ap, a, b, 0, c), GF[0])
        } else a.log_("No DIAL device with id: " + b)
    }
    ...
    function aG(a, b) {
        ...
        var c = a.Ce ? Xb(a.Ce) : {};
        a.Xd ? (a.Af = "POST", c["Content-Type"] = "application/x-www-form-urlencoded", a.Ua.send(a.Kb, a.Af, a.Xd, c)) : (a.Af = "GET", a.Nn && !oc && (c.Connection = "close"), a.Ua.send(a.Kb, a.Af, null, c));
        a.g.zc(1);
        var d = a.Xd;
        if (d)
    ...
    f.ju = function(a) {
        a = a.target;
        var b = this.ci;
        b && 3 == FE(a) ? (this.a.debug("Throttling readystatechange."), HB(b)) : this.Vn(a)
    };
    f.Vn = function(a) {
        try {
            if (a == this.Ua) t: {
                ...
                if (C && !Dc(10) || oc && !Cc("420+")) {
                    if (4 > b) break t
                } else if (3 > b || 3 == b && !mc && !HE(this.Ua)) break t;this.Ke || 4 != b || 7 == c || (8 == c || 0 >= d ? this.g.zc(3) : this.g.zc(2));dG(this);
                var e = GE(this.Ua);this.og = e;
                var g = HE(this.Ua);g || this.a.debug("No response text for uri " + this.Kb + " status " + e);this.Ac = 200 == e;this.a.info("XMLHTTP RESP (" + this.i + ") [ attempt " + this.k + "]: " + this.Af + "\n" + this.Kb + "\n" + b + " " + e);this.Ac ? (4 == b && eG(this), this.C ? (fG(this,
                    b, g), mc && this.Ac && 3 == b && (this.b.listen(this.o, "tick", this.Rt), this.o.start())) : (gG(this.a, this.i, g, null), hG(this, g)), this.Ac && !this.Ke && (4 == b ? this.g.Zh(this) : (this.Ac = !1, cG(this)))) : (400 == e && 0 < g.indexOf("Unknown SID") ? (this.$d = 3, iG(), this.a.Rd("XMLHTTP Unknown SID (" + this.i + ")")) : (this.$d = 0, iG(), this.a.Rd("XMLHTTP Bad status " + e + " (" + this.i + ")")), eG(this), jG(this))
            }
            else this.a.Rd("Called back with an unexpected xmlhttp")
        } catch (h) {
            this.a.debug("Failed call to OnXmlHttpReadyStateChanged_"), this.Ua &&
                HE(this.Ua) && HE(this.Ua)
        } finally {}
    };
    ...
    function fG(a, b, c) {
        for (var d = !0; !a.Ke && a.Eg < c.length;) {
            ...
            if (e == ZF) {
                ...
                d = !1;
                break
            } else gG(a.a, a.i, e, null), hG(a, e)
        }
        4 == b && 0 == c.length && (a.$d = 1, iG(), d = !1);
        a.Ac = a.Ac && d;
        d || (gG(a.a, a.i, c, "[Invalid Chunked Response]"), eG(a), jG(a))
    }
    f.Rt = function() {
        var a = FE(this.Ua),
            b = HE(this.Ua);
        this.Eg < b.length && (dG(this), fG(this, a, b), this.Ac && 4 != a && cG(this))
    };
    ...
    function kG(a, b) {
        ...
        if (isNaN(c)) return YF;
        d += 1;
        if (d + c > b.length) return ZF;
        var e = b.substr(d, c);
        a.Eg = d + c;
        return e
    }
    ...
    f.Oy = function(a) {
        this.Ke || (this.a.info("TRIDENT TEXT (" + this.i + "): " + a ? "success" : "failure"), eG(this), this.Ac = a, this.g.Zh(this), this.g.zc(4))
    };
    f.cancel = function() {
        this.Ke = !0;
        eG(this)
    ...
    function oG(a, b) {
        if (null != a.Jf) throw Error("WatchDog timer not null");
        a.Jf = mG(t(a.ty, a), b)
    }

    function dG(a) {
        a.Jf && (l.clearTimeout(a.Jf), a.Jf = null)
    }
    f.ty = function() {
        this.Jf = null;
        var a = u();
        0 <= a - this.yl ? (this.a.info("TIMEOUT: " + this.Kb), 2 != this.Cf && this.g.zc(3), eG(this), this.$d = 2, iG(), jG(this)) : (this.a.Rd("WatchDog timer called too early"), oG(this, this.yl - a))
    };
    ...
    function rG(a, b, c) {
        ...
        e.onload = function() {
            try {
                d.debug("TestLoadImage: loaded"), sG(e), c(!0)
            } catch (a) {}
        };
        e.onerror = function() {
            try {
                d.debug("TestLoadImage: error"), sG(e), c(!1)
            } catch (a) {}
        };
        e.onabort = function() {
            try {
                d.debug("TestLoadImage: abort"), sG(e), c(!1)
            } catch (a) {}
        };
        e.ontimeout = function() {
            try {
                d.debug("TestLoadImage: timeout"), sG(e), c(!1)
            } catch (a) {}
        };
    ...
    f.connect = function(a) {
        ...
        this.vo = u();
        var b = this.a.u;
        null != b ? (this.Kg = b[0], (this.Ng = b[1]) ? (this.Pb = 1, vG(this)) : (this.Pb = 2, wG(this))) : (Ve(a, "MODE", "init"), this.Nb = new WF(this, this.b, void 0, void 0, void 0), this.Nb.Ce = this.Lk, bG(this.Nb, a, !1, null, !0), this.Pb = 0)
    };
    ...
    function wG(a) {
        ...
        var b = a.a.A;
        if (null != b) a.b.debug("TestConnection: skipping stage 2, precomputed result is " + b ? "Buffered" : "Unbuffered"), iG(), b ? (iG(), zG(a.a, a, !1)) : (iG(), zG(a.a, a, !0));
        else if (a.Nb = new WF(a, a.b, void 0, void 0, void 0), a.Nb.Ce = a.Lk, b = AG(a.a, a.Kg, a.ll), iG(), !C || Dc(10)) Ve(b, "TYPE", "xmlhttp"), bG(a.Nb, b, !1, a.Kg, !1);
        else {
            Ve(b, "TYPE", "html");
            var c = a.Nb;
            a = Boolean(a.Kg);
    ...
    f.Kp = function(a, b) {
        ...
        if (0 == this.Pb)
            if (this.b.debug("TestConnection: Got data for stage 1"), b) {
                ...
                this.Kg = c[0];
                this.Ng = c[1]
            } else this.b.debug("TestConnection: Null responseText"), BG(this.a, this);
        else if (2 == this.Pb)
            if (this.Ai) iG(), this.dl = u();
            else if ("11111" == b) {
            if (iG(), this.Ai = !0, this.zi = u(), c = this.zi - this.vo, !C || Dc(10) || 500 > c) this.Se = 200, this.Nb.cancel(), this.b.debug("Test connection succeeded; using streaming connection"), iG(), zG(this.a,
                this, !0)
        } else iG(), this.zi = this.dl = u(), this.Ai = !1
    };
    f.Zh = function() {
        this.Se = this.Nb.og;
        if (!this.Nb.Ac) this.b.debug("TestConnection: request failed, in state " + this.Pb), 0 == this.Pb ? iG() : 2 == this.Pb && iG(), BG(this.a, this);
        else if (0 == this.Pb) this.b.debug("TestConnection: request complete for initial check"), this.Ng ? (this.Pb = 1, vG(this)) : (this.Pb = 2, wG(this));
        else if (2 == this.Pb) {
            this.b.debug("TestConnection: request complete for stage 2");
            var a = !1;
            (a = !C || Dc(10) ? this.Ai : 200 > this.dl - this.zi ? !1 : !0) ? (this.b.debug("Test connection succeeded; using streaming connection"), iG(),
                zG(this.a, this, !0)) : (this.b.debug("Test connection failed; not using streaming"), iG(), zG(this.a, this, !1))
        }
    };
    f.ji = function() {
        return this.a.ji()
    ...
    f.connect = function(a, b, c, d, e) {
        ...
        this.Jk = b;
        this.Vg = c || {};
        d && q(e) && (this.Vg.OSID = d, this.Vg.OAID = e);
    ...
    function IG(a) {
        if (a.ie) {
            var b = a.ie;
            b.Nb && (b.Nb.cancel(), b.Nb = null);
            b.Se = -1;
            a.ie = null
        }
        a.Ra && (a.Ra.cancel(), a.Ra = null);
        a.Cd && (l.clearTimeout(a.Cd), a.Cd = null);
        LG(a);
        a.Bb && (a.Bb.cancel(), a.Bb = null);
        a.ge && (l.clearTimeout(a.ge), a.ge = null)
    }
    ...
    function NG(a) {
        a.Bb || a.ge || (a.ge = mG(t(a.Ho, a), 0), a.Dg = 0)
    }
    f.Ho = function(a) {
        this.ge = null;
        PG(this, a)
    ...
    function PG(a, b) {
        ...
        } else 3 == a.b && (b ? RG(a, b) : 0 == a.g.length ? a.a.debug("startForwardChannel_ returned: nothing to send") : a.Bb || (RG(a), a.a.debug("startForwardChannel_ finished, sent request")))
    }

    function RG(a, b) {
        var c, d;
        b ? 6 < a.Ie ? (a.g = a.i.concat(a.g), a.i.length = 0, c = a.zg - 1, d = QG(a)) : (c = b.i, d = b.Xd) : (c = a.zg++, d = QG(a));
        var e = a.di.clone();
        Ue(e, "SID", a.j);
        Ue(e, "RID", c);
        Ue(e, "AID", a.pf);
    ...
    function QG(a) {
        var b = Math.min(a.g.length, 1E3),
            c = ["count=" + b],
            d;
        6 < a.Ie && 0 < b ? (d = a.g[0].a, c.push("ofs=" + d)) : d = 0;
        for (var e = 0; e < b; e++) {
            var g = a.g[e].a,
                h = a.g[e].map,
                g = 6 >= a.Ie ? e : g - d;
    ...
    function SG(a) {
        a.Ra || a.Cd || (a.o = 1, a.Cd = mG(t(a.hp, a), 0), a.Hf = 0)
    }

    function TG(a) {
        if (a.Ra || a.Cd || 3 <= a.Hf) return !1;
    ...
    f.hp = function() {
        ...
        Ue(a, "AID", this.pf);
        JG(this, a);
        if (!C || Dc(10)) Ue(a, "TYPE", "xmlhttp"), bG(this.Ra, a, !0, this.vi, !1);
        else {
            Ue(a, "TYPE", "html");
            var b = this.Ra,
                c = Boolean(this.vi);
    ...
    f.Kp = function(a, b) {
        if (0 != this.b && (this.Ra == a || this.Bb == a))
            if (this.Vc = a.og, this.Bb == a && 3 == this.b)
                if (7 < this.Ie) {
                    var c;
                    try {
                        c = this.k.parse(b)
                    ...
                    if (ga(c) && 3 == c.length) {
                        var e = c;
                        if (0 == e[0]) t: if (this.a.debug("Server claims our backchannel is missing."), this.Cd) this.a.debug("But we are currently starting the request.");
                            else {
                                if (this.Ra)
                                    if (this.Ra.vg + 3E3 < this.Bb.vg) LG(this), this.Ra.cancel(), this.Ra = null;
                                    else break t;
                                else this.a.Rd("We do not have a BackChannel established");
                                TG(this);
                                iG()
                            }
                        else this.Co =
                            e[1], c = this.Co - this.pf, 0 < c && (e = e[2], this.a.debug(e + " bytes (in " + c + " arrays) are outstanding on the BackChannel"), 37500 > e && this.Nh && 0 == this.Hf && !this.Te && (this.Te = mG(t(this.lv, this), 6E3)))
                    } else this.a.debug("Bad POST response data returned"), yG(this, 11)
                } else "y2f%" != b && (this.a.debug("Bad data returned - missing/invald magic cookie"), yG(this, 11));
        else if (this.Ra == a && LG(this), !/^[\s\xa0]*$/.test(b))
            for (c = this.k.parse(b), ga(c), e = 0; e < c.length; e++) {
                var g = c[e];
                this.pf = g[0];
                g = g[1];
                2 == this.b ? "c" == g[0] ? (this.j =
                    g[1], this.vi = g[2], g = g[3], null != g ? this.Ie = g : this.Ie = 6, this.b = 3, this.ub && this.ub.Bo(this), this.qo = AG(this, this.vi, this.Jk), SG(this)) : "stop" == g[0] && yG(this, 7) : 3 == this.b && ("stop" == g[0] ? yG(this, 7) : "noop" != g[0] && this.ub && this.ub.Ao(this, g), this.Hf = 0)
            }
    };
    f.lv = function() {
        null != this.Te && (this.Te = null, this.Ra.cancel(), this.Ra = null, TG(this), iG())
    };

    function LG(a) {
        null != a.Te && (l.clearTimeout(a.Te), a.Te = null)
    }
    f.Zh = function(a) {
        this.a.debug("Request complete");
        var b;
        if (this.Ra == a) LG(this), this.Ra = null, b = 2;
        else if (this.Bb == a) this.Bb = null, b = 1;
        else return;
        this.Vc = a.og;
        if (0 != this.b)
            if (a.Ac) 1 == b ? (u(), ij(EG, new GG(EG, a.Xd ? a.Xd.length : 0)), NG(this), this.i.length = 0) : SG(this);
            else {
                var c = a.$d;
                if (3 == c || 7 == c || 0 == c && 0 < this.Vc) this.a.debug("Not retrying due to error type");
                else {
                    this.a.debug("Maybe retrying, last error: " + XF(c, this.Vc));
                    var d;
                    if (d = 1 == b) this.Bb || this.ge ? d = !1 : 1 == this.b || 2 <= this.Dg ? d = !1 : (this.a.debug("Going to retry POST"),
                        this.ge = mG(t(this.Ho, this, a), UG(this, this.Dg)), this.Dg++, d = !0);
                    if (d || 2 == b && TG(this)) return;
    ...
    function UG(a, b) {
        ...
        a.ub || (a.a.debug("Inactive channel"), c *= 2);
        return c * b
    }
    f.ow = function(a) {
        if (!y(arguments, this.b)) throw Error("Unexpected channel state: " + this.b);
    };
    ...
    function yG(a, b) {
        ...
        if (2 == b || 9 == b) {
            ...
            a.ub && (c = null);
            var d = t(a.ww, a);
            c || (c = new Ge("//www.google.com/images/cleardot.gif"), Xe(c));
            rG(c.toString(), 1E4, d)
        } else iG();
        VG(a, b)
    }
    f.ww = function(a) {
        a ? (this.a.info("Successfully pinged google.com"), iG()) : (this.a.info("Failed to ping google.com"), iG(), VG(this, 8))
    };
    ...
    function KG(a) {
        ...
        a.Vc = -1;
        if (a.ub)
            if (0 == a.i.length && 0 == a.g.length) a.ub.Tk(a);
            else {
    ...
    function xG(a, b, c) {
        var d = Ye(c);
        if ("" != d.Me) b && Ie(d, b + "." + d.Me), Je(d, d.Xg);
    ...
    function XG(a) {
        a && (this.id = a.id || a.name, this.name = a.name, this.app = a.app, this.type = a.type || "REMOTE_CONTROL", this.Lp = a.user || "")
    }
    f = XG.prototype;
    f.id = "";
    f.name = "";
    ...
    function YG(a, b) {
        kj.call(this);
        if (ja(a)) b && (a = t(a, b));
        else if (a && ja(a.handleEvent)) a = t(a.handleEvent, a);
        else throw Error("Invalid listener argument");
        this.o = a;
    ...
    f.dispose = function() {
        this.F || (this.F = !0, this.g.clear(), this.disconnect(), ph(this.g))
    };
    f.ia = function() {
        return this.F
    };
    f.connect = function(a, b, c) {
        if (!this.a || 2 != this.a.b) {
            ...
            d.ub = this;
            this.a = d;
            e ? (3 != e.b && 0 == OG(e) || this.A.Rd("Unexpected state on old channel when reconnecting: " + e.b), this.a.connect(a, b, this.o, e.j, e.pf)) : c ? this.a.connect(a, b, this.o, c.sessionId, c.arrayId) : this.a.connect(a, b, this.o)
        }
    };
    f.disconnect = function(a) {
        this.C = a || 0;
        this.b.stop();
        this.a && (3 == this.a.b && PG(this.a), this.a.disconnect());
        this.C = 0
    };
    f.sendMessage = function(a, b) {
        ...
        b && $b(c, b);
        this.b.enabled || 2 == (this.a ? this.a.b : 0) ? (this.A.info("Queuing message while (re)connecting: " + a), this.k.push(c)) : $G(this) ? MG(this.a, c) : this.A.Rd("Ignoring message: " + a)
    };
    f.Bo = function() {
        var a = this.b;
        a.stop();
        ...
        if (this.k.length) {
            a = this.k;
            this.k = [];
            for (var b = 0, c = a.length; b < c; ++b) this.A.info("Sending queued message: " + a[b]._sc), MG(this.a, a[b])
        }
    ...
    f.$o = function(a, b) {
        ...
        if (4 != b && !c) {
            if (6 == b || 410 == this.a.Vc) c = this.b, c.stop(), lj(c, 500);
            this.b.start()
        }
        this.B("handlerError", b)
    };
    f.Tk = function(a, b, c) {
        if (!this.b.enabled) this.B("handlerClosed");
        else if (c)
    ...
    f.Ao = function(a, b) {
        if ("S" == b[0]) this.u = b[1];
            ...
            this.b.start();
            this.a.disconnect()
        } else this.B("handlerMessage", new CF(b[0], b[1]))
    };
    ...
    cH.prototype.reset = function(a) {
        ...
        this.index = -1;
        dH(this);
        a && (this.kb = a.videoIds, this.index = a.index, this.a = a.playerState, this.g = a.errorReason, this.volume = a.volume, this.muted = a.muted, this.b = a.trackData, this.i = a.playerTime, this.j = a.playerTimeAt)
    };
    ...
    function iH(a, b, c) {
        c = c || eH(a);
        if (pb(a.kb, b) && c == eH(a)) return !1;
        a.kb = eb(b);
        hH(a, c);
        return !0
    }
    cH.prototype.add = function(a) {
        return a && !y(this.kb, a) ? (this.kb.push(a), !0) : !1
    };
    cH.prototype.remove = function(a) {
        var b = eH(this);
        return ab(this.kb, a) ? (this.index = Pa(this.kb, b), !0) : !1
    };
    ...
    function pH(a, b) {
        "playerChange" == b ? (M(a.bh), a.bh = L(t(function() {
            this.B("playerChange");
            this.bh = NaN
        }, a), 2E3)) : "playlistChange" == b && (M(a.dh), a.dh = L(t(function() {
    ...
    function rH(a, b) {
        b ? (a.log_("Changing current screen id from: " + a.i + " to " + b.tb), a.i = b.tb, aH(a.g, b.ic)) : (a.log_("Removing current screen id: " + a.i), a.i = "", aH(a.g, ""))
    }
    ...
    function uH(a, b) {
        ...
        a.b ? kh(xH(a.b), "") : kh("", "");
        a.a = new cH;
        Vb(c) || (a.a.kb = c.videoIds.split(","), hH(a.a, c.videoId));
        a.g.connect(Vb(c) ? {} : {
            method: "setPlaylist",
            params: ub(c)
        }, 1, eh());
    ...
    f.Xn = function(a) {
        ...
        zH(this);
        a ? uH(this, a) : (this.j = "", oH(this, "connectionError"))
    };
    f.disconnect = function() {
    ...
    function AH(a) {
        ...
        b ? (a.log_("Did not stop DIAL device, because another remote is connected: " + ub(b ? {
            ...
            type: b.type,
            user: b.Lp
        } : null)), a.j = "") : (b = sH(a), a.j ? (a.log_("Stopping DIAL device: " + a.j), BF(a.j), a.j = "") : b && b.Db && (a.log_("Stopping DIAL device: " + b.Db), BF(b.Db)))
    }
    ...
    function FH(a, b) {
        var c = sH(a),
            d = Ua(b, function(a) {
                var b;
                if (b = c) b = a.key, b = b == c.tb || b == c.Db;
    ...
    f.playVideo = function(a, b, c) {
        ...
        var d;
        d = this.a;
        a && !y(d.kb, a) ? (-1 < d.index && d.index >= d.kb.length - 1 ? d.kb.push(a) : d.kb.splice(d.index + 1, 0, a), d = !0) : d = !1;
    ...
    function MH(a) {
        if ($G(a.g))
            if (a.b.a.getVideoData().Pa && !NH(a.b)) a.log_("Wait for playlist data to be loaded.");
            else {
                ...
                if (b = c.a.zb()) {
                    c = [];
                    for (e = 0; e < b.dc; e++) c[e] = Wh(b, e).L;
                    b = c
                } else b = [c.a.getVideoData().L];
                c = OH(a.b)[PH(a.b)];
                g ? (g = a.b.a.getCurrentTime(), h ? KH(a, d, b, c,
                    g) : a.playVideo(d, c, g)) : h && LH(a, b, c)
            }
    }
    f.play = function() {
        IH(this, "play");
        fH(this.a, gH(this.a)); - 1E3 != this.a.a && (this.a.a = 1);
        pH(this, "playerChange")
    };
    f.pause = function() {
        IH(this, "pause");
        fH(this.a, gH(this.a)); - 1E3 != this.a.a && (this.a.a = 2);
        pH(this, "playerChange")
    };
    f.setVolume = function(a, b) {
        var c = {
    ...
    function QH(a, b, c) {
        c ? (a.a.b = {
            ...
            videoId: b,
            style: ub(c.style)
        }, $b(b, a.a.b), IH(a, "setSubtitlesTrack", b)) : IH(a, "setSubtitlesTrack");
        pH(a, "playerChange")
    }
    f.xo = function() {
    ...
    function UH(a, b) {
        switch (b.action) {
            ...
            case "remoteDisconnected":
                d = new XG(sb(b.params.device)), cb(a.o, function(a) {
                    return a.equals(d)
                })
        }
    }
    ...
    function VH(a, b) {
        var c = !1;
        if ("loungeStatus" == b.action) c = !!Ua(a.o, function(a) {
            return "LOUNGE_SCREEN" == a.type
        });
        ...
        if (c != HH(a))
            if (c) {
                if (RH(a), oH(a, "connectionOpened"), a.xo(), EH(a) && a.b) {
                    var c = xH(a.b),
                        d = OH(a.b)[PH(a.b)];
                    IH(a, "insertVideo", {
                        videoId: c,
    ...
    f.Vv = function(a) {
        ...
        if (HH(this)) {
            var b = !1,
                c = !1,
                d, e, g, h, k, m, p;
            a.params && (d = a.params.videoId || a.params.video_id, e = a.params.videoIds || a.params.video_ids, g = a.params.state, h = a.params.currentTime || a.params.current_time, k = a.params.volume, m = a.params.muted, q(a.params.currentError) && (p = sb(a.params.currentError)));
            if ("onSubtitlesTrackChanged" == a.action) d == eH(this.a) && (delete a.params.videoId,
                Vb(a.params) ? this.a.b = null : this.a.b = a.params, qH(this, "playerChange"));
            else if (eH(this.a) || "onStateChange" != a.action) "playlistModified" != a.action && "nowPlayingPlaylist" != a.action || e ? (d || "nowPlaying" != a.action && "nowPlayingPlaylist" != a.action ? d ? d != eH(this.a) && (b = !0) : d = eH(this.a) : (hH(this.a, ""), b = !0), e && (e = e.split(","), iH(this.a, e, d) && (b = !0))) : (iH(this.a, []), b = !0), this.a.add(d) && IH(this, "getPlaylist"), d && hH(this.a, d), b && qH(this, "playlistChange"), q(g) && (b = parseInt(g, 10), b = isNaN(b) ? -1 : b, -1 == b && -1E3 == this.a.a &&
                (b = -1E3), 0 == b && "0" == h && (b = -1), c = c || b != this.a.a, this.a.a = b, d = null, -1E3 == b && (d = this.a.g || "unknown", p && (d = p.reason || d)), c = c || this.a.g != d, this.a.g = d, 1 == this.a.a ? (SH(this), this.fl = L(t(this.xo, this), 2E4)) : SH(this)), "onError" != a.action || -1 != this.a.a && -1E3 != this.a.a || (a = sb(a.params.errors) || [], 1 == a.length && "PLAYER_ERROR" == a[0].error && a[0].videoId == eH(this.a) && (this.a.a = -1E3, this.a.g = a[0].reason || "unknown", c = !0)), h && (b = parseInt(h, 10), fH(this.a, isNaN(b) ? 0 : b), c = !0), q(k) && (b = parseInt(k, 10), isNaN(b) || (c = c || this.a.volume !=
                b, this.a.volume = b), q(m) && (m = "true" == m, c = c || this.a.muted != m, this.a.muted = m)), c && qH(this, "playerChange")
        }
    };
    f.rl = function() {
        this.i && !sH(this) ? (this.log_("Dropping current screen with id: " + this.i), this.disconnect(), this.a = null) : mH() || lh()
    };
    ...
    f.Vw = function(a, b) {
        ...
        switch (a) {
            case "control_toggle_play_pause":
                1 == c.a ? $H(this) : (this.b.play(), this.a.rb(!0));
                break;
            case "control_play":
                this.b.play();
                this.a.rb(!0);
    ...
    f.Ts = function() {
        var a = this.o,
            b = GH(this.b);
        XH(this);
        bI(this, a); - 1 == b.a ? ZH(this, a) : (b = this.b, a = Math.floor(a), IH(b, "seekTo", {
            newTime: a
        }), fH(b.a, a), -1E3 != b.a.a && (b.a.a = 3), pH(b, "playerChange"))
    };
    ...
    function aI(a, b) {
        if (YH(a)) {
            ...
            } else QH(a.b, a.a.a.getVideoData().L, null);
            a.g = GH(a.b).b
        }
    }
    ...
    f.pn = function() {
        if (YH(this)) {
            ...
            0 == this.k && (b = this.a.a, (b = Q(b.app, b.a || 1)) && b.fg(!1));
            this.k = a.a;
            gI(this);
            b = Math.round(this.a.a.rn()); - 1 ==
                a.volume || b == a.volume && this.a.a.sn() == a.muted || (this.a.ba("onVolumeChange", this.Kh, this), this.a.a.setVolume(a.volume), a.muted ? this.a.a.tn() : this.a.a.un(), this.a.G("onVolumeChange", this.Kh, this))
        } else this.a.rb(!1)
    };
    ...
    function gI(a) {
        ...
        if (!yg(b, a.g))
            ...
            } else a.a.a.xn("captions")
    }
    f.qn = function() {
        YH(this) || (bI(this, 0), XH(this), this.a.rb(!1))
    };
    ...
    function eI(a) {
        XH(a);
        JH(a.b) || (bI(a, gH(GH(a.b))), a.i = L(t(function() {
            eI(this)
        }, a), 500))
    }
    ...
    function hI() {
        Y.call(this, ["div", ["html5-bezel", "html5-center-overlay"],
            ["div", "{{icon}}"]
        ]);
        this.a = NaN;
        this.hide()
    ...
    jI.prototype.show = function(a) {
        if (a || this.element.childNodes.length) {
            if (a) {
                ...
                var b = this.element,
                    c = this.a;
                if (null != Xo("backgroundSize")) d = document.createElement("div"), d.style.backgroundImage = "url(" + ap(b, a, c) + ")";
                else {
                    var d = document.createElement("img");
                    d.src = ap(b, a, c);
                    a = d;
                    b.clientWidth / b.clientHeight < $o ? (a.style.height = "100%", a.style.width = "auto") : (a.style.height = "auto", a.style.width = "100%")
                }
                G(d, "video-thumbnail");
    ...
    function kI(a, b, c, d) {
        ...
        lI(this);
        b = D("html5-remote-display-error",
            b);
        b.innerHTML = "";
        c = dd("div");
        b.appendChild(c);
    ...
    f.wy = function(a) {
        a && !a.disabled && (qI(this, a), this.click(a))
    };
    f.uy = function(a, b, c) {
    ...
    function sI(a, b, c, d, e) {
        ...
        else g ? 27 == d.keyCode ? (tI(a, c), uI(a, b)) : e(b, c, d) : (a = ef(b, $(a, "reverse")) ? 38 : 40, d.keyCode == a && (Zf(b, "click"), d.preventDefault()))
    }
    f.vy = function(a, b, c) {
        c.altKey || c.ctrlKey || c.shiftKey || (a = rI(this, a), To(a) && c.preventDefault())
    };
    ...
    f.xy = function(a, b, c) {
        ...
        b = Vc("td", null, b);
        d = wI(d, b, e, c); - 1 != d && (vI(this, a, b[d]), c.preventDefault())
    };
    f.yy = function(a, b, c) {
    ...
    function xI(a, b) {
        var c = b.iframeMask;
        c || (c = document.createElement("iframe"), c.src = 'javascript:""', c.className = $(a, "menu-mask"), b.iframeMask = c);
        return c
    }
    ...
    function yI(a, b, c, d) {
        ...
        ef(b, "flip") && (ef(b, $(a, "reverse")) ? (g = 6, h = 7) : (g = 7, h = 6));
        var p;
        K(b, "button-has-sibling-menu") ? p = Ed(e) : K(b, "button-menu-root-container") && (p = zI(b));
        C && !Cc("8") && (p = null);
        var s;
        p && (s = Sd(p), s = new Eb(-s.top, s.left, s.top, -s.left));
        p = new A(0, 1);
        ef(b, $(a, "center-menu")) && (p.x -= Math.round((Qd(c).width - Qd(b).width) / 2));
        d && (p.y += Zc(document).y);
        if (a = xI(a, b)) b = Qd(c), a.style.width = b.width + "px", a.style.height = b.height + "px", jv(e, g, a, h, p, s), d && Yo(a, "position", "fixed");
        jv(e, g, c, h, p, s)
    }
    ...
    f.xp = function(a, b, c) {
        ...
        if (!d || e && (g || h))
            if (uI(this, a), d && b && K(a, "button-menu-indicate-selected")) {
                if (a = D($(this, "content"), a)) Ic && "innerText" in c ? b = c.innerText.replace(/(\r\n|\r|\n)/g, "\n") : (b = [], rd(c, b, !0), b = b.join("")), b = b.replace(/ \xAD /g, " ").replace(/\xAD/g,
                    ""), b = b.replace(/\u200B/g, ""), Ic || (b = b.replace(/ +/g, " ")), " " != b && (b = b.replace(/^\s*/, "")), md(a, b);
    ...
    f.click = function(a) {
        if (rI(this, a)) {
            ...
            c && c != a ? (uI(this, c), L(t(this.Ep, this, a), 1)) : To(b) ? uI(this, a) : this.Ep(a);
            a.focus()
        }
    ...
    CI.prototype.o = function(a) {
        (a = a.currentTarget) && "remote-select-receiver" == K(a, "action") && (a = K(a, "value"), FI(this, a), this.B("selectreceiver", a))
    };
    ...
    function GI(a) {
        ...
        if (a.k) a.log_("Connecting with the delayed connect data: " + ub(a.k)), a.connect({
            key: a.k.key
        }), Rg("yt-remote-delayed-connect-key");
        else {
            var c = mH();
            c ? c.tb == a.i ? a.log_("Skipping connecting because current connection exists.") :
                (a.log_("Resuming MDx session: " + gg(c)), rH(a, c), a.g.connect({}, 0, eh()), a.a = new cH, yH(a)) : (lh(), a.log_("Skipping connecting because no session screen found."))
        }
    ...
    f.unload = function() {
        this.aa && (this.aa = !1, KI(this, this.k), this.rb(!1), uo(this), this.g.ba("reconnectclicked", this.dn, this), cI(this), qh(this.j, this.g), this.g = this.j = null, GI.D.unload.call(this))
    };
    f.H = function() {
        Tf(this.I);
        this.I.length = 0;
    ...
    f.dn = function() {
        var a = this.b;
        JH(a) && (a = a.g.b, a.enabled && (a.stop(), a.start(), a.k()));
        mI(this.g)
    };
    f.je = function(a, b) {
    ...
    f.um = function(a) {
        if (this.i.key != a)
            if (this.k.key == a) {
                ...
                this.b.disconnect();
                this.unload();
                a && (this.a.wg(b), this.a.playVideo())
            } else if (a = mg(mh(), a)) KI(this, a), this.b.connect(a), this.load()
    };

    function KI(a, b) {
        var c = a.i;
        (c || b ? c && b && c.key == b.key : 1) || (a.i = b, FI(a.u, b.key))
    }
    f.eg = function() {
        var a = mh();
        ...
        this.g && (a = this.g, a.I = this.i.name, lI(a))
    };

    function LI(a) {
        cI(a);
        JH(a.b) ? (oI(a.g, bH(a.b.g)), a.F = L(t(function() {
            LI(this)
        }, a), 1E3)) : mI(a.g)
    }
    ...
    f.qj = function() {
        ...
        O(this, this.k);
        this.lb ? this.R = N(window, "resize", t(this.Ig, this)) : Hv() ? this.R =
            Df(t(this.Jv, this), 250) : this.R = Df(t(this.Ig, this), 250)
    };
    f.Mi = function(a) {
        ...
        if (this.b) {
            ...
            if (!a.isEmpty()) {
                ...
                var e = RI(this),
                    g = !1,
                    h;
                e ? (h = SI(this, d, c, e, !1), b = h.width / h.height / Gb(c), 0.001 > Math.abs(b - 1) && (b = 1), h = new Hb(h.left + h.width / 2 * (1 - 1 / b), h.top, h.width / b, h.height)) : h = new Hb(0, 0, d.width, d.height);
                Jb(this.la, h) || (this.la = h, Md(this.b, Kb(h)), Bd(this.b, new A(h.left, h.top)), g = !0);
                c = SI(this, d, c, e);
                Jb(this.K, c) || (this.K = c, Md(this.$, c.width, c.height), Bd(this.$, c.left, c.top), g = !0);
                Yo(this.b, "transform", 1 == b ? "none" : "scaleX(" +
                    b + ")");
                b = g;
                if (g = !Fb(a, Kb(this.K))) this.K.width = a.width, this.K.height = a.height, this.Jl(a);
                (b || g) && this.B("resize")
            }
        }
    };
    ...
    function SI(a, b, c, d, e) {
        c.isEmpty() ? d = b : d ? (c = a.xb || VI(c), a = a.Xa || c, d = VI(b), d = a > d ? new B(b.width, b.width / (isFinite(a) ? a : c)) : a < d ? new B(b.height * a, b.height) : b.clone(), e || (c > a ? d.width = d.height * c : c < a && (d.height = d.width / c))) : (e = c.clone(), d = e.scale(Gb(e) > Gb(b) ? b.width / e.width : b.height / e.height));
    ...
    function ai(a) {
        a.k && (a.k.show(), a.Np(), Ef(a.Oa), a.Oa = Df(t(a.Np, a), 500))
    }
    f.Np = function() {
        var a = Q(this.app),
        ...
        b.a && (d = b.a, c.dash = d.i && d.g ? "no" : "yes", c.mime = b.a.Sc);
        if (a = a.u ? a.u.b : null) c.drm_flavor = a.b, c.drm_key_system = a.a;
        this.k.update(c)
    };
    f.Bk = function(a) {
        a && a.stopPropagation();
        this.k && (Ef(this.Oa), this.k.hide())
    };
    f.Yk = function() {
        this.j = new ep;
        this.j.b = this
    ...
    f.Qy = function(a) {
        a && y(this.b, a) && (Zj(a), Yf(a), ab(this.b, a))
    };
    f.Ny = function(a) {
    ...
    function YI(a, b, c, d) {
        if (this.g = !!c) this.kl = Math.max(800, this.kl);
        this.element = a;
        this.A = b;
        this.k = d;
    ...
    function bJ() {
        ZI && !aJ && (aJ = !0, document.addEventListener("click", function(a) {
    ...
    function cJ(a) {
        ...
        window.setTimeout(function() {
            var b = $I.indexOf(a); - 1 != b && $I.splice(b, 1)
        }, 2500)
    }
    f = YI.prototype;
    f.kl = 1E3;
    f.Qw = function(a) {
        if (!(1 < a.touches.length || a._stop)) {
            this.a = a._stop = !0;
            this.g || (this.element.ontouchend = t(this.jo, this), document.body.addEventListener("touchend", dJ(this), !1));
    ...
    f.jo = function(a) {
        "touchend" == a.type && !this.a || a._stop || (a._stop = !0, this.ni(!0), window.setTimeout(t(function() {
            this.Ci();
            this.A(a)
        }, this), 0))
    };
    f.vx = function(a) {
        1 < a.touches.length ? this.Ci() : (a = a.touches[0], a = new A(a.clientX, a.clientY), this.b && 12 < Cb(this.b, a) && this.Ci())
    };
    ...
    function kJ(a, b, c) {
        for (var d = Uc(Ro[b], a.ib), e = 0; e < d.length; e++) a.g.listen(d[e], "click", function(a) {
    ...
    f.ou = function(a) {
        a.preventDefault();
        To(this.ib) ? a.stopPropagation() : (gJ(this.ib, a), Uo(this.ib), this.a.listen(this.ib, "contextmenu", function(a) {
            a.preventDefault()
        }), a = t(function() {
            this.a.listen(window, "blur", this.hide);
            this.a.listen(document, "click", this.hide)
        }, this), L(a, 0), this.a.listen(document, "keydown", this.uw))
    };
    f.uw = function(a) {
    ...
    function pJ() {
        Y.call(this, ["div", ["ytp-error", "html5-stop-propagation"],
        ...
        ym && (this.a = new nJ(1, 1), this.a.X(this.element, 0), O(this, this.a))
    }
    v(pJ, Y);
    ...
    function qJ(a, b) {
        Y.call(this, ["div", ["ytp-interstitial", "html5-stop-propagation"],
            ["div", "ytp-interstitial-content", ["div", "ytp-error-content-wrap", "{{content}}"],
                ["button", "yt-uix-button ytp-interstitial-button", "{{ok}}"]
            ]
        ]);
    ...
    f.update = function(a) {
        ...
        "watch_actions_ajax" in vf && !this.ca.g ? (a = this.b, a.b.show(), a.a.show()) : (a = this.b, a.b.hide(), a.a.hide())
    };
    f.Oh = function(a) {
    ...
    function tJ(a, b) {
        if (a.da) {
            var c = null;
            "detailpage" == a.g.Z ? (Fv(b, a.a), c = b ? 0 : 1) : c = Gv(a.da, b, a.a, a.g.Qa, a.g.Za);
            null != c && (iv(a.b, c), a.ca.B("RATE_SENTIMENT", {
                videoId: a.da.L,
                sentiment: c
            }))
        }
    ...
    f.cw = function(a) {
        this.b || this.i || (this.i = !0, this.A.call(this.k || l, a))
    };
    f.bw = function(a) {
        !this.b && this.i && (this.i = !1, this.C.call(this.k || l, a))
    };
    f.dispose = function() {
        this.b = !0;
        M(this.g);
    ...
    function yJ() {
        Y.call(this, ["div", "ytp-tooltip", ["div", "ytp-tooltip-body", ["div", "ytp-tooltip-content", "{{content}}"]],
    ...
    function wp(a, b, c) {
        var d, e = new vJ(b, "mouseover", function() {
            ...
            if (d && (a = c && c(b), !c || a)) {
                a ? zJ(d, a) : (a = K(b, "tooltip") || "", zJ(d, ed(a)));
    ...
    function gp(a, b, c, d) {
        ...
        wp(a, b, function() {
            ...
            if (e && e.na) {
                a = e.na;
                var b = e.ob;
                wJ || (wJ = new Fp(Hf("YTP_TOOLTIP_IDENTITY")), xJ = new Fp(Hf("YTP_TOOLTIP_IDENTITY_WATCH_LATER")));
                var k = dd("div");
                ...
                var b = dd("span"),
                    p = null;
                d ? (G(b, "ytp-idt-watch-later"), p = [ed(Jp(xJ, {
                    user_name: ""
    ...
    AJ.prototype.H = function() {
        this.b = this.nl = null;
        for (var a in this.a) ph(this.a[a]);
        this.a = {};
        AJ.D.H.call(this)
    };
    ...
    function DJ(a, b) {
        a.i != b && (a.i = b, a.g.Ia(b), a.element.Ab(a.j(b)))
    }
    ...
    function GJ(a, b) {
        Y.call(this, ["div", ["ytp-menu-container", "html5-stop-propagation"],
            ["div", "ytp-menu", "{{content}}"]
        ]);
        this.i = a;
        this.g = b || !1;
        this.a = [];
    ...
    function HJ(a) {
        qh(a.b);
        a.b = [];
        var b, c, d = new Y(["div", "ytp-menu-content"]),
            e = 1 == a.a.length || a.g;
        e && a.a.length && (c = new Y(["div", "ytp-menu-row", ["div", "ytp-menu-cell", a.a[0].a]]), c.X(d.M()));
        var g = !1;
        for (b = 0; b < a.a.length; b++) g = g || a.a[b].o;
        var h = g ? ["ytp-menu-cell", "ytp-menu-cell-span"] : "ytp-menu-cell";
        for (b = 0; b < a.a.length; b++) {
            var k = a.a[b];
            c = k.b;
            c = e ? !g || c ? new Y(["div", "ytp-menu-row", ["div", h, "{{content}}"]]) : new Y(["div", "ytp-menu-row", ["div", "ytp-menu-cell", "{{content}}"],
                    ["div", "ytp-menu-cell", "{{more}}"]
                ]) :
                !g || k.b ? new Y(["div", "ytp-menu-row", ["div", ["ytp-menu-cell", "ytp-menu-title"], k.a],
                    ["div", h, "{{content}}"]
                ]) : new Y(["div", "ytp-menu-row", ["div", ["ytp-menu-cell", "ytp-menu-title"], k.a],
    ...
    function NJ(a, b, c) {
        if (a.g != b || a.u != c) {
            ...
            a.i.Ia(c);
            var d = a.i;
            d.u && (d.g && Hw(Kw(d, d.g), !1), b && Hw(Kw(d, b), !0), d.g = b);
            a.C = "auto" == c;
    ...
    MJ.prototype.F = function(a) {
        ...
        this.C && "auto" == a || (NJ(this, a, a), Zf(this.element, "change"))
    };
    ...
    function TJ() {
        Y.call(this, ["div", ["ytp-time-display", "html5-control"],
    ...
    function VJ(a, b) {
        ...
        a.qb && fp(a.i, a.qb, Z("YTP_TOOLTIP_WATCH_LATER"),
            !0);
    ...
    f.hs = function(a) {
        var b = a.keyCode;
        if (32 == b || 13 == b) this.an(), a.preventDefault()
    };
    f.setVolume = function(a, b) {
        if (this.V != a || this.W != b) {
            ...
            if (b) this.R = "-" + c + "px " + d, this.gg.style.left = "0px";
            else {
                var e;
                0 >= a ? e = 0 : 100 <= a ? e = c : (e = (c - 0) * a / 100, e = 0 >= e ? 0 : e >= c ? c : 0 + Math.round(e));
            ...
            c = Math.round(a);
            d = c + "% " +
                Hf("HTML5_VOLUME_SETTING") + (b ? " " + Hf("HTML5_VOLUME_MUTED") : "");
    ...
    function ZJ(a, b) {
        if (b) {
            ...
            } else c = a.qc, xp(c, "ytp-button-pause"), d = Z("YTP_BUTTON_PAUSE");
            c.Ab(d);
            c.a = d
        } else KJ(a.qc)
    }
    ...
    function WJ(a, b, c, d) {
        a.u[b] || (a.u[b] = c, id(c.M(), d || a.j.M()), c.listen(c, "click", qa(a.Kw, b), a, "menuButtonClick"), c = new GJ(a.i, "__default__" != b), O(a, c), c.hide(), c.X(a.U), a.A[b] = c)
    }
    f.ds = function() {
        ef(this.qb, "html5-async-progress") || (Ev(this.qb, "html5-async-progress"), this.B("watchlater"))
    };
    f.es = function() {
    ...
    f.Md = function() {
        this.Q.removeAll();
        this.K && (this.K.hide(), this.K = null);
        this.P && (ev(this.P), this.P = null)
    };
    f.Kw = function(a, b) {
        b.stopPropagation();
        var c = this.u[a];
    ...
    function gK(a) {
        for (var b = 0; b < a.i.length; b++) a.k.Uc(a.i[b]);
        for (b = 0; b < a.j.length; b++) a.o.Uc(a.j[b])
    }
    ...
    function hK(a, b) {
        ...
        c.Yh && (c = this.a, e = D("html5-storyboard", c.g), c.u = new KB, d = c.u, g = TI(c.bb.b), d.td = e, d.ae = g.width, d.$b = D("html5-storyboard-filmstrip", d.td), d.Ph = D("html5-storyboard-lens", d.td), d.ik = D("html5-storyboard-lens-thumbnail",
            d.td), d.jk = D("html5-storyboard-lens-timestamp", d.td), d.tg = D("html5-storyboard-thumbnail", d.$b), F(d.tg), O(c, c.u));
        iK(this)
    }
    v(hK, dK);
    ...
    f.hx = function(a) {
        if (this.a.u) {
            var b = this.a.u;
            !b.Wc || b.ae == a.width && b.g || (b.ae = a.width, LB(b, !0))
        }
    };
    f.ix = function(a) {
        dC(this.a, a);
    ...
    f.Gp = function(a) {
        1 != a.getPlayerType() ? this.g && (gK(this), this.g = !1, eK(this, "videoplayerchange", this.Gp)) : this.g || iK(this)
    };
    f.mx = function(a, b, c) {
        if ("newdata" == a) {
            a = b.Ha || 0;
    ...
    function jK(a, b) {
        ...
        if (c.Gc) {
            ...
            d.k && (Jw(d.k.g, e), e.length ? aK(d, d.k) : bK(d, d.k));
            DJ(d.k, g);
            O(d, d.k);
            d.k.listen("change", d.Rr, d)
        }
        c.Wb && (d = this.a, this.b.N().ue ? dv(d.a) : ev(d.a), d.a.show());
        c.sf || Vo(this.a.qb);
        c.xh && this.a.o.show();
        c.ig && (d = this.a, Jw(d.I.g, this.b.a.ig ? Ch : [1]), aK(d, d.I));
        if (c.bb)
            for (c = this.a, d = [c.qc, c.nd, c.kf, c.F, c.qb, c.lf,
                    c.o, c.j
                ], e = 0; e < d.length; e++) c.b.listen(d[e], "click", c.Sr)
    }
    v(jK, dK);
    f = jK.prototype;
    f.ur = function(a) {
    ...
    f.yr = function(a) {
        var b = this.a;
        this.b.N();
        a ? (a = b.o, xp(a, "ytp-button-fullscreen-exit"), b = Z("YTP_BUTTON_FULLSCREEN_EXIT"), a.Ab(b), a.a = b) : FJ(b.o)
    };
    f.Ur = function(a) {
        R(a.a, 2) || (0 < Uq(a, 8) ? ZJ(this.a, !0) : 0 > Uq(a, 8) ? ZJ(this.a, !1) : 0 > Uq(a, 2) && ZJ(this.a, R(a.a, 8)));
        0 > Uq(a, 16) && (a = this.b.getCurrentTime(), kK(this) && YJ(this.a, a))
    };
    f.sr = function(a) {
        if (R(a.a, 2)) {
            a = this.a.qc;
    ...
    f.Br = function(a) {
        var b = this.a,
            c = b.u[a];
        c && (c.zf(), Oo(c, "menuButtonClick"), b.u[a] = null, b.A[a].dispose(), b.A[a] = null)
    };
    f.Er = function(a) {
        var b = this.a;
    ...
    f.Kr = function(a) {
        ...
        "auto" == lK(this.b) && (b = this.a, NJ(b.g, a, a), PJ(b.j, a));
        Eh(this.b, a, 1)
    };
    f.Lr = function(a) {
        var b = this.b;
        mK(b, !1);
        a != b.a.ue && (b.a.ue = a, b.B("SIZE_CLICKED", a), b.ea.Ig())
    };
    f.Mr = function(a) {
        Bh(this.b, a)
    };
    ...
    f.Kx = function(a) {
        if (a.responseText) {
            ...
            this.B("templateready")
        } else this.B("templateerror")
    };
    f.ip = function(a) {
        0 >= a || Bm() ? (this.va = !0, this.a && Lo(this.a)) : L(t(this.ip, this, a - 1), 50)
    };
    f.qj = function() {
        qK.D.qj.call(this);
        this.va || Mo(this.a);
        ...
        a.Ub && (this.addClass("html5-tablet"), G(document.body, "html5-tablet-body"));
        ...
        "1.3" != b && "1.8" !=
            b || this.addClass("autohide-aspect");
        a.Wb && this.resize();
        this.P = D("html5-watermark", this.a);
        rK(this.app) && Uo(this.P);
        a.te && !a.Vb && (this.A = new UJ(this.j), VJ(this.A, this.I), O(this, this.A), this.Va = new jK(this.app, this.A), O(this, this.Va));
    ...
    f.Ax = function(a) {
        2 == a ? uK(this) : (this.Q.hide(), this.removeClass("cued-mode"));
        3 == a ? this.o.show() : R(this.app.getPlayerState(), 1) || this.o.hide()
    };
    f.Cx = function(a) {
        var b;
        b = a.a;
        if (R(b, 2)) b = ["ended-mode"];
        else {
            var c = [];
    ...
    f.Bx = function(a) {
        R(a.a, 2) && !this.app.N().Ld ? uK(this) : 0 > Uq(a, 2) && (this.Q.hide(), this.removeClass("cued-mode"))
    };
        ...
        if (b.Vm) {
            if (b.Ub) {
                ...
                a.W = new YI(a.a, t(function(a) {
                    if (ef(this.a, "cued-mode")) up.hasTags(void 0) && this.Zn(a);
                    else if (wK(a) && (this.S ? this.Ok() : this.uk(), this.A)) {
                        a = this.A;
            ...
            } else N(a.a, "click", t(a.Zn, a)), N(a.a, "dblclick", t(a.qu, a)), N(a.a, "click", t(a.Ok, a)), N(a.a, "mousemove", t(a.Ok, a)), N(a.a,
                "mouseout", t(a.uk, a)), N(a.a, "click", t(a.ao, a, !1), !0), N(a.a, "keydown", t(a.ao, a, !0), !0), N(a.a, "focus", t(a.pu, a), !0);
            var d = t(function() {
                var a = this.b;
                a && (Vj(a), up.fillPool(4), b.Ub && bJ(), (a = Rf(this.a, "click", d, !0)) && Tf(a))
            }, a);
            N(a.a, "click", d, !0);
    ...
    f.Zn = function(a) {
        var b = this.app.N();
        wK(a) && (this.a.focus(), !ef(this.a, "cued-mode") && b.Vb || nK(this.app, !0));
        lJ(this.app, "screenclick")
    };
    f.qu = function(a) {
        6 != this.app.o && (wK(a) && (a = this.app, mK(a, !a.a.$a)), lJ(this.app, "screendoubleclick"))
    };
    f.ru = function(a) {
        var b = a.scale,
            c = this.app.N().$a;
        b * (c ? -1 : 1) > (c ? -0.7 : 1.3) && (b = this.app, mK(b, !b.a.$a));
        a.preventDefault()
    };
    f.su = function(a) {
        a = a.scale;
        var b = this.app.N().$a;
        a * (b ? -1 : 1) > (b ? -0.9 : 1.1) && (a = this.app, mK(a, !a.a.$a))
    };
    f.gw = function(a, b) {
        this.J.hide();
    ...
    f.vu = function(a) {
        this.app.a.C = u();
        var b = a.keyCode;
        if (179 == b || 178 == b) 179 == b && (this.B("playpausetoggled", !0), a.preventDefault()), 178 == b && (this.app.a.C = u(), yh(this.app), a.preventDefault());
        ...
        32 == b && wK(a) && (nK(this.app, !0), a.preventDefault());
    ...
    f.uu = function(a) {
        ...
        if (38 == b || 40 == b || 37 == b || 39 == b) {
            var c = 5;
            a.ctrlKey && (c *= 2);
            if (38 == b) c = this.app, oK(c, {
                volume: c.Ba.volume + 5,
                muted: !1
            });
            else if (40 == b) c = this.app, oK(c, {
                volume: c.Ba.volume - 5,
                muted: !1
            });
            else if (37 == b) {
            ...
            } else 39 == b && (d = this.app, uh(d, d.getCurrentTime() + c, !1, 250, void 0));
            a.preventDefault()
        }
        36 == b && (uh(this.app, 0), a.preventDefault());
        35 == b && (uh(this.app, Infinity), a.preventDefault());
        27 == b && (mK(this.app, !1), a.preventDefault())
    };
    f.$n = function(a) {
        a.preventDefault();
        uJ(this.app)
    ...
    f.Ok = function(a) {
        if (a) {
            var b = a.x || a.screenX;
            a = a.y || a.screenY;
            if (this.Ga.x == b && this.Ga.y == a) return;
            this.Ga = {
                x: b,
                y: a
            }
        ...
        this.Ca = !1;
        this.ha.start();
        this.S && (this.S = !1, this.removeClass("hide-controls"), this.removeClass("ytp-hide-mouse"), this.app.Wa("onShowControls"))
    };
    f.uk = function(a) {
        if (a && (a = a.relatedTarget) && ld(this.a, a)) return;
        this.Ca = !0;
        this.ha.stop();
        if (!this.S) {
            if (a = this.A) {
            ...
            this.Sa && this.Ca && !a && !b && (this.S = !0, this.addClass("hide-controls"), this.mb && this.addClass("ytp-hide-mouse"), this.app.Wa("onHideControls"))
        }
    };
    f.ao = function(a) {
        this.wb = a
    ...
    f.Fx = function(a) {
        if (this.a) {
            this.u || (this.u = new pJ, this.u.X(this.a), O(this, this.u));
            var b = this.app.N(),
                c = a.message;
            a = a.messageKey;
            ...
            if (b)
                for (b = a.element.getElementsByTagName("a"), c = 0; c < b.length; c++) b[c].setAttribute("target", "_blank");
            this.u.show()
        }
    };
    f.Ex = function() {
    ...
    f.Hx = function() {
        this.J && Tf(this.bb);
        this.J || (this.J = new qJ(0, Hf("YTP_STILL_THERE")), this.J.X(this.a), O(this, this.J));
        var a = hz(this.app.N());
    ...
    function IA(a, b, c) {
        ...
        this.I = "";
        this.i = null;
        if (a = n("ytbin.qoe.getInstance")) a = a(), a.isRunning() && (this.i = a);
        this.K = !1
    }
    v(IA, nh);
    var zK = {
    ...
    f.wj = function() {
        if (this.u) {
            ...
            isNaN(a.b) || (b = a.b, a.i < b && (b = a.i), this.F != b && (LA(this, "bh", [b.toFixed(3)]), this.F = b), this.a.Sa && 3 > b && ("PL" == this.b || "B" == this.b) && this.o.start())
        }
    };
    f.hg = function() {
        if (!this.ia() && !Vb(this.j) && this.u) {
            ...
            $b(a, az(this.a));
            a.html5 = "1";
            if (this.i && (a.qcft = this.i.getCurrentFrameTime(), a.qtql = this.i.getTargetQualityLevel(), a.qstb = this.i.getStability(),
                    a.qtob = this.i.getTimeOverBudget(), !this.K)) {
                var b = this.i.getTimeToTargetFromMark();
                0 <= b && (a.qttt = b, this.K = !0)
            }
            var a = yk($y(this.a) + "stream_204", a),
                c;
            for (c in this.j) a += "&" + c + "=" + this.j[c].join(",");
            ua(a);
            this.j = {};
            this.k.start()
        }
    ...
    f.Fq = function() {
        "PL" == this.b && (LA(this, "vps", [this.b]), this.hg())
    };
    f.H = function() {
        IA.D.H.call(this);
        Ef(this.A)
    ...
    function BK(a, b, c, d) {
        ...
        d && (this.hm = d.fs, this.J = d.nbe, this.K = d.bc, this.P = d.bd, this.Oa = d.bt, d.rtn && (this.Xf = d.rtn), this.mh ? (this.Gc = d.state, 0 < d.rti && (this.kh = d.rti)) : (this.ob = d.mos, this.Kc = d.volume, d.at && (this.A = d.at), d.allowed && (this.F = d.allowed), d.ex_ads && (this.R = d.ex_ads)));
        this.ha = b.j;
        this.nh = b.Sb;
        this.ma = b.o;
        this.na = b.u;
    ...
    f.Uh = function() {
        ...
        this.S && (a.ytr = this.S);
        this.mh ? (a.idpj = this.bb, a.ldpj = this.xb, null != this.kh && (a.rti = this.od(this.kh))) : (q(this.A) && (a.at = this.A), q(this.F) && (a.allowed = this.F), q(this.R) && (a.ex_ads =
            this.R));
        this.gm && this.W && (a.tst = this.W);
        this.fa || (a.ps = this.Hc, this.K && (a.bc = this.K), this.P && (a.bd = this.P, a.bt = this.Oa), 0 < this.J && (a.nbe = this.J));
        !this.ef && 0 < this.b.length ? (a.st = Ra(this.b, this.od).join(","), a.et = Ra(this.g, this.od).join(","), a.vis = Ra(this.a, this.od).join(",")) : (this.ef || this.ih) && 1 == this.a.length && (a.vis = this.od(this.a[0]));
        return a
    };
    f.od = function(a) {
    ...
    function CK(a, b, c, d) {
        ...
        this.j = [];
        this.Yf = b.rq;
        c && (this.P = c.nbe, this.Q = c.bc, this.R = c.bd, this.lb = c.bt, this.$l = c.fs, this.am = c.mos, this.Zl = c.ssrt, this.source = c.sourceid, this.za = c.sd, this.lj = c.hmewadbc, this.va = c.hmewdfc, this.jj = c.hmewdrop, this.ij = c.hmewvdbc, this.Ic = c.hmemdf, this.Jc = c.hmempaintdelay, this.ld = c.hmempainted, this.la = c.hmempf, this.gd = c.hmempresented, this.kd = c.volume);
        this.nj = b.nj;
        this.lh = b.Sb;
        this.S = b.o;
        this.Ga = b.u;
    ...
    f.Uh = function() {
        ...
        void 0 != this.ma && this.na &&
            (a.uga = this.na + this.ma);
        ...
        this.Q && (a.bc = this.Q);
        this.R && (a.bd = this.R, a.bt = this.lb);
        0 < this.P && (a.nbe = this.P);
        void 0 != this.va && (a.hmewdfc = this.va, a.hmewdrop = this.jj, a.hmewvdbc = this.ij, a.hmewadbc = this.lj);
        void 0 != this.la && (a.hmempf = this.la, a.hmemdf = this.Ic, a.hmempresented = this.gd, a.hmempainted = this.ld,
            a.hmempaintdelay = this.Jc);
        0 < this.b.length && (a.st = this.b.map(this.ii).join(","), a.et = this.g.map(this.ii).join(","));
        for (var b = 0; b < this.u.length; b++) Lb(OD(this.u[b]), function(b, d) {
            d in a || (a[d] = b)
        });
        return a
    };
    ...
    DK.prototype.P = function(a) {
        ...
        if (!(1E-5 > Math.abs(d - e)))
            if (0 > d) HK(this), this.g = b;
            else if (d > e) d > e + 0.5 && (HK(this), this.g = b);
        else if (0 == d) {
            d < e - 0.5 && (HK(this), this.g = b);
            return
        }
        this.A = c;
        this.k = b;
    ...
    function HK(a, b) {
        var c = a.k - a.g;
        if (b && 0 < c || 0.5 < c) a.ya.push([a.g, a.k, mB(a)]), a.g = a.k, a.Q += c
    }
    ...
    function GK(a, b) {
        ...
        for (var c = gB(a, "watchtime"), d = 0; d < b.length; d++) c.b.push(b[d][0]), c.g.push(b[d][1]), c.a && c.a.push(b[d][2]);
        c.k = a.k;
        return c
    }
    ...
    function pB(a, b) {
        if (!a.ia()) {
            R(b.a, 2) ? (a.u = "paused", a.i && KA(a).send()) : R(b.a, 8) ? (a.u = "playing", a.i && isNaN(a.C) && lB(a, !1)) : a.u = "paused";
            var c = a.o,
                d = b.a,
                e;
            e = b.a;
            if (R(e, 128)) e = "ER";
            else if (R(e, 16) || R(e, 32)) e = "S";
            else {
                var g = zK[jk(e)];
                "B" == g && R(e, 4) && (g = "PB");
                e = g
            }
            e != c.b && (!c.a.Sa || "B" != e && "PB" != e || c.wj(), LA(c, "vps", [e]), c.b = e);
            if (0 < Uq(b, 256) || R(d, 128)) c.onError(d.a.errorCode);
            (R(d, 2) || R(d, 128)) && c.hg()
        }
    }
    ...
    function XA(a, b, c) {
        ...
        ra(b, EK(a));
        ra(b, nB(a));
        "streamingerror" == b.event ? a = "//s.youtube.com/stream_204" : (a = a.a.hb + "player_204", delete b.fexp);
        b = Bk(a, b);
        ua(b, c)
    }
    ...
    function IK(a, b, c) {
        ...
        if (this.b != b) {
            if (this.b) {
                var d = this.b,
                    e = this.la,
                    g;
                for (g in e) d.ba(g, e[g], this)
            }
            b.P = this.na;
            g = this.la;
            for (var h in g) b.G(h, g[h], this);
            this.b = b
        }
        this.ma = ac(["beginseeking",
            this.xs, "endseeking", this.Ns, "internalvideodatachange", this.jn, "internalvideoformatchange", this.Ls, "progresssync", this.Gs, "seekto", this.Hs, "onLoadProgress", this.Cs, "onVideoProgress", this.Ms, "newlicensesession", this.Os, "playbackdataloaded", this.wm, "playbackready", this.Es, "statechange", this.Fs
        ]);
        this.k = null;
        DC(this, this.b);
        this.V = -1;
        ...
        O(this, this.ea);
        this.ea.G("templateerror", this.Is,
            this);
    ...
    function KK(a) {
        ...
        a.k && ZA(a.k, b);
        ak(a.i, a.xg);
        a.a.Od ? (a.Bf && Tf(a.Bf), a.Bf = N(a.i, "volumechange", t(a.du, a), !1)) : a.i.setVolume(a.Ba.volume, a.Ba.muted);
        b = a.ea;
        b.b = a.i;
        b.la = new Hb(0, 0, 0, 0);
    ...
    function qp(a, b) {
        a.a.Hb ? (a.P && (Bd(a.i, a.P.left, a.P.top), Md(a.i, Kb(a.P)), a.P = null), Zj(a.i), tp(a.k), ZA(a.k, a.i), ak(a.i, a.xg)) : up.releaseTag(b)
    }
    ...
    function FC(a, b) {
        ...
        var c = a.ma,
            d;
        for (d in c) b.ba(d, c[d], a);
        b != a.b && (c = b.getPlayerType(), a.Q[c] == b && delete a.Q[c]);
        b == a.k && (a.k = null, b != a.b && DC(a, a.b))
    }
    ...
    function di(a) {
        !a.F && a.I.N().lg && (a.F = new GI(a), a.F && OK(a, a.F));
        var b = a.F;
    ...
    function OK(a, b) {
        ...
        b.G("command_remove_cuerange_all",
            a.Qm, a);
    ...
    f.Js = function() {
        ...
        b.module_menu_item_add =
            t(this.ls, this);
        b.module_menu_item_remove = t(this.ms, this);
        b.module_menu_show = t(this.os, this);
        a.k = b;
        b = this.S;
        a.b != b && (qy(a), a.i = {}, a.b = b);
        this.ea.qj();
        a = this.ha;
        a.U = this.ea.a;
        for (var c in a.g) a.U[c] = a.g[c];
        for (c in a.i) a.U[c] = a.i[c];
        c = t(this.rs, this);
        a = document;
        ...
        b = this.ea.Pc();
        this.a.pb = b;
        "detailpage" != this.a.Z && c && (c.playlist || c.list || c.api) && (RK(this, c), Sn(a) || (c = this.g, a = t(this.gn, this), c.De = a, c.Wd && L(c.De, 0)));
        if (c = this.J.args.jsapicallback) ja(c) || (c = n(c)), c && PK(t(c, l, this.a.Aj), l);
        this.a.lg = ci(this.a) && (!Ya(hh()) || !Ya(jh()));
        Am() ? this.a.rj ? SK(this) : "leanback" != this.a.Z && TK(this) : oy(this.b, 5,
            "HTML5_NO_AVAILABLE_FORMATS_FALLBACK", void 0);
        this.ea.Wj()
    };
    ...
    function Bh(a, b) {
        if (!isNaN(b) && a.i) {
            ...
            a.xg != c && (a.xg = c, a.b == a.k && ak(a.i, c), a.B("onPlaybackRateChange", c))
        }
    }
    ...
    function Eh(a, b, c) {
        if (a = Q(a, c)) b = em(b, b, !0), Wx(a, "m", b)
    }
    f.getCurrentTime = function(a) {
    ...
    function Tx(a, b) {
        ...
        Px() && (a.i.setAttribute("mozStereoMode", d ? "1" : "0"), c = qm[d ? c.qe : 0], d = document.createElement("NvStereoExtDataElement"), d.setAttribute("stereoMode", c), gd(document.documentElement, d), Zf(d, "3DModeEvent"))
    }
    ...
    f.ws = function(a) {
        var b;
        (b = !R(a.a, 2)) || ("embedded" == this.a.Z && this.a.Vf ? (b = Math.floor(hz(this.a) / 6E4), b = Math.min(0.005, 1.24601E-4 * Math.exp(0.062 * b)), Math.random() < b ? (this.B("interstitial"), b = !0) : b = !1) : b = !1, b = !b && !xK(this));
        if (b) {
            R(a.a, 2) && (this.pauseVideo(), R(a.b, 32) && this.b.oi(), this.a.Tb && mK(this, !1));
            0 < Uq(a, 256) && (b = a.a.a, bi(this.b, b.errorCode, b.errorDetail));
            if (R(a.a, 128)) {
                b = a.a;
                Ef(0);
                Ah(this);
                ...
                b.message || (b.messageKey || (b.messageKey =
                    "HTML5_DEFAULT_FALLBACK"), b.message = Hf(b.messageKey));
    ...
    f.ts = function(a, b, c) {
        if ("newdata" == a) {
            ...
            ei(this.F);
            a = [];
            for (var d in this.A) zh(this, d) && a.push(d);
            this.A = {};
            0 < a.length && this.B("controlsenabled", a);
            this.qh();
            this.W = {}
        }
        this.getVideoData().Qj ? (this.Ff = Xb(this.Ba), this.mf(["audio"]), d = this.i, d.Uk = !0, d.muted = !0) : (zh(this, "audio") && this.th(["audio"]), this.i.Uk = !1, this.Ff && (oK(this, this.Ff), this.Ff = null));
        d = this.getVideoData();
        d.nb && !this.a.Nj ? oy(this.b, 205, "DEVICE_FALLBACK", void 0) : d.nb && !d.gb ? this.mf(["seek"]) : this.th(["seek"]);
        this.getVideoData().Hk &&
            !this.a.Oj && oy(this.b, 207, "DEVICE_FALLBACK", void 0);
        if (c.W || c.i.focEnabled || c.i.rmktEnabled) c = 1E3 * this.getVideoData().Aa, WK(this, "part2viewed", 0, c), WK(this, "videoplaytime25", 0.25 * c, c), WK(this, "videoplaytime50", 0.5 * c, c), WK(this, "videoplaytime75", 0.75 * c, c), WK(this, "videoplaytime100", c, 2147483647), WK(this, "conversionview", c, 2147483647)
    };
    f.jn = function(a, b, c) {
        "newdata" == a && (qy(this.j), Bh(this, 1), b.a.cg && b.i && UA(b.i, {
            metric: "connected"
        }));
    ...
    function RK(a, b) {
        ...
        ph(a.g);
        b ? (a.g = new Xn(b), a.j && (c = a.j, x([rw], c.j, c))) : a.g = null
    }
    ...
    function WK(a, b, c, d) {
        b in a.W || (c = new Rh(c, d, {
            id: b,
            priority: 1
        }), c.Ta.G("onEnter", a.Dp, a), c.Ta.G("onExit", a.Dp, a), a.b.wh(c), a.W[b] = c)
    }
    f.Dp = function(a) {
        var b = a.getId(),
            c = this.b.getVideoData();
        "part2viewed" == b ? (c.W && ua(c.W), c.wb && ua(c.wb)) : "conversionview" == b && VK(this);
        c.Ga && (b = a.getId(), c = Bk(c.Ga, {
            label: b
        }), ua(c));
        this.b.sh(a)
    };
    ...
    function VK(a) {
        ...
        b.Fo || (b.i.eventLabel = a.a.Z, b.i.playerStyle = a.a.cb, b.W && (b.i.feature = "pyv"), b.i.vid = b.L, b.i.isAd = !("adunit" != a.a.Z && !b.W), Lm("view", b.i), b.Fo = !0)
    }

    function NK(a, b) {
        b != a.o && (2 == b && UK(a, 5), a.o = b, a.B("appstatechange", b))
    }

    function UK(a, b) {
        a.V != b && (a.V = b, a.Xi("onStateChange", b))
    }
    ...
    f.Hs = function(a, b) {
        var c = a.getVideoData();
        if (1 == this.o || 2 == this.o) c.Ha = b;
        2 == this.o ? SK(this) : (c = fB(a, b), this.Wa("seekto", c))
    };
    f.xs = function() {
    ...
    function YK(a, b, c, d) {
        wA("_start") || (uA("_start"), yA(void 0).srt = 0);
        var e = Q(a, d);
        if (!e) return !1;
        M(a.fa);
        b.ff = Km(b.ff, c);
    ...
    function Kh(a, b, c) {
        var d = Q(a, c);
        d && (Ah(a, c), FA(d, b, QK(a)), OA(d) && (Zy(d.N(), b.b), d == a.b && (NK(a, 1), TK(a))))
    }
    ...
    function Sh(a, b, c, d, e) {
        if (ka(b) && !ga(b)) {
            ...
            startSeconds: d,
            suggestedQuality: e
        }, r(b) && 16 == b.length ? d.list = "PL" + b : d.playlist = b, b = d;
        RK(a, b);
        b = a.g;
        a = t(a.gn, a);
        b.De = a;
    ...
    function xK(a) {
        return a.g && ("embedded" == a.a.Z || a.a.$a) && Tp(a) ? (Th(a), !0) : !1
    }

    function Th(a) {
        a.g && (a.g.Wd ? bo(a.g) && Vh(a, co(a.g)) : (co(a.g), a.Re = !1))
    }
    ...
    f.Lm = function(a, b) {
        var c = Q(this, b);
        c && (x(a, c.wh, c), this.B("cuerangesadded", a))
    };
    f.Pm = function(a, b) {
        var c = Q(this, b);
        c && (x(a, c.sh, c), this.B("cuerangesremoved", a))
    };
    f.Qm = function(a, b) {
        var c = Q(this, b);
        if (c) {
            for (var c = c.A, d = c.i.length - 1; 0 <= d; d--) c.i[d].namespace == a && mk(c, d);
            c.Zb()
        }
    };
    f.Tm = function(a) {
    ...
    f.vs = function() {
        ...
        if (!this.a.Ih && "detailpage" == this.a.Z) {
            ...
            if (a.a && a.J && a.J.a) {
                ...
                a.a.Ya && (b = a.a.Ya, yA("after_ad").plid = b);
                b = a.a.Fa;
                yA("after_ad").cpn = b;
                b = a.J.a;
    ...
    f.hv = function(a, b, c) {
        ...
        var d = [],
            e;
        for (e in a) "_" != e.charAt(0) && d.push(e + "." + a[e]);
        b.rt = d.join(",");
        for (var g in c) "_" != g.charAt(0) && (b[g] = c[g]);
        a = zf("TIMING_INFO") || {};
        "e" in a && (b.e = a.e);
        "ei" in a && (b.ei = a.ei);
        return b
    ...
    f.Mm = function(a) {
        "remote" == a ? (NK(this, 6), ei(this.u)) : this.Xi("onApiChange")
    };
    f.Nm = function(a) {
        "remote" == a && TK(this)
    };
    ...
    f.fn = function(a) {
        ...
        zh(this, "audio") ? this.Ff && (this.Ff = Xb(a), this.Wa("onVolumeChange", a)) : (this.i.setVolume(a.volume, a.muted), this.a.Od || this.Wa("onVolumeChange", a))
    };
    f.rs = function() {
        $K(this, !!ag())
    };
    ...
    f.Om = function(a, b) {
        if ("onAdStateChange" == a) {
            var c = arguments[1],
                d = arguments[2],
                e = arguments[3] || {};
            1 == c && (uA("vr"), jB(this.k), ZK(this));
            0 == c && e && (this.b.J = e);
            var g = this.a;
            "leanback" == g.Z && Xy(g) && (0 == c ? this.Vd = this.i : this.Vd = d, this.B("onAdStateChange", c, e.video_id))
        } else this.B.apply(this, arguments)
    };
    f.Xe = function(a, b) {
    ...
    f.playVideo = function(a, b) {
        var c = Q(this, b);
        c && (2 == this.o ? SK(this) : c.W ? (a && aL(this, c), R(c.getPlayerState(), 2) ? this.of(0) : c.playVideo()) : PA(c))
    };
    f.pauseVideo = function(a, b) {
        var c = Q(this, b);
        c && (a && aL(this, c), c.pauseVideo())
    };

    function Ah(a, b) {
        var c = Q(a, b);
        c && 1 != a.o && 2 != a.o && (c.pauseVideo(), c.g && (c.g.o = !1))
    }
        ...
        if (a.a.$a != b)
            if ($f())
                if (b) {
                    ...
                    d && d.apply(c)
                } else(c = sf(["exitFullscreen", "cancelFullscreen", "cancelFullScreen"], document)) && c.call(document);
        else a.B("onFullScreenToggleRequest"), $K(a, b)
    }
    ...
    f.wm = function() {
        if (this.k == this.b) {
            var a;
            if (a = ci(this.a))
                if (Qg("yt-remote-delayed-connect-key")) a = !0;
                else {
                    a = ah();
                    var b = tg(hh());
                    a = !!xg(b, a)
                } a || !this.getVideoData(1).Jm || this.a.Tb ? MA(this.b) && !NA(this.b) ? (this.log_("No available formats"), oy(this.b, 5, "HTML5_NO_AVAILABLE_FORMATS_FALLBACK", void 0)) : ((b = NA(this.b)) || (b = ((b = this.getVideoData()) && b.Q.length && !MA(Q(this)) && sn(zm(), "application/x-mpegURL") ? 0 <= Pa(b.Q, "fresca") : !1) || a), b ? (a && NK(this, 6), !this.u && this.I.getVideoData().ja && (this.u = new UD(this)) &&
                OK(this, this.u), (a = this.u) && !a.Df && a.eb(this.I) && a.create(), di(this), MK(this)) : (a = !1, this.getVideoData().la || this.S && (a = ey(this.S)), a && (a = {
                video_id: this.getVideoData().b.ypc_vid,
                ypc_preview: 1
            }, a.video_id ? Nh(this, a, 1) : (this.mf(["seek", "play_pause"]), a = this.j, x([Wq, Jx, Up, ly, rw, Ux, Zx, fy, Ju], a.j, a))))) : (a = "DEVICE_FALLBACK", pc || Rj("iemobile") || Rj("xbox") && Rj("trident") || Rj("nintendo wiiu") || (a = "FLASH_FALLBACK"), oy(this.b, 5, a, void 0))
        } else MK(this)
    };
    f.Ds = function() {
        this.pauseVideo()
    ...
    function vK(a) {
        ...
        if (a.i) {
            ...
            c = UI(a.ea);
            Jb(a.a.ep, c) || (a.a.ep = c, b = !0);
            c = UI(a.ea);
            Jb(a.a.Qc, c) || (a.a.Qc = c, b = !0);
            b && (Wx(Q(a), "r"), a.B("resize", TI(a.ea)), a.Wa("onResize"))
        }
    }
    ...
    n("yt.window.popup") || (ba("yt.window.popup", aw, void 0), ba("yt.window.open", $v, void 0));
    ba("yt.player.Application.create", function(a, b) {
        JK[a] && (JK[a].dispose(), JK[a] = null);
        var c = new IK(a, b);
        oh(c, function() {
            JK[a] = null
        });
